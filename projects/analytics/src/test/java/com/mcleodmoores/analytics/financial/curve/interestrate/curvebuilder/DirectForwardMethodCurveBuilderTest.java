...
/**
 * Unit tests for {@link DirectForwardMethodCurveBuilder}.
 */
@Test(groups = TestGroup.UNIT)
public class DirectForwardMethodCurveBuilderTest {
  ...
  static {
    TYPES.put("A",
        new DirectForwardMethodCurveTypeSetUp().forDiscounting(Currency.USD).withInterpolator(NamedInterpolator1dFactory.of("Linear", "FlatExtrapolator")));
    TYPES.put("B",
        new DirectForwardMethodCurveTypeSetUp().forDiscounting(Currency.USD).withInterpolator(NamedInterpolator1dFactory.of("Linear", "FlatExtrapolator")));
    TYPES.put("C",
        new DirectForwardMethodCurveTypeSetUp().forDiscounting(Currency.USD).withInterpolator(NamedInterpolator1dFactory.of("Linear", "FlatExtrapolator")));
  ...
  private static final DirectForwardMethodCurveBuilder BUILDER = new DirectForwardMethodCurveBuilder(CURVE_NAMES, DISCOUNTING, IBOR, OVERNIGHT, NODES, TYPES,
  ...
  public void testNullCurveNames() {
    new DirectForwardMethodCurveBuilder(null, DISCOUNTING, IBOR, OVERNIGHT, NODES, TYPES, FX, KNOWN_CURVES, SENSITIVITIES, ROOT_FINDER);
  }
  ...
  public void testEmptyCurveNames() {
    new DirectForwardMethodCurveBuilder(new ArrayList<List<String>>(), DISCOUNTING, IBOR, OVERNIGHT, NODES, TYPES, FX, KNOWN_CURVES, SENSITIVITIES,
        ROOT_FINDER);
  }
  ...
  public void testNullDiscountingIds() {
    new DirectForwardMethodCurveBuilder(CURVE_NAMES, null, IBOR, OVERNIGHT, NODES, TYPES, FX, KNOWN_CURVES, SENSITIVITIES, ROOT_FINDER);
  }
  ...
  public void testNullIborIndices() {
    new DirectForwardMethodCurveBuilder(CURVE_NAMES, DISCOUNTING, null, OVERNIGHT, NODES, TYPES, FX, KNOWN_CURVES, SENSITIVITIES, ROOT_FINDER);
  }
  ...
  public void testNullOvernightIndices() {
    new DirectForwardMethodCurveBuilder(CURVE_NAMES, DISCOUNTING, IBOR, null, NODES, TYPES, FX, KNOWN_CURVES, SENSITIVITIES, ROOT_FINDER);
  }
  ...
  public void testNullNodes() {
    new DirectForwardMethodCurveBuilder(CURVE_NAMES, DISCOUNTING, IBOR, OVERNIGHT, null, TYPES, FX, KNOWN_CURVES, SENSITIVITIES, ROOT_FINDER);
  }
  ...
  public void testNullCurveTypes() {
    new DirectForwardMethodCurveBuilder(CURVE_NAMES, DISCOUNTING, IBOR, OVERNIGHT, NODES, null, FX, KNOWN_CURVES, SENSITIVITIES, ROOT_FINDER);
  }
  ...
  public void testNullRootFinder() {
    new DirectForwardMethodCurveBuilder(CURVE_NAMES, DISCOUNTING, IBOR, OVERNIGHT, NODES, TYPES, FX, KNOWN_CURVES, SENSITIVITIES, null);
  }
  ...
  public void testDiscountingIdsAreCurrencies() {
    ...
    final DirectForwardMethodCurveBuilder builder = new DirectForwardMethodCurveBuilder(CURVE_NAMES, discountingCurves, IBOR, OVERNIGHT, NODES, TYPES, FX,
