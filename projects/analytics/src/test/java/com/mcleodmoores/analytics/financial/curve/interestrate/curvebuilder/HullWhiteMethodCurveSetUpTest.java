...
public class HullWhiteMethodCurveSetUpTest {
  ...
  public void testNullBuilderMethodInputs() {
    TestUtils.testNullBuilderMethodInputs(HullWhiteMethodCurveSetUp.class, CurveSetUpInterface.class, "withKnownBundle");
  }
  ...
  public void testNullCurveName1() {
    new HullWhiteMethodCurveSetUp().addNode(null, INSTRUMENT_1);
  }
  ...
  public void testNullInstrument() {
    new HullWhiteMethodCurveSetUp().addNode("A", null);
  }
  ...
  public void testNullFxMatrix() {
    new HullWhiteMethodCurveSetUp().addFxMatrix(null);
  }
   ...
   */
  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testNullHullWhiteParameters() {
    new HullWhiteMethodCurveSetUp().addHullWhiteParameters(null);
  }
  ...
  public void testNullModelCurrency() {
    new HullWhiteMethodCurveSetUp().forHullWhiteCurrency(null);
  }
  ...
  public void testNullCurveName2() {
    new HullWhiteMethodCurveSetUp().removeNodes(null);
  }
  ...
  public void testEmptyBuilderMethodInputs() {
    TestUtils.testEmptyBuilderMethodInputs(HullWhiteMethodCurveSetUp.class, CurveSetUpInterface.class);
  }
  ...
  public void testNegativeBuilderMethodInputs() {
    TestUtils.testBuilderMethodsLowerRange(HullWhiteMethodCurveSetUp.class, CurveSetUpInterface.class, 0, false);
  }
  ...
  public void testNullBuilder() {
    new HullWhiteMethodCurveSetUp(null);
  }
  ...
  public void testBuilding() {
    new HullWhiteMethodCurveSetUp().building("A").building("B");
  }
  ...
  public void testBuildingFirst() {
    new HullWhiteMethodCurveSetUp().building("A").buildingFirst("B");
  }
  ...
  public void testThenBuilding() {
    new HullWhiteMethodCurveSetUp().thenBuilding("B");
  }
  ...
  public void testDuplicatedCurveType() {
    new HullWhiteMethodCurveSetUp().using("A").using("A");
  }
  ...
  public void testNoCurves() {
    new HullWhiteMethodCurveSetUp().getBuilder();
  }
