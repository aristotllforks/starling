...
public class DirectForwardMethodCurveSetUpTest {
  ...
  public void testNullBuilderMethodInputs() {
    TestUtils.testNullBuilderMethodInputs(DirectForwardMethodCurveSetUp.class, CurveSetUpInterface.class, "withKnownBundle");
  }
  ...
  public void testNullCurveName1() {
    new DirectForwardMethodCurveSetUp().addNode(null, INSTRUMENT_1);
  }
  ...
  public void testNullInstrument() {
    new DirectForwardMethodCurveSetUp().addNode("A", null);
  }
  ...
  public void testNullFxMatrix() {
    new DirectForwardMethodCurveSetUp().addFxMatrix(null);
  }
  ...
  public void testNullCurveName2() {
    new DirectForwardMethodCurveSetUp().removeNodes(null);
  }
  ...
  public void testEmptyBuilderMethodInputs() {
    TestUtils.testEmptyBuilderMethodInputs(DirectForwardMethodCurveSetUp.class, CurveSetUpInterface.class);
  }
  ...
  public void testNegativeBuilderMethodInputs() {
    TestUtils.testBuilderMethodsLowerRange(DirectForwardMethodCurveSetUp.class, CurveSetUpInterface.class, 0, false);
  }
  ...
  public void testNullBuilder() {
    new DirectForwardMethodCurveSetUp(null);
  }
  ...
  public void testBuilding() {
    new DirectForwardMethodCurveSetUp().building("A").building("B");
  }
  ...
  public void testBuildingFirst() {
    new DirectForwardMethodCurveSetUp().building("A").buildingFirst("B");
  }
  ...
  public void testThenBuilding() {
    new DirectForwardMethodCurveSetUp().thenBuilding("B");
  }
  ...
  public void testDuplicatedCurveType() {
    new DirectForwardMethodCurveSetUp().using("A").using("A");
  }
  ...
  public void testDuplicatedPreConstructedCurveForCurrency() {
    ...
    new DirectForwardMethodCurveSetUp().using(curve1).forDiscounting(Currency.USD).using(curve2).forDiscounting(Currency.USD).getBuilder();
  }
  ...
  public void testDuplicatedPreConstructedCurveForIborIndex() {
    ...
    final YieldCurve curve1 = new YieldCurve("A", ConstantDoublesCurve.from(0.01));
    final YieldCurve curve2 = new YieldCurve("B", ConstantDoublesCurve.from(0.02));
    new DirectForwardMethodCurveSetUp().using(curve1).forIndex(index).using(curve2).forIndex(index).getBuilder();
  }
  ...
  public void testCopy() {
    final DirectForwardMethodCurveSetUp setup1 = new DirectForwardMethodCurveSetUp()
        .building("B").using("B").forDiscounting(Currency.EUR).addNode("B", INSTRUMENT_2);
    DirectForwardMethodCurveSetUp setup2 = setup1.copy();
  ...
  public void testNoCurves() {
    new DirectForwardMethodCurveSetUp().getBuilder();
  }
  ...
  public void testNodesNotAdded() {
    final DirectForwardMethodCurveSetUp setup = new DirectForwardMethodCurveSetUp()
        .building("A", "B")
  ...
  public void testAddNodes() {
    final DirectForwardMethodCurveSetUp setup = new DirectForwardMethodCurveSetUp()
        ...
        .using("B").forDiscounting(Currency.EUR)
        .addNode("B", INSTRUMENT_2);
    final DirectForwardMethodCurveBuilder builder = setup.getBuilder();
