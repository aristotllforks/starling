...
public class CouponONDiscountingMethodTest {
  ...
  private static final CouponONDefinition CPN_OIS_DEFINITION = CouponONDefinition.from(EONIA, EFFECTIVE_DATE, TENOR, NOTIONAL, 2,
  ...
  public void presentValue() {
    ...
    final double forward = MULTICURVES.getSimplyCompoundForwardRate(EONIA, CPN_OIS.getFixingPeriodStartTime(),
        CPN_OIS.getFixingPeriodEndTime(), CPN_OIS.getFixingPeriodAccrualFactor());
    final double pvExpected = NOTIONAL * CPN_OIS.getFixingPeriodAccrualFactor() * forward
        * MULTICURVES.getDiscountFactor(CPN_OIS.getCurrency(), CPN_OIS.getPaymentTime());
  ...
  public void presentValueStarted() {
    ...
    final double forward = MULTICURVES.getSimplyCompoundForwardRate(EONIA, cpnOISStarted.getFixingPeriodStartTime(),
        cpnOISStarted.getFixingPeriodEndTime(), cpnOISStarted.getFixingPeriodAccrualFactor());
