...
public class BondFuturesOptionMarginTransactionBlackFlatMethodTest {
  ...
  private static final BlackBondFuturesFlatProviderDiscount BLACK_FLAT_BNDFUT = new BlackBondFuturesFlatProviderDiscount(
  ...
  private static final ParameterSensitivityParameterCalculator<BlackBondFuturesProviderInterface> PSSFC = new ParameterSensitivityParameterCalculator<>(
      PVCSBFC);
  private static final ParameterSensitivityBlackBondFuturesFlatDiscountInterpolatedFDCalculator PSSFC_FD = new ParameterSensitivityBlackBondFuturesFlatDiscountInterpolatedFDCalculator(
      PVBFC, SHIFT);
  /** Tolerances */
  ...
  public void presentValue() {
    ...
    assertEquals("BondFuturesOptionMarginTransactionBlackFlatMethod: present value", pvExpected1,
        pvComputed1.getAmount(BOBLM4_DEFINITION.getCurrency()), TOLERANCE_RATE);
    ...
    assertEquals("BondFuturesOptionMarginTransactionBlackFlatMethod: present value", pvExpected1,
        pvCalculator.getAmount(BOBLM4_DEFINITION.getCurrency()), TOLERANCE_RATE);
    ...
    assertEquals("BondFuturesOptionMarginTransactionBlackFlatMethod: present value", pvExpected2,
        pvComputed2.getAmount(BOBLM4_DEFINITION.getCurrency()), TOLERANCE_RATE);
  }
