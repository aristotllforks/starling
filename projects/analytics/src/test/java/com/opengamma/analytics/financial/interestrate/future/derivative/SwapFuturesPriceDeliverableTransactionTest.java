...
public class SwapFuturesPriceDeliverableTransactionTest {
  ...
  private static final SwapFuturesPriceDeliverableTransaction SWAP_FUTURES_TRANSACTION = new SwapFuturesPriceDeliverableTransaction(
      SWAP_FUTURES_SECURITY, REF_PRICE, QUANTITY);
  ...
  public void testHashCodeEquals() {
    ...
    other = new SwapFuturesPriceDeliverableTransaction(SWAP_FUTURES_SECURITY_DEFINITION.toDerivative(REFERENCE_DATE.plusDays(1)), REF_PRICE,
        QUANTITY);
