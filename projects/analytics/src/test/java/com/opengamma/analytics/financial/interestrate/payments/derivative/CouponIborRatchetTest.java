...
public class CouponIborRatchetTest {
  ...
  private static final ZonedDateTime ACCRUAL_END_DATE = ScheduleCalculator.getAdjustedDate(ACCRUAL_START_DATE, TENOR_IBOR, BUSINESS_DAY,
      CALENDAR, IS_EOM);
  ...
  private static final CouponIborRatchetDefinition RATCHET_IBOR_DEFINITION = new CouponIborRatchetDefinition(CUR, PAYMENT_DATE,
      ACCRUAL_START_DATE, ACCRUAL_END_DATE, ACCRUAL_FACTOR, NOTIONAL,
      FIXING_DATE, INDEX_IBOR, MAIN_COEF, FLOOR_COEF, CAP_COEF, CalendarAdapter.of(CALENDAR));
  ...
  public void nullIndex() {
    new CouponIborRatchet(CUR, RATCHET_IBOR.getPaymentTime(), RATCHET_IBOR.getPaymentYearFraction(), NOTIONAL, RATCHET_IBOR.getFixingTime(),
        RATCHET_IBOR.getFixingPeriodStartTime(), RATCHET_IBOR.getFixingPeriodEndTime(), RATCHET_IBOR.getFixingAccrualFactor(), null,
  ...
  public void nullMain() {
    new CouponIborRatchet(CUR, RATCHET_IBOR.getPaymentTime(), RATCHET_IBOR.getPaymentYearFraction(), NOTIONAL, RATCHET_IBOR.getFixingTime(),
        RATCHET_IBOR.getFixingPeriodStartTime(), RATCHET_IBOR.getFixingPeriodEndTime(), RATCHET_IBOR.getFixingAccrualFactor(), INDEX_IBOR,
        null, FLOOR_COEF, CAP_COEF);
  }
  ...
  public void numberMain() {
    new CouponIborRatchet(CUR, RATCHET_IBOR.getPaymentTime(), RATCHET_IBOR.getPaymentYearFraction(), NOTIONAL, RATCHET_IBOR.getFixingTime(),
        RATCHET_IBOR.getFixingPeriodStartTime(), RATCHET_IBOR.getFixingPeriodEndTime(), RATCHET_IBOR.getFixingAccrualFactor(), INDEX_IBOR,
        new double[2], FLOOR_COEF, CAP_COEF);
  }
  ...
  public void numberFloor() {
    new CouponIborRatchet(CUR, RATCHET_IBOR.getPaymentTime(), RATCHET_IBOR.getPaymentYearFraction(), NOTIONAL, RATCHET_IBOR.getFixingTime(),
        RATCHET_IBOR.getFixingPeriodStartTime(), RATCHET_IBOR.getFixingPeriodEndTime(), RATCHET_IBOR.getFixingAccrualFactor(), INDEX_IBOR,
        MAIN_COEF, new double[2], CAP_COEF);
  }
  ...
  public void numberCap() {
    new CouponIborRatchet(CUR, RATCHET_IBOR.getPaymentTime(), RATCHET_IBOR.getPaymentYearFraction(), NOTIONAL, RATCHET_IBOR.getFixingTime(),
        RATCHET_IBOR.getFixingPeriodStartTime(), RATCHET_IBOR.getFixingPeriodEndTime(), RATCHET_IBOR.getFixingAccrualFactor(), INDEX_IBOR,
        MAIN_COEF, FLOOR_COEF, new double[2]);
  }
  ...
  public void testWithNotional() {
    ...
    final CouponIborRatchet expected = new CouponIborRatchet(CUR, 0.25, 0.25, notional, 0.1, 0.1, 0.2, 0.25, INDEX_IBOR, MAIN_COEF,
        FLOOR_COEF, CAP_COEF);
    final CouponIborRatchet coupon = new CouponIborRatchet(CUR, 0.25, 0.25, NOTIONAL, 0.1, 0.1, 0.2, 0.25, INDEX_IBOR, MAIN_COEF,
        FLOOR_COEF, CAP_COEF);
  ...
  public void testEqualHash() {
    ...
    final CouponIborRatchet other = new CouponIborRatchet(CUR, RATCHET_IBOR.getPaymentTime(), RATCHET_IBOR.getPaymentYearFraction(),
        NOTIONAL, RATCHET_IBOR.getFixingTime(),
        RATCHET_IBOR.getFixingPeriodStartTime(), RATCHET_IBOR.getFixingPeriodEndTime(), RATCHET_IBOR.getFixingAccrualFactor(), INDEX_IBOR,
        MAIN_COEF, FLOOR_COEF, CAP_COEF);
    ...
    modified = new CouponIborRatchet(CUR, RATCHET_IBOR.getPaymentTime(), RATCHET_IBOR.getPaymentYearFraction(), NOTIONAL,
        RATCHET_IBOR.getFixingTime(),
        RATCHET_IBOR.getFixingPeriodStartTime(), RATCHET_IBOR.getFixingPeriodEndTime(), RATCHET_IBOR.getFixingAccrualFactor(), INDEX_IBOR,
        new double[3], FLOOR_COEF, CAP_COEF);
    assertFalse("Ratchet Ibor Coupon: equal/hash", RATCHET_IBOR.equals(modified));
    modified = new CouponIborRatchet(CUR, RATCHET_IBOR.getPaymentTime(), RATCHET_IBOR.getPaymentYearFraction(), NOTIONAL,
        RATCHET_IBOR.getFixingTime(),
        RATCHET_IBOR.getFixingPeriodStartTime(), RATCHET_IBOR.getFixingPeriodEndTime(), RATCHET_IBOR.getFixingAccrualFactor(), INDEX_IBOR,
    ...
    modified = new CouponIborRatchet(CUR, RATCHET_IBOR.getPaymentTime(), RATCHET_IBOR.getPaymentYearFraction(), NOTIONAL,
        RATCHET_IBOR.getFixingTime(),
        RATCHET_IBOR.getFixingPeriodStartTime(), RATCHET_IBOR.getFixingPeriodEndTime(), RATCHET_IBOR.getFixingAccrualFactor(), INDEX_IBOR,
        MAIN_COEF, FLOOR_COEF, new double[3]);
    assertFalse("Ratchet Ibor Coupon: equal/hash", RATCHET_IBOR.equals(modified));
  }
