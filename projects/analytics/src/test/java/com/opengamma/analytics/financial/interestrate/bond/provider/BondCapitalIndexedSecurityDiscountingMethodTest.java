...
public class BondCapitalIndexedSecurityDiscountingMethodTest {
  ...
  private static final PresentValueDiscountingInflationIssuerCalculator PVDIIC = PresentValueDiscountingInflationIssuerCalculator
      .getInstance();
  private static final ParameterSensitivityInflationMulticurveDiscountInterpolatedFDCalculator PS_PV_FDC = new ParameterSensitivityInflationMulticurveDiscountInterpolatedFDCalculator(
      PVDIC, SHIFT_FD);
  private static final ParameterSensitivityIssuerInflationMulticurveDiscountInterpolatedFDCalculator PS_PV_FDIC = new ParameterSensitivityIssuerInflationMulticurveDiscountInterpolatedFDCalculator(
      PVDIIC, SHIFT_FD);
  private static final PresentValueCurveSensitivityDiscountingInflationCalculator PVCSDC = PresentValueCurveSensitivityDiscountingInflationCalculator
      .getInstance();
  private static final ParameterInflationSensitivityParameterCalculator<InflationProviderInterface> PSC = new ParameterInflationSensitivityParameterCalculator<>(
      PVCSDC);
  private static final PresentValueCurveSensitivityIssuerDiscountingInflationCalculator PVCSDIC = PresentValueCurveSensitivityIssuerDiscountingInflationCalculator
      .getInstance();
  private static final ParameterInflationSensitivityParameterCalculator<InflationIssuerProviderInterface> PSIC = new ParameterInflationSensitivityParameterCalculator<>(
      PVCSDIC);
  ...
  private static final YieldConvention YIELD_CONVENTION_CAIN = YieldConventionFactory.INSTANCE.getYieldConvention("UK:BUMP/DMO METHOD"); // To
                                                                                                                                         // check
  ...
  private static final BondCapitalIndexedSecurityDefinition<CouponInflationZeroCouponMonthlyGearingDefinition> BOND_SECURITY_CAIN_DEFINITION = BondCapitalIndexedSecurityDefinition
      .fromMonthly(
          PRICE_INDEX_AUDCPI, MONTH_LAG_CAIN, START_DATE_CAIN, INDEX_START_CAIN, FIRST_COUPON_DATE_CAIN, MATURITY_DATE_CAIN,
          COUPON_PERIOD_CAIN, NOTIONAL_CAIN, REAL_RATE_CAIN,
          BUSINESS_DAY_AUD, SETTLEMENT_DAYS_CAIN, CalendarAdapter.of(CALENDAR_AUD), DAY_COUNT_CAIN, YIELD_CONVENTION_CAIN, IS_EOM_CAIN,
          ISSUER_AUD_GOVT);
  private static final DoubleTimeSeries<ZonedDateTime> AUD_CPI = MulticurveProviderDiscountDataSets.audCPIFrom2009();
  private static final BondCapitalIndexedSecurity<Coupon> BOND_SECURITY_CAIN = BOND_SECURITY_CAIN_DEFINITION.toDerivative(PRICING_DATE,
      AUD_CPI);
  ...
  public void presentValueCAIN() {
    ...
    final MultipleCurrencyAmount pvNominal = METHOD_INFLATION_ZC_MONTHLY
        .presentValue((CouponInflationZeroCouponMonthlyGearing) BOND_SECURITY_CAIN.getNominal().getNthPayment(0), marketUKGovt);
    ...
    assertEquals("Inflation Capital Indexed bond: present value", pvExpectd.getAmount(BOND_SECURITY_CAIN.getCurrency()),
        pv.getAmount(BOND_SECURITY_CAIN.getCurrency()), 1.0E-2);
  }
  ...
  public void presentValueParameterCurveSensitivityCAIN() {
    ...
    final MultipleCurrencyParameterSensitivity pvicsFD = PS_PV_FDC.calculateSensitivity(BOND_SECURITY_CAIN.getCoupon(),
        MARKET.getInflationProvider());
    final MultipleCurrencyParameterSensitivity pvicsExact = PSC.calculateSensitivity(BOND_SECURITY_CAIN.getCoupon(),
        MARKET.getInflationProvider(), MARKET.getAllNames());

    AssertSensitivityObjects.assertEquals("Bond capital indexed security: presentValueParameterCurveSensitivity ", pvicsExact, pvicsFD,
  ...
  public void presentValueCurveSensitivityCAIN() {
    final InflationProviderInterface creditDiscounting = new InflationProviderDecoratedIssuer(MARKET, BOND_SECURITY_CAIN.getCurrency(),
    ...
    AssertSensitivityObjects.assertEquals("Bond capital indexed security: presentValueCurveSensitivity ", pvcisCalculated, pvcisMethod,
        TOLERANCE_PV_DELTA);

  }

  // Index-Lined Gilt 2% Index-linked Treasury Stock 2035 - GB0031790826
  private static final WorkingDayCalendar CALENDAR_GBP = WeekendWorkingDayCalendar.SATURDAY_SUNDAY;
  ...
  // TODO: ex-coupon 7 days
  private static final BondCapitalIndexedSecurityDefinition<CouponInflationZeroCouponMonthlyGearingDefinition> BOND_SECURITY_GILT_1_DEFINITION = BondCapitalIndexedSecurityDefinition
      .fromMonthly(
          PRICE_INDEX_UKRPI, MONTH_LAG_GILT_1, START_DATE_GILT_1, INDEX_START_GILT_1, FIRST_COUPON_DATE_GILT_1, MATURITY_DATE_GILT_1,
          COUPON_PERIOD_GILT_1, NOTIONAL_GILT_1, REAL_RATE_GILT_1,
          BUSINESS_DAY_GBP, SETTLEMENT_DAYS_GILT_1, CalendarAdapter.of(CALENDAR_GBP), DAY_COUNT_GILT_1, YIELD_CONVENTION_GILT_1,
          IS_EOM_GILT_1, ISSUER_UK_GOVT);
  private static final DoubleTimeSeries<ZonedDateTime> UK_RPI = MulticurveProviderDiscountDataSets.ukRpiFrom2010();
  private static final BondCapitalIndexedSecurity<Coupon> BOND_SECURITY_GILT_1 = BOND_SECURITY_GILT_1_DEFINITION.toDerivative(PRICING_DATE,
      UK_RPI);
  ...
  public void presentValueGilt1() {
    ...
    final MultipleCurrencyAmount pvNominal = METHOD_INFLATION_ZC_MONTHLY
        .presentValue((CouponInflationZeroCouponMonthlyGearing) BOND_SECURITY_GILT_1.getNominal().getNthPayment(0), marketUKGovt);
    ...
    assertEquals("Inflation Capital Indexed bond: present value", pvExpectd.getAmount(BOND_SECURITY_GILT_1.getCurrency()),
        pv.getAmount(BOND_SECURITY_GILT_1.getCurrency()), 1.0E-2);
  }
  ...
  private static final BondCapitalIndexedSecurityDefinition<CouponInflationZeroCouponInterpolationGearingDefinition> BOND_SECURITY_TIPS_1_DEFINITION = BondCapitalIndexedSecurityDefinition
      .fromInterpolation(PRICE_INDEX_USCPI, MONTH_LAG_TIPS_1, START_DATE_TIPS_1, INDEX_START_TIPS_1, MATURITY_DATE_TIPS_1,
          COUPON_PERIOD_TIPS_1, NOTIONAL_TIPS_1, REAL_RATE_TIPS_1, BUSINESS_DAY_USD,
          SETTLEMENT_DAYS_TIPS_1, CalendarAdapter.of(CALENDAR_USD), DAY_COUNT_TIPS_1, YIELD_CONVENTION_TIPS_1, IS_EOM_TIPS_1,
          ISSUER_US_GOVT);
  private static final DoubleTimeSeries<ZonedDateTime> US_CPI = MulticurveProviderDiscountDataSets.usCpiFrom2009();
  private static final BondCapitalIndexedSecurity<Coupon> BOND_SECURITY_TIPS_1 = BOND_SECURITY_TIPS_1_DEFINITION.toDerivative(PRICING_DATE,
      US_CPI);
  ...
  public void presentValueTips1() {
    ...
    assertEquals("Inflation Capital Indexed bond: present value", pvExpectd.getAmount(BOND_SECURITY_TIPS_1.getCurrency()),
  ...
  public void presentValueFromCleanPriceRealTips1() {
    ...
    assertEquals("Inflation Capital Indexed bond: present value from clean real price", pvExpected,
        pv.getAmount(BOND_SECURITY_TIPS_1.getCurrency()), 1.0E-6);
  }
  ...
  public void presentValueFromCleanPriceNominalTips1() {
    ...
    final MultipleCurrencyAmount pv = METHOD_BOND_INFLATION.presentValueFromCleanNominalPrice(BOND_SECURITY_TIPS_1, MARKET,
        cleanPriceNominal);
    final ZonedDateTime spot = ScheduleCalculator.getAdjustedDate(PRICING_DATE, SETTLEMENT_DAYS_TIPS_1, CALENDAR_USD);
    final ZonedDateTime refInterpolatedDate = spot.minusMonths(MONTH_LAG_TIPS_1);
    final ZonedDateTime[] referenceEndDate = new ZonedDateTime[2];
    ...
    final double estimatedIndex = weight * estimatedIndexMonth0 + (1 - weight) * estimatedIndexMonth1;
    final double dfSettle = MARKET.getDiscountFactor(BOND_SECURITY_TIPS_1.getCurrency(), BOND_SECURITY_TIPS_1.getSettlementTime());
    final double pvAtSettle = cleanPriceNominal + dfSettle * BOND_SECURITY_TIPS_1.getAccruedInterest() / NOTIONAL_TIPS_1 * estimatedIndex
        / BOND_SECURITY_TIPS_1.getIndexStartValue() * NOTIONAL_TIPS_1;
  ...
  public void dirtyRealPriceFromRealYieldTips1() {
    ...
    for (int loopyield = 0; loopyield < yield.length; loopyield++) {
      ...
      assertEquals("Inflation Capital Indexed bond: yield " + loopyield, dirtyRealPriceExpected[loopyield], dirtyRealPrice[loopyield],
          1.0E-8);
    }
  }
  ...
  public void priceYieldExternalValues1() {
    ...
    final BondCapitalIndexedSecurity<Coupon> bond110817 = BOND_SECURITY_TIPS_1_DEFINITION.toDerivative(pricingDate20110817, US_CPI);
    final double referenceIndexExpected = 225.83129;
    final MultipleCurrencyAmount netAmountSettle = bond110817.getSettlement().accept(NADIC, market.getInflationProvider());
    final double referenceIndexComputed = netAmountSettle.getAmount(bond110817.getCurrency())
        * BOND_SECURITY_TIPS_1_DEFINITION.getIndexStartValue() / bond110817.getSettlement().getNotional();
    ...
    final MultipleCurrencyAmount indexRatioCalculated = bond110817.getSettlement().accept(NADIC, market.getInflationProvider());
    assertEquals("Inflation Capital Indexed bond: indexRatio", indexRatioExpected,
        indexRatioCalculated.getAmount(PRICE_INDEX_USCPI.getCurrency()) / NOTIONAL_TIPS_1, 1.0E-5);
    final double yieldExpected = 1.999644 / 100.0;
    final double dirtyRealPriceComputed = METHOD_BOND_INFLATION.dirtyRealPriceFromCleanRealPrice(bond110817, cleanRealPrice);
    final double yieldComputed = METHOD_BOND_INFLATION.yieldRealFromDirtyRealPrice(bond110817, dirtyRealPriceComputed);
    ...
    final double accruedReal = bond110817.getAccruedInterest();
    ...
    final MultipleCurrencyAmount netAmount = METHOD_BOND_INFLATION.netAmount(bond110817, market, cleanRealPrice);
    assertEquals("Inflation Capital Indexed bond: net amount", netAmountExpected,
        netAmount.getAmount(PRICE_INDEX_USCPI.getCurrency()) * m1 / NOTIONAL_TIPS_1, 2.0E+0); // The difference is due to rounding.
  }
  ...
  public void performance() {
    ...
    for (int i = 0; i < nbTest; i++) {
      for (int j = 0; j < yield.length; j++) {
        dirtyRealPrice[j] = METHOD_BOND_INFLATION.dirtyPriceFromRealYield(BOND_SECURITY_TIPS_1, yield[j]);
      }
    }
    ...
    for (int i = 0; i < nbTest; i++) {
      for (int j = 0; j < yield.length; j++) {
        yieldComputed[j] = METHOD_BOND_INFLATION.yieldRealFromDirtyRealPrice(BOND_SECURITY_TIPS_1, dirtyRealPrice[j]);
      }
    }
    endTime = System.currentTimeMillis();
  ...
  public void presentValueParameterCurveSensitivity() {
    final MultipleCurrencyParameterSensitivity pvicsFD = PS_PV_FDC.calculateSensitivity(BOND_SECURITY_GILT_1.getCoupon(),
        MARKET.getInflationProvider());
    final MultipleCurrencyParameterSensitivity pvicsExact = PSC.calculateSensitivity(BOND_SECURITY_GILT_1.getCoupon(),
        MARKET.getInflationProvider(), MARKET.getAllNames());
  ...
  public void presentValueCurveSensitivity() {
    final InflationProviderInterface creditDiscounting = new InflationProviderDecoratedIssuer(MARKET, BOND_SECURITY_GILT_1.getCurrency(),
    ...
    final MultipleCurrencyInflationSensitivity pvcisMethod = METHOD_BOND_INFLATION.presentValueCurveSensitivity(BOND_SECURITY_GILT_1,
        MARKET);
