...
public class InterestRateFutureOptionMarginTransactionSABRMethodTest {
  ...
  private static final SABRSTIRFuturesProviderDiscount SABR_MULTICURVES = new SABRSTIRFuturesProviderDiscount(MULTICURVES, SABR_PARAMETERS,
      EURIBOR3M);
  ...
  private static final InterestRateFutureSecurityDefinition EDU2_DEFINITION = new InterestRateFutureSecurityDefinition(LAST_TRADING_DATE,
  ...
  private static final InterestRateFutureOptionMarginSecurity OPTION_EDU2 = new InterestRateFutureOptionMarginSecurity(EDU2,
      EXPIRATION_TIME, STRIKE, IS_CALL);
  // Transaction
  private static final int QUANTITY = -123;
  private static final double TRADE_PRICE = 0.0050;
  private static final InterestRateFutureOptionMarginTransaction TRANSACTION = new InterestRateFutureOptionMarginTransaction(OPTION_EDU2,
      QUANTITY, TRADE_PRICE);

  private static final InterestRateFutureOptionMarginTransactionSABRMethod METHOD_SABR_TRA = InterestRateFutureOptionMarginTransactionSABRMethod
      .getInstance();
  private static final InterestRateFutureOptionMarginSecuritySABRMethod METHOD_SABR_SEC = InterestRateFutureOptionMarginSecuritySABRMethod
      .getInstance();
  ...
  private static final PresentValueCurveSensitivitySABRSTIRFuturesCalculator PVCSSFC = PresentValueCurveSensitivitySABRSTIRFuturesCalculator
      .getInstance();
  private static final PresentValueSABRSensitivitySABRSTIRFuturesCalculator PVSSSFC = PresentValueSABRSensitivitySABRSTIRFuturesCalculator
      .getInstance();

  private static final double SHIFT = 1.0E-6;
  private static final ParameterSensitivityParameterCalculator<SABRSTIRFuturesProviderInterface> PSSFC = new ParameterSensitivityParameterCalculator<>(
      PVCSSFC);
  private static final ParameterSensitivitySABRSTIRFuturesDiscountInterpolatedFDCalculator PSSFC_FD = new ParameterSensitivitySABRSTIRFuturesDiscountInterpolatedFDCalculator(
      PVSFC, SHIFT);
  ...
  public void presentValueFromOptionPrice() {
    ...
    final InterestRateFutureOptionMarginTransaction transactionNoPremium = new InterestRateFutureOptionMarginTransaction(OPTION_EDU2,
        QUANTITY, TRADE_PRICE);
  ...
  public void presentValue() {
    ...
    final double pvNoPremiumExpected = METHOD_SABR_TRA.presentValueFromFuturePrice(transactionNoPremium, SABR_MULTICURVES, priceFuture)
        .getAmount(EUR);
  ...
  public void presentValueMethodVsCalculator() {
    ...
    assertEquals("Future option: present value: Method vs Calculator", pvNoPremiumMethod.getAmount(EUR),
        pvNoPremiumCalculator.getAmount(EUR), TOLERANCE_PV);
  }
  ...
  public void presentValueCurveSensitivity() {
    final MultipleCurrencyParameterSensitivity pvpsDepositExact = PSSFC.calculateSensitivity(TRANSACTION, SABR_MULTICURVES,
    ...
    AssertSensitivityObjects.assertEquals("InterestRateFutureOptionMarginTransactionSABRMethod: presentValueCurveSensitivity",
  ...
  public void presentValueCurveSensitivityMethodVsCalculator() {
    ...
    AssertSensitivityObjects.assertEquals("InterestRateFutureOptionMarginTransactionSABRMethod: presentValueCurveSensitivity", pvcsMethod,
  ...
  public void presentValueSABRSensitivity() {
    ...
    final SABRSTIRFuturesProviderDiscount sabrBundleAlphaBumped = new SABRSTIRFuturesProviderDiscount(MULTICURVES, sabrParameterAlphaBumped,
        EURIBOR3M);
    ...
    final SABRSTIRFuturesProviderDiscount sabrBundleRhoBumped = new SABRSTIRFuturesProviderDiscount(MULTICURVES, sabrParameterRhoBumped,
        EURIBOR3M);
    ...
    final SABRSTIRFuturesProviderDiscount sabrBundleNuBumped = new SABRSTIRFuturesProviderDiscount(MULTICURVES, sabrParameterNuBumped,
        EURIBOR3M);
  ...
  public void presentValueSABRSensitivityMethodVsCalculator() {
    ...
    assertEquals("Future discounting curve sensitivity: security price vs transaction sensitivity", sensiMethod.getAlpha(),
        sensiSecurity.getAlpha());
    assertEquals("Future discounting curve sensitivity: security price vs transaction sensitivity", sensiMethod.getRho(),
        sensiSecurity.getRho());
    assertEquals("Future discounting curve sensitivity: security price vs transaction sensitivity", sensiMethod.getNu(),
        sensiSecurity.getNu());
  }
