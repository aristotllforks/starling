...
public class CouponIborCompoundingSimpleSpreadDiscountingMethodTest {
  ...
  private static final CouponIborCompoundingSimpleSpreadDefinition CPN_DEFINITION = CouponIborCompoundingSimpleSpreadDefinition.from(
      NOTIONAL, START_DATE, END_DATE, CADCDOR3M, SPREAD,
      StubType.SHORT_START, CADCDOR3M.getBusinessDayConvention(), CADCDOR3M.isEndOfMonth(), CalendarAdapter.of(CALENDAR));

  private static final CouponIborCompoundingSimpleSpreadDiscountingMethod METHOD_COMPOUNDED = CouponIborCompoundingSimpleSpreadDiscountingMethod
      .getInstance();

  private static final ZonedDateTime REFERENCE_DATE_BEFORE = DateUtils.getUTCDate(2012, 8, 7);
  private static final CouponIborCompoundingSimpleSpread CPN_BEFORE = CPN_DEFINITION.toDerivative(REFERENCE_DATE_BEFORE); // Reference date
                                                                                                                          // before the
                                                                                                                          // coupon start
                                                                                                                          // date.
  ...
  private static final CouponIborCompoundingSimpleSpread CPN_1 = (CouponIborCompoundingSimpleSpread) CPN_DEFINITION
  ...
  public void presentValueMethodVsCalculator() {
    ...
    assertEquals("CouponIborCompoundingSimpleSpreadDiscountingMethod: Present value", pvMethod.getAmount(CAD),
  ...
  public void presentValueCurveSensitivity() {
    ...
    AssertSensitivityObjects.assertEquals("CouponIborCompoundingSimpleSpreadDiscountingMethod: presentValueCurveSensitivity ",
  ...
  public void presentValueCurveSensitivityMethodVsCalculator() {
    ...
    AssertSensitivityObjects.assertEquals("CouponIborCompoundingSimpleSpreadDiscountingMethod: Present value curve sensitivity", pvcsMethod,
