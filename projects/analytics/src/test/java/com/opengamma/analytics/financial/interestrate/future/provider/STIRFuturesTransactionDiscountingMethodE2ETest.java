...
/**
 * Tests the STIR Futures discounting method with standard data. Swap Desk EUR 1 / pv - bpv01 / OIS-IRS3-IRS6
 */
...
public class STIRFuturesTransactionDiscountingMethodE2ETest {
  ...
  private static final WorkingDayCalendar CALENDAR = StandardDataSetsMulticurveEUR.calendarArray()[0];
  ...
  private static final Pair<MulticurveProviderDiscount, CurveBuildingBlockBundle> MULTICURVE_PAIR = StandardDataSetsMulticurveEUR
      .getCurvesUSDOisL3();
  ...
  private static final InterestRateFutureSecurityDefinition ERZ4_SEC_DEFINITION = new InterestRateFutureSecurityDefinition(
      LAST_TRADING_DATE, EUREURIBOR3M, NOTIONAL, FUTURE_FACTOR, NAME, CalendarAdapter.of(CALENDAR));
  ...
  private static final InterestRateFutureTransactionDefinition ERZ4_TRA_DEFINITION = new InterestRateFutureTransactionDefinition(
      ERZ4_SEC_DEFINITION, QUANTITY, TRADE_DATE, TRADE_PRICE);
  ...
  public void presentValue() {
    ...
    assertEquals("STIRFuturesTransactionDiscountingMethod: present value from standard curves", pvExpected.getAmount(EUR),
        pvComputed.getAmount(EUR), TOLERANCE_PV);
  }
  ...
  public void bucketedPV01() {
    final double[] deltaDsc = { 0.0003, 0.0003, 0.0000, 0.0000, 1.7334, 3.0714, 4.6402, -18.8887, -0.9835, 0.0000, 0.0000, 0.0000, 0.0000,
        0.0000, 0.0000, 0.0000 };
    final double[] deltaFwd = { -2398.5241, -2479.7772, -2479.1440, 9422.5946, 912.6277, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000,
