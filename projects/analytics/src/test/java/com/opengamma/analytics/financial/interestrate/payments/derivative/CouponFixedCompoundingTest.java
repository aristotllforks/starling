...
public class CouponFixedCompoundingTest {
  ...
  private static final CouponFixedCompounding CPN = new CouponFixedCompounding(USDLIBOR1M.getCurrency(), PAYMENT_TIME,
      PAYMENT_ACCRUAL_FACTOR, NOTIONAL,
  ...
  public void testWithNotional() {
    ...
    final CouponFixedCompounding expected = new CouponFixedCompounding(USDLIBOR1M.getCurrency(), PAYMENT_TIME, PAYMENT_ACCRUAL_FACTOR,
        notional,
        PAYMENT_ACCRUAL_FACTORS, FIXED_RATE);
  ...
  public void testEqualHash() {
    ...
    final CouponFixedCompounding other = new CouponFixedCompounding(USDLIBOR1M.getCurrency(), PAYMENT_TIME, PAYMENT_ACCRUAL_FACTOR,
        NOTIONAL,
        PAYMENT_ACCRUAL_FACTORS, FIXED_RATE);
