...
public class CouponONArithmeticAverageSpreadSimplifiedTest {
  ...
  private static final CouponONArithmeticAverageDefinition FEDFUND_CPN_3M_2_DEF = CouponONArithmeticAverageDefinition.from(FEDFUND,
      ACCRUAL_START_DATE, ACCRUAL_END_DATE, NOTIONAL, PAYMENT_LAG, CalendarAdapter.of(CALENDAR));

  private static final CouponONArithmeticAverageSpreadSimplified CPN_AA_ON = CouponONArithmeticAverageSpreadSimplified.from(PAYMENT_TIME,
  ...
  public void nullIndex() {
    CouponONArithmeticAverageSpreadSimplified.from(PAYMENT_TIME, FEDFUND_CPN_3M_2_DEF.getPaymentYearFraction(), NOTIONAL, null,
        ACCRUAL_START_TIME, ACCRUAL_END_TIME, ACCRUAL_FACTOR, SPREAD);
  }
  ...
  public void equalHash() {
    ...
    final CouponONArithmeticAverageSpreadSimplified other = CouponONArithmeticAverageSpreadSimplified.from(PAYMENT_TIME,
        FEDFUND_CPN_3M_2_DEF.getPaymentYearFraction(),
        NOTIONAL, FEDFUND, ACCRUAL_START_TIME, ACCRUAL_END_TIME, ACCRUAL_FACTOR, SPREAD);
    ...
    modified = CouponONArithmeticAverageSpreadSimplified.from(PAYMENT_TIME, FEDFUND_CPN_3M_2_DEF.getPaymentYearFraction() + 0.1, NOTIONAL,
        FEDFUND, ACCRUAL_START_TIME, ACCRUAL_END_TIME,
        ACCRUAL_FACTOR, SPREAD);
    assertFalse("CouponArithmeticAverageONSpreadSimplified: equal-hash", CPN_AA_ON.equals(modified));
    modified = CouponONArithmeticAverageSpreadSimplified.from(PAYMENT_TIME, FEDFUND_CPN_3M_2_DEF.getPaymentYearFraction(), NOTIONAL + 0.1,
        FEDFUND, ACCRUAL_START_TIME, ACCRUAL_END_TIME,
        ACCRUAL_FACTOR, SPREAD);
    assertFalse("CouponArithmeticAverageONSpreadSimplified: equal-hash", CPN_AA_ON.equals(modified));
    final IndexON modifiedIndex = IndexONMaster.getInstance().getIndex("EONIA");
    modified = CouponONArithmeticAverageSpreadSimplified.from(PAYMENT_TIME, FEDFUND_CPN_3M_2_DEF.getPaymentYearFraction(), NOTIONAL,
        modifiedIndex, ACCRUAL_START_TIME, ACCRUAL_END_TIME,
        ACCRUAL_FACTOR, SPREAD);
    assertFalse("CouponArithmeticAverageONSpreadSimplified: equal-hash", CPN_AA_ON.equals(modified));
    modified = CouponONArithmeticAverageSpreadSimplified.from(PAYMENT_TIME, FEDFUND_CPN_3M_2_DEF.getPaymentYearFraction(), NOTIONAL,
        FEDFUND, ACCRUAL_START_TIME + 0.1, ACCRUAL_END_TIME,
        ACCRUAL_FACTOR, SPREAD);
    assertFalse("CouponArithmeticAverageONSpreadSimplified: equal-hash", CPN_AA_ON.equals(modified));
    modified = CouponONArithmeticAverageSpreadSimplified.from(PAYMENT_TIME, FEDFUND_CPN_3M_2_DEF.getPaymentYearFraction(), NOTIONAL,
        FEDFUND, ACCRUAL_START_TIME, ACCRUAL_END_TIME + 0.1,
