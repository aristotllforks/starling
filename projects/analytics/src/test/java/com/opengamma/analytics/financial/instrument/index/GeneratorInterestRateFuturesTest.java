...
public class GeneratorInterestRateFuturesTest {
  ...
  private static final ZonedDateTime LAST_TRADING_DATE = ScheduleCalculator.getAdjustedDate(FIXING_PERIOD_START_DATE,
      -USDLIBOR3M.getSpotLag(), NYC);
  private static final double NOTIONAL = 1000000;
  private static final InterestRateFutureSecurityDefinition FUTURES_DEFINITION = new InterestRateFutureSecurityDefinition(LAST_TRADING_DATE,
      USDLIBOR3M, NOTIONAL, 0.25, "IRF", CalendarAdapter.of(NYC));
  ...
  public void generateInstrument() {
    ...
    final InterestRateFutureTransactionDefinition insGenerated = GENERATOR_FUTURES_ED.generateInstrument(referenceDate, price, notional,
        attribute);
    final InterestRateFutureTransactionDefinition insExpected = new InterestRateFutureTransactionDefinition(FUTURES_DEFINITION, quantity,
        referenceDate, price);
