...
public class CouponONSpreadDiscountingMethodTest {
  ...
  private static final CouponONSpreadSimplifiedDefinition CPN_OIS_DEFINITION = CouponONSpreadSimplifiedDefinition.from(EONIA,
      EFFECTIVE_DATE, TENOR, NOTIONAL, SPREAD, 2,
      GENERATOR_SWAP_EONIA.getBusinessDayConvention(), GENERATOR_SWAP_EONIA.isEndOfMonth(), CalendarAdapter.of(CALENDAR));
  ...
  public void presentValue() {
    ...
    final double pvExpected = (NOTIONAL * CPN_OIS.getFixingPeriodAccrualFactor() * forward + SPREAD_AMOUNT)
