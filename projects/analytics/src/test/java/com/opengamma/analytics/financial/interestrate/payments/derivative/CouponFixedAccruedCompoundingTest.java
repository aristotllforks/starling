...
public class CouponFixedAccruedCompoundingTest {
  ...
  private static final ZonedDateTime ACCRUAL_END_DATE = ScheduleCalculator.getAdjustedDate(START_DATE, TENOR_3M,
  ...
  private static final double PAYMENT_ACCRUAL_FACTOR = DAY_COUNT.getDayCountFraction(REFERENCE_DATE, ACCRUAL_END_DATE,
      CalendarAdapter.of(CALENDAR));
  private static final double FIXED_RATE = .02;

  private static final CouponFixedAccruedCompounding CPN = new CouponFixedAccruedCompounding(USDLIBOR1M.getCurrency(), PAYMENT_TIME,
      PAYMENT_ACCRUAL_FACTOR, NOTIONAL, FIXED_RATE);
  private static final CouponFixedAccruedCompounding CPN_WITH_ACCRUAL_TIMES = new CouponFixedAccruedCompounding(USDLIBOR1M.getCurrency(),
      PAYMENT_TIME, PAYMENT_ACCRUAL_FACTOR, NOTIONAL, FIXED_RATE,
  ...
  public void testEqualHash() {
    ...
    final CouponFixedAccruedCompounding other = new CouponFixedAccruedCompounding(USDLIBOR1M.getCurrency(), PAYMENT_TIME,
        PAYMENT_ACCRUAL_FACTOR, NOTIONAL, FIXED_RATE);
