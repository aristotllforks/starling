...
public class InterestRateFutureTransactionHullWhiteMethodTest {
  ...
  private static final InterestRateFutureSecurityDefinition ERU2_SEC_DEFINITION = new InterestRateFutureSecurityDefinition(
      LAST_TRADING_DATE, EURIBOR3M, NOTIONAL, FUTURE_FACTOR, NAME, CalendarAdapter.of(CALENDAR));
  private static final InterestRateFutureTransactionDefinition ERU2_TRA_DEFINITION = new InterestRateFutureTransactionDefinition(
      ERU2_SEC_DEFINITION, QUANTITY, TRADE_DATE, TRADE_PRICE);
  ...
  private static final HullWhiteOneFactorProviderDiscount HW_MULTICURVES = new HullWhiteOneFactorProviderDiscount(MULTICURVES,
      MODEL_PARAMETERS, EUR);

  private static final InterestRateFutureTransactionHullWhiteMethod METHOD_IRFUT_TRA_HW = InterestRateFutureTransactionHullWhiteMethod
      .getInstance();
  private static final InterestRateFutureSecurityHullWhiteMethod METHOD_IRFUT_SEC_HW = InterestRateFutureSecurityHullWhiteMethod
      .getInstance();
  ...
  public void presentValueMethodVsCalculator() {
    ...
    assertEquals(pvCalculator.getAmount(EUR), pvMethod.getAmount(EUR), TOLERANCE_PV);
  }
  ...
  public void marketQuote() {
    ...
    assertEquals(priceMethod, marketQuote, TOLERANCE_PRICE);
  }
  ...
  public void presentValueCurveSensitivity() {
    final MultipleCurrencyParameterSensitivity pvpsDepositExact = PSHWC.calculateSensitivity(ERU2_TRA, HW_MULTICURVES,
    ...
    AssertSensitivityObjects.assertEquals(pvpsDepositExact, pvpsDepositFD, TOLERANCE_PV_DELTA);
  }
  ...
  public void comparisonDiscounting() {
    ...
    final double priceDiscounting = methodDiscounting.price(ERU2_SEC, HW_MULTICURVES);
    final double priceHullWhite = METHOD_IRFUT_SEC_HW.price(ERU2_SEC, HW_MULTICURVES);
    assertTrue(priceDiscounting > priceHullWhite);
  }
