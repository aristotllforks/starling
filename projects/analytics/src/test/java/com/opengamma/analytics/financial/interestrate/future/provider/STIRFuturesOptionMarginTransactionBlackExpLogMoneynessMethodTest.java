...
public class STIRFuturesOptionMarginTransactionBlackExpLogMoneynessMethodTest {
  ...
  private static final InterestRateFutureSecurityDefinition ERZ4_DEFINITION = new InterestRateFutureSecurityDefinition(LAST_TRADE_DATE,
  ...
  private static final InterestRateFutureOptionMarginSecurityDefinition CALL_ERZ4_099_SEC_DEFINITION = new InterestRateFutureOptionMarginSecurityDefinition(
      ERZ4_DEFINITION, EXPIRY_DATE, STRIKE_099, IS_CALL);
  private static final InterestRateFutureOptionMarginSecurityDefinition PUT_ERZ4_099_SEC_DEFINITION = new InterestRateFutureOptionMarginSecurityDefinition(
      ERZ4_DEFINITION, EXPIRY_DATE, STRIKE_099, !IS_CALL);
  ...
  private static final InterestRateFutureOptionMarginTransactionDefinition CALL_ERZ4_099_TRA_1_DEFINITION = new InterestRateFutureOptionMarginTransactionDefinition(
      CALL_ERZ4_099_SEC_DEFINITION, QUANTITY, TRADE_DATE, TRADE_PRICE);
  private static final InterestRateFutureOptionMarginTransactionDefinition CALL_ERZ4_099_TRA_2_DEFINITION = new InterestRateFutureOptionMarginTransactionDefinition(
      CALL_ERZ4_099_SEC_DEFINITION, QUANTITY, TRADE_DATE.minusDays(1), TRADE_PRICE);
  private static final InterestRateFutureOptionMarginTransactionDefinition PUT_ERZ4_099_TRA_1_DEFINITION = new InterestRateFutureOptionMarginTransactionDefinition(
      PUT_ERZ4_099_SEC_DEFINITION, QUANTITY, TRADE_DATE, TRADE_PRICE);
  private static final InterestRateFutureTransactionDefinition ERZ4_TRA_STRIKE_DEFINITION = new InterestRateFutureTransactionDefinition(
      ERZ4_DEFINITION, QUANTITY, TRADE_DATE, STRIKE_099);
  ...
  private static final InterestRateFutureOptionMarginTransaction CALL_ERZ4_099_TRA_1 = CALL_ERZ4_099_TRA_1_DEFINITION
      .toDerivative(REFERENCE_DATE, REFERENCE_PRICE);
  private static final InterestRateFutureOptionMarginTransaction CALL_ERZ4_099_TRA_2 = CALL_ERZ4_099_TRA_2_DEFINITION
      .toDerivative(REFERENCE_DATE, REFERENCE_PRICE);
  private static final InterestRateFutureOptionMarginTransaction PUT_ERZ4_099_TRA_1 = PUT_ERZ4_099_TRA_1_DEFINITION
      .toDerivative(REFERENCE_DATE, REFERENCE_PRICE);
  ...
  final private static BlackSTIRFuturesExpLogMoneynessProviderDiscount MULTICURVE_BLACK = new BlackSTIRFuturesExpLogMoneynessProviderDiscount(
      MULTICURVE, BLACK_SURFACE_LOGMONEY, EURIBOR3M);

  /** Methods and calculators */
  private static final InterestRateFutureOptionMarginSecurityBlackSTIRFuturesMethod METHOD_OPT_SEC = InterestRateFutureOptionMarginSecurityBlackSTIRFuturesMethod
      .getInstance();
  ...
  private static final PresentValueCurveSensitivityBlackSTIRFutureOptionCalculator PVCSBFOC = PresentValueCurveSensitivityBlackSTIRFutureOptionCalculator
      .getInstance();
  private static final double SHIFT_FD = 1.0E-7;
  private static final ParameterSensitivityParameterCalculator<BlackSTIRFuturesProviderInterface> PSSFC = new ParameterSensitivityParameterCalculator<>(
      PVCSBFOC);
  private static final ParameterSensitivityBlackSTIRFuturesExpLogMoneynessDiscountInterpolatedFDCalculator PSSFC_FD = new ParameterSensitivityBlackSTIRFuturesExpLogMoneynessDiscountInterpolatedFDCalculator(
      PVBFOC, SHIFT_FD);
  ...
  public void presentValue() {
    ...
    final double pvExpected1 = (priceOpt1 - TRADE_PRICE) * ERZ4_DEFINITION.getNotional() * ERZ4_DEFINITION.getPaymentAccrualFactor()
        * QUANTITY;
    ...
    assertEquals("BondFuturesOptionMarginTransactionBlackFlatMethod: present value", pvExpected1, pvCalculator.getAmount(EUR),
        TOLERANCE_PV);
    ...
    final double pvExpected2 = (priceOpt2 - REFERENCE_PRICE) * ERZ4_DEFINITION.getNotional() * ERZ4_DEFINITION.getPaymentAccrualFactor()
        * QUANTITY;
  ...
  /**
   * Test using the flat smile. This is required for a finite difference comparison, as the model is the Black sensitivity and a full bump
   * and re-price with volatility interpolation would change the volatility (and the risk).
   */
  @Test
  public void presentValueCurveSensitivity() {
    ...
    AssertSensitivityObjects.assertEquals("BondFuturesOptionMarginTransactionBlackFlatMethod: presentValueCurveSensitivity", pvpsFD,
  ...
  public void presentValueBlackSensitivity() {
    ...
    final BlackSTIRFuturesExpLogMoneynessProvider blackShiftedPlus = new BlackSTIRFuturesExpLogMoneynessProvider(MULTICURVE,
        shiftedSurfacePlus, EURIBOR3M);
    final BlackSTIRFuturesExpLogMoneynessProvider blackShiftedMinus = new BlackSTIRFuturesExpLogMoneynessProvider(MULTICURVE,
        shiftedSurfaceMinus, EURIBOR3M);
    ...
    final double vegaExpected = (pvP.getAmount(CALL_ERZ4_099_TRA_1.getCurrency()) - pvM.getAmount(CALL_ERZ4_099_TRA_1.getCurrency()))
        / (2 * shiftVega);
    final double vegaComputed = METHOD_OPT_TRA.presentValueBlackSensitivity(CALL_ERZ4_099_TRA_1, MULTICURVE_BLACK).getSensitivity()
        .toSingleValue();
    assertEquals("STIRFuturesOptionMarginTransactionBlackExpLogMoneynessMethod: present value Black sensitivity", vegaExpected,
        vegaComputed, TOLERANCE_PV_DELTA);
  }
