...
public class BondFutureOptionPremiumSecurityBlackSurfaceMethodTest {
  ...
  private static final BlackBondFuturesSmilePriceProvider BLACK_PRICE_MULTICURVES = new BlackBondFuturesSmilePriceProvider(
      BLACK_MULTICURVES, PRICE_FUTURE);

  private static final double STRIKE = 1.04;
  private static final BondFutureOptionPremiumSecurity BOND_FUTURE_OPTION_DERIV_CALL = new BondFutureOptionPremiumSecurity(
      BOND_FUTURE_DERIV, OPTION_EXPIRY, STRIKE, true);
  private static final BondFutureOptionPremiumSecurity BOND_FUTURE_OPTION_DERIV_PUT = new BondFutureOptionPremiumSecurity(BOND_FUTURE_DERIV,
      OPTION_EXPIRY, STRIKE, false);
  ...
  public void priceFromFuturePrice() {
    final double callBlackPrice = BlackFormulaRepository.price(PRICE_FUTURE, STRIKE, OPTION_EXPIRY,
        BLACK_MULTICURVES.getVolatility(OPTION_EXPIRY, STRIKE), true);
    assertEquals("BondFutureOptionPremiumSecurityBlackSurfaceMethod: option price from future price", callBlackPrice,
        METHOD_BLACK_SEC.price(BOND_FUTURE_OPTION_DERIV_CALL, BLACK_PRICE_MULTICURVES),
        EPS);
    final double putBlackPrice = BlackFormulaRepository.price(PRICE_FUTURE, STRIKE, OPTION_EXPIRY,
        BLACK_MULTICURVES.getVolatility(OPTION_EXPIRY, STRIKE), false);
    assertEquals("BondFutureOptionPremiumSecurityBlackSurfaceMethod: option price from future price", putBlackPrice,
        METHOD_BLACK_SEC.price(BOND_FUTURE_OPTION_DERIV_PUT, BLACK_PRICE_MULTICURVES), EPS);
    assertEquals("BondFutureOptionPremiumSecurityBlackSurfaceMethod: option price from future price", PRICE_FUTURE - STRIKE,
        callBlackPrice - putBlackPrice, EPS);
  }
  ...
  public void priceFromCurves() {
    ...
    assertEquals("BondFutureOptionPremiumSecurityBlackSurfaceMethod: option price", priceFuture,
        METHOD_BLACK_SEC.underlyingFuturePrice(BOND_FUTURE_OPTION_DERIV_PUT, ISSUER_MULTICURVES), EPS);
    final double callBlackPrice = BlackFormulaRepository.price(priceFuture, STRIKE, OPTION_EXPIRY,
        BLACK_MULTICURVES.getVolatility(OPTION_EXPIRY, STRIKE), true);
    assertEquals("BondFutureOptionPremiumSecurityBlackSurfaceMethod: option price", callBlackPrice,
        METHOD_BLACK_SEC.price(BOND_FUTURE_OPTION_DERIV_CALL, BLACK_MULTICURVES), EPS);
    final double putBlackPrice = BlackFormulaRepository.price(priceFuture, STRIKE, OPTION_EXPIRY,
        BLACK_MULTICURVES.getVolatility(OPTION_EXPIRY, STRIKE), false);
    assertEquals("BondFutureOptionPremiumSecurityBlackSurfaceMethod: option price", putBlackPrice,
        METHOD_BLACK_SEC.price(BOND_FUTURE_OPTION_DERIV_PUT, BLACK_MULTICURVES), EPS);
  }
  ...
  public void priceCurveSensitivityFromCurves() {
    final MulticurveSensitivity pcsCallComputed = METHOD_BLACK_SEC.priceCurveSensitivity(BOND_FUTURE_OPTION_DERIV_CALL, BLACK_MULTICURVES)
        .cleaned();
    ...
    AssertSensitivityObjects.assertEquals(
        "BondFutureOptionPremiumSecurityBlackSurfaceMethod: option price curve sensitivity - put/call parity", pcsFuture, pcsCallPut,
        TOLERANCE_PRICE_SENSI);
    ...
    AssertSensitivityObjects.assertEquals("BondFutureOptionPremiumSecurityBlackSurfaceMethod: option price curve sensitivity",
        pcsCallExpected, pcsCallComputed, TOLERANCE_PRICE_SENSI);
  }
  ...
  public void priceCurveSensitivityFromFuturesPrice() {
    final MulticurveSensitivity pcsCallComputed = METHOD_BLACK_SEC
        .priceCurveSensitivity(BOND_FUTURE_OPTION_DERIV_CALL, BLACK_PRICE_MULTICURVES).cleaned();
    final MulticurveSensitivity pcsCallNoFut = METHOD_BLACK_SEC.priceCurveSensitivity(BOND_FUTURE_OPTION_DERIV_CALL, BLACK_MULTICURVES)
        .cleaned();
    AssertSensitivityObjects.assertDoesNotEqual("BondFutureOptionPremiumSecurityBlackSurfaceMethod: option price curve sensitivity",
        pcsCallComputed, pcsCallNoFut, TOLERANCE_PRICE_SENSI);
    final MulticurveSensitivity pcsPutComputed = METHOD_BLACK_SEC.priceCurveSensitivity(BOND_FUTURE_OPTION_DERIV_PUT,
        BLACK_PRICE_MULTICURVES);
    final MulticurveSensitivity pcsFuture = METHOD_FUTURES.priceCurveSensitivity(BOND_FUTURE_DERIV, ISSUER_MULTICURVES).cleaned();
    final MulticurveSensitivity pcsCallPut = pcsCallComputed.plus(pcsPutComputed.multipliedBy(-1.0)).cleaned();
    AssertSensitivityObjects.assertEquals(
        "BondFutureOptionPremiumSecurityBlackSurfaceMethod: option price curve sensitivity - put/call parity", pcsFuture, pcsCallPut,
  ...
  public void testGreeksFromFuturePrice() {
    final double callBlackDelta = BlackFormulaRepository.delta(PRICE_FUTURE, STRIKE, OPTION_EXPIRY,
        BLACK_MULTICURVES.getVolatility(OPTION_EXPIRY, STRIKE), true);
    assertEquals(callBlackDelta, METHOD_BLACK_SEC.priceDelta(BOND_FUTURE_OPTION_DERIV_CALL, BLACK_PRICE_MULTICURVES), EPS);
    final double putBlackDelta = BlackFormulaRepository.delta(PRICE_FUTURE, STRIKE, OPTION_EXPIRY,
        BLACK_MULTICURVES.getVolatility(OPTION_EXPIRY, STRIKE), false);
    assertEquals(putBlackDelta, METHOD_BLACK_SEC.priceDelta(BOND_FUTURE_OPTION_DERIV_PUT, BLACK_PRICE_MULTICURVES), EPS);
    final double blackVega = BlackFormulaRepository.vega(PRICE_FUTURE, STRIKE, OPTION_EXPIRY,
        BLACK_MULTICURVES.getVolatility(OPTION_EXPIRY, STRIKE));
    ...
    final double blackGamma = BlackFormulaRepository.gamma(PRICE_FUTURE, STRIKE, OPTION_EXPIRY,
        BLACK_MULTICURVES.getVolatility(OPTION_EXPIRY, STRIKE));
  ...
  public void testGreeks() {
    final double priceFuture = METHOD_BLACK_SEC.underlyingFuturePrice(BOND_FUTURE_OPTION_DERIV_CALL, ISSUER_MULTICURVES);
    final double callBlackDelta = BlackFormulaRepository.delta(priceFuture, STRIKE, OPTION_EXPIRY,
        BLACK_MULTICURVES.getVolatility(OPTION_EXPIRY, STRIKE), true);
    assertEquals(callBlackDelta, METHOD_BLACK_SEC.priceDelta(BOND_FUTURE_OPTION_DERIV_CALL, BLACK_MULTICURVES), EPS);
    final double putBlackDelta = BlackFormulaRepository.delta(priceFuture, STRIKE, OPTION_EXPIRY,
        BLACK_MULTICURVES.getVolatility(OPTION_EXPIRY, STRIKE), false);
    assertEquals(putBlackDelta, METHOD_BLACK_SEC.priceDelta(BOND_FUTURE_OPTION_DERIV_PUT, BLACK_MULTICURVES), EPS);
    final double blackVega = BlackFormulaRepository.vega(priceFuture, STRIKE, OPTION_EXPIRY,
        BLACK_MULTICURVES.getVolatility(OPTION_EXPIRY, STRIKE));
    ...
    final double blackGamma = BlackFormulaRepository.gamma(priceFuture, STRIKE, OPTION_EXPIRY,
        BLACK_MULTICURVES.getVolatility(OPTION_EXPIRY, STRIKE));
