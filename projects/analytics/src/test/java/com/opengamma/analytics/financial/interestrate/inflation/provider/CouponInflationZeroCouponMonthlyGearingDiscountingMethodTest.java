...
public class CouponInflationZeroCouponMonthlyGearingDiscountingMethodTest {
  ...
  private static final CouponInflationZeroCouponMonthlyGearingDefinition ZERO_COUPON_NO_DEFINITION = CouponInflationZeroCouponMonthlyGearingDefinition
  ...
  private static final CouponInflationZeroCouponMonthlyGearingDefinition ZERO_COUPON_WITH_DEFINITION = CouponInflationZeroCouponMonthlyGearingDefinition
      .from(START_DATE, PAYMENT_DATE, NOTIONAL,
  ...
  public void presentValueCurveSensitivityWithNotional() {
    ...
    AssertSensitivityObjects.assertEquals("DepositCounterpartDiscountingMethod: presentValueCurveSensitivity ", pvicsExact, pvicsFD,
        TOLERANCE_PV_DELTA);
