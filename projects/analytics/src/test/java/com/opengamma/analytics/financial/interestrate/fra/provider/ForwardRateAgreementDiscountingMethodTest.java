...
public class ForwardRateAgreementDiscountingMethodTest {
  ...
  private static final WorkingDayCalendar CALENDAR = MulticurveProviderDiscountDataSets.getUSDCalendar();
  ...
  private static final ForwardRateAgreementDefinition FRA_DEFINITION = new ForwardRateAgreementDefinition(CUR, PAYMENT_DATE,
      ACCRUAL_START_DATE, ACCRUAL_END_DATE, ACCRUAL_FACTOR_PAYMENT, NOTIONAL,
      FIXING_DATE, USDLIBOR3M, FRA_RATE, CalendarAdapter.of(CALENDAR));
  // To derivatives
  ...
  private static final ForwardRateAgreementDiscountingProviderMethod FRA_METHOD = ForwardRateAgreementDiscountingProviderMethod
      .getInstance();
  ...
  public void parRate() {
    ...
    final double forwardExpected = MULTICURVE.getSimplyCompoundForwardRate(USDLIBOR3M, FRA.getFixingPeriodStartTime(),
        FRA.getFixingPeriodEndTime(), FRA.getFixingYearFraction());
  ...
  public void presentValue() {
    ...
    final double expectedPv = FRA.getNotional() * dfSettle * FRA.getPaymentYearFraction() * (forward - FRA_RATE)
  ...
  public void presentValueBuySellParity() {
    final ForwardRateAgreementDefinition fraDefinitionSell = new ForwardRateAgreementDefinition(CUR, PAYMENT_DATE, ACCRUAL_START_DATE,
        ACCRUAL_END_DATE, ACCRUAL_FACTOR_PAYMENT, -NOTIONAL,
        FIXING_DATE, USDLIBOR3M, FRA_RATE, CalendarAdapter.of(CALENDAR));
  ...
  public void parSpread() {
    ...
    final ForwardRateAgreementDefinition fra0Definition = new ForwardRateAgreementDefinition(CUR, PAYMENT_DATE, ACCRUAL_START_DATE,
        ACCRUAL_END_DATE, ACCRUAL_FACTOR_PAYMENT, NOTIONAL, FIXING_DATE,
        USDLIBOR3M, FRA_RATE + parSpread, CalendarAdapter.of(CALENDAR));
