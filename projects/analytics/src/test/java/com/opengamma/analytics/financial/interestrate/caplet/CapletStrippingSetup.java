...
public abstract class CapletStrippingSetup {
  ...
  private static final double[] CAP_STRIKES = new double[] { 0.005, 0.01, 0.015, 0.02, 0.025, 0.03, 0.035, 0.04, 0.045, 0.05, 0.055, 0.06,
  ...
  private static final double[][] CAP_VOLS = new double[][] { { 0.7175, 0.7781, 0.8366, Double.NaN, 0.8101, 0.7633, 0.714 },
      { Double.NaN, 0.7309, 0.7523, 0.7056, 0.66095, 0.5933, 0.5313 },
      { Double.NaN, 0.78086, 0.73987, 0.667, 0.61469, 0.53502, 0.4691 }, { Double.NaN, 0.7335, 0.71235, 0.63455, 0.56975, 0.48235, 0.4369 },
      { Double.NaN, 0.80496, 0.73408, 0.6081, 0.5472, 0.46445, 0.38854 }, { Double.NaN, 0.737, 0.7179, 0.61055, 0.52865, 0.432, 0.365 },
      { Double.NaN, 0.737, 0.7179, 0.61055, 0.52865, 0.432, 0.365 },
      { 0.96976, 0.82268, 0.73761, Double.NaN, 0.5168, 0.4183, 0.35485 }, { 0.98927, 0.8376, 0.7274, 0.5983, 0.5169, 0.4083, 0.3375 },
      { 1.00627, 0.83618, 0.74276, 0.6003, Double.NaN, Double.NaN, 0.34498 }, { 1.02132, 0.8391, 0.7226, 0.5921, 0.4984, 0.3914, 0.32155 },
      { 1.0255, 0.8406, 0.7196, 0.5962, 0.5035, 0.3873, 0.3227 },
      { 1.0476, 0.8411, 0.7072, 0.58845, 0.50055, 0.3856, 0.3135 }, { 1.0467, 0.73755, 0.70655, 0.5855, 0.50165, 0.3824, 0.3093 },
      { Double.NaN, 0.72535, 0.70495, 0.58455, 0.499, 0.3802, 0.316 },
      { Double.NaN, 0.8458, 0.70345, 0.58335, 0.4984, 0.38905, 0.3164 }, { Double.NaN, 0.8489, 0.70205, 0.58245, 0.4999, 0.39155, 0.3239 },
      { Double.NaN, 0.7402, 0.7009, 0.5824, 0.5059, 0.4005, 0.3255 },
  ...
  static {
    ...
    YIELD_CURVES = new MulticurveProviderDiscount(Collections.singletonMap(CUR, disCurve), Collections.singletonMap(INDEX, indexCurve),
        Collections.emptyMap(), new FXMatrix());
  }
