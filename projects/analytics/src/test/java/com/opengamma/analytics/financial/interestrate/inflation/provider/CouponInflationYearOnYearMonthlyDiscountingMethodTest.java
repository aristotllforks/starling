...
public class CouponInflationYearOnYearMonthlyDiscountingMethodTest {
  ...
  private static final CouponInflationYearOnYearMonthlyDefinition YEAR_ON_YEAR_NO_DEFINITION = CouponInflationYearOnYearMonthlyDefinition
  ...
  private static final CouponInflationYearOnYearMonthlyDefinition YEAR_ON_YEAR_WITH_DEFINITION = CouponInflationYearOnYearMonthlyDefinition
      .from(PAYMENT_DATE_MINUS1, PAYMENT_DATE, NOTIONAL,
          PRICE_INDEX_EUR,
          MONTH_LAG, true);
