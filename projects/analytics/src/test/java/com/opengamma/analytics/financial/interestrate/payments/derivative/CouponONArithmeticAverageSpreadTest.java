...
public class CouponONArithmeticAverageSpreadTest {
  ...
  private static final CouponONArithmeticAverageSpread CPN_AA_ON = CouponONArithmeticAverageSpread.from(PAYMENT_TIME,
  ...
  public void nullIndex() {
    CouponONArithmeticAverageSpread.from(PAYMENT_TIME, FEDFUND_CPN_3M_2_DEF.getPaymentYearFraction(), NOTIONAL, null, FIXING_TIMES,
  ...
  public void nullFixTimes() {
    CouponONArithmeticAverageSpread.from(PAYMENT_TIME, FEDFUND_CPN_3M_2_DEF.getPaymentYearFraction(), NOTIONAL, FEDFUND, null,
        FEDFUND_CPN_3M_2_DEF.getFixingPeriodAccrualFactors(), ACCRUED_RATE,
        SPREAD);
  }
  ...
  public void nullFixAF() {
    CouponONArithmeticAverageSpread.from(PAYMENT_TIME, FEDFUND_CPN_3M_2_DEF.getPaymentYearFraction(), NOTIONAL, FEDFUND, FIXING_TIMES, null,
        ACCRUED_RATE, SPREAD);
  }
  ...
  public void getter() {
    ...
    assertEquals("CouponArithmeticAverageONSpread: getter", CPN_AA_ON.getFixingPeriodAccrualFactors(),
    ...
    assertEquals("CouponArithmeticAverageONSpread: getter", CPN_AA_ON.getSpreadAmount(),
        SPREAD * CPN_AA_ON.getPaymentYearFraction() * NOTIONAL);
  }
  ...
  public void equalHash() {
    ...
    final CouponONArithmeticAverageSpread other = CouponONArithmeticAverageSpread.from(PAYMENT_TIME,
        FEDFUND_CPN_3M_2_DEF.getPaymentYearFraction(),
        NOTIONAL, FEDFUND, FIXING_TIMES, FEDFUND_CPN_3M_2_DEF.getFixingPeriodAccrualFactors(), ACCRUED_RATE, SPREAD);
    ...
    modified = CouponONArithmeticAverageSpread.from(PAYMENT_TIME + 0.1, FEDFUND_CPN_3M_2_DEF.getPaymentYearFraction(), NOTIONAL, FEDFUND,
        FIXING_TIMES,
    ...
    modified = CouponONArithmeticAverageSpread.from(PAYMENT_TIME, FEDFUND_CPN_3M_2_DEF.getPaymentYearFraction() + 0.1, NOTIONAL, FEDFUND,
        FIXING_TIMES,
        FEDFUND_CPN_3M_2_DEF.getFixingPeriodAccrualFactors(), ACCRUED_RATE, SPREAD);
    assertFalse("CouponArithmeticAverageONSpread: equal-hash", CPN_AA_ON.equals(modified));
    modified = CouponONArithmeticAverageSpread.from(PAYMENT_TIME, FEDFUND_CPN_3M_2_DEF.getPaymentYearFraction(), NOTIONAL + 10, FEDFUND,
        FIXING_TIMES,
        FEDFUND_CPN_3M_2_DEF.getFixingPeriodAccrualFactors(), ACCRUED_RATE, SPREAD);
    assertFalse("CouponArithmeticAverageONSpread: equal-hash", CPN_AA_ON.equals(modified));
    final IndexON modifiedIndex = IndexONMaster.getInstance().getIndex("EONIA");
    modified = CouponONArithmeticAverageSpread.from(PAYMENT_TIME, FEDFUND_CPN_3M_2_DEF.getPaymentYearFraction(), NOTIONAL, modifiedIndex,
        FIXING_TIMES,
        FEDFUND_CPN_3M_2_DEF.getFixingPeriodAccrualFactors(), ACCRUED_RATE, SPREAD);
    assertFalse("CouponArithmeticAverageONSpread: equal-hash", CPN_AA_ON.equals(modified));
    modified = CouponONArithmeticAverageSpread.from(PAYMENT_TIME, FEDFUND_CPN_3M_2_DEF.getPaymentYearFraction(), NOTIONAL, FEDFUND,
        FIXING_TIMES, FEDFUND_CPN_3M_2_DEF.getFixingPeriodAccrualFactors(),
