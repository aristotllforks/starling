...
public class CapFloorIborBlackSmileMethodTest {
  ...
  private static final PresentValueCurveSensitivityBlackSmileCapCalculator PVCSBSCC = PresentValueCurveSensitivityBlackSmileCapCalculator
      .getInstance();

  private static final double SHIFT = 1.0E-7;
  private static final ParameterSensitivityParameterCalculator<BlackSmileCapProviderInterface> PS_SS_C = new ParameterSensitivityParameterCalculator<>(
      PVCSBSCC);
  private static final ParameterSensitivityBlackSmileCapDiscountInterpolatedFDCalculator PS_SS_FDC = new ParameterSensitivityBlackSmileCapDiscountInterpolatedFDCalculator(
      PVBSCC, SHIFT);
  // To derivative
  ...
  public void presentValueCurveSensitivityCap() {
    final MultipleCurrencyParameterSensitivity pvpsExact = PS_SS_C.calculateSensitivity(CAP_LONG, BLACK_MULTICURVES,
