...
public class CapFloorInflationYearOnYearMonthlyBlackNormalSmileMethodTest {
  ...
  private static final CouponInflationYearOnYearMonthlyDefinition YEAR_ON_YEAR_DEFINITION = CouponInflationYearOnYearMonthlyDefinition.from(
      ...
      PRICE_INDEX_EUR,
      MONTH_LAG, false);
  private static final CapFloorInflationYearOnYearMonthlyDefinition YEAR_ON_YEAR_DEFINITION_CAP = CapFloorInflationYearOnYearMonthlyDefinition
  ...
  private static final CapFloorInflationYearOnYearMonthlyBlackNormalSmileMethod METHOD = CapFloorInflationYearOnYearMonthlyBlackNormalSmileMethod
      .getInstance();
  ...
  public void presentValue() {
    ...
    final double volatility = BLACK_INFLATION.getBlackParameters().getVolatility(YEAR_ON_YEAR_CAP.getReferenceEndTime(),
