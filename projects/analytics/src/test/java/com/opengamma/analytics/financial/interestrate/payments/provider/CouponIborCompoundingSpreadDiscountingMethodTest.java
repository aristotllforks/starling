...
public class CouponIborCompoundingSpreadDiscountingMethodTest {
  ...
  private static final CouponIborCompoundingSpreadDefinition CPN_DEFINITION = CouponIborCompoundingSpreadDefinition.from(NOTIONAL,
  ...
  private static final CouponIborCompoundingSpreadDiscountingMethod METHOD_COMPOUNDED = CouponIborCompoundingSpreadDiscountingMethod
      .getInstance();
  ...
  private static final CouponIborCompoundingSpread CPN_1 = (CouponIborCompoundingSpread) CPN_DEFINITION.toDerivative(REFERENCE_DATE_1,
      FIXING_TS);
  ...
  public void presentValueBeforeFirstFixing() {
    ...
    for (int loopsub = 0; loopsub < nbSub; loopsub++) {
      final double forward = MULTICURVES.getSimplyCompoundForwardRate(CPN_BEFORE.getIndex(),
          CPN_BEFORE.getFixingPeriodStartTimes()[loopsub], CPN_BEFORE.getFixingPeriodEndTimes()[loopsub],
  ...
  public void presentValueMethodVsCalculator() {
    ...
    assertEquals("CouponIborCompoundedDiscounting: Present value", pvMethod.getAmount(CAD), pvCalculator.getAmount(CADCDOR3M.getCurrency()),
        TOLERANCE_PV);
  ...
  public void presentValueAfter1Fixing() {
    ...
    accruedNotional *= 1.0 + CPN_1.getPaymentAccrualFactors()[0]
        * (MULTICURVES.getSimplyCompoundForwardRate(CPN_1.getIndex(), CPN_1.getFixingPeriodStartTimes()[0],
            CPN_1.getFixingPeriodEndTimes()[0], CPN_1.getFixingPeriodAccrualFactors()[0]) + SPREAD);
  ...
  public void presentValueCurveSensitivityMethodVsCalculator() {
    ...
    AssertSensitivityObjects.assertEquals("CouponIborCompoundedDiscounting: Present value curve sensitivity", pvcsMethod, pvcsCalculator,
        TOLERANCE_PV_DELTA);
  }
