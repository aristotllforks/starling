...
public class BondFutureConstantSpreadHorizonCalculatorTest {
  ...
  private static final InstrumentDerivativeVisitor<ParameterIssuerProviderInterface, MultipleCurrencyAmount> PV_CALCULATOR = PresentValueIssuerCalculator
      .getInstance();
  /** Horizon calculator */
  private static final HorizonCalculator<BondFuturesTransactionDefinition, IssuerProviderInterface, Double> CALCULATOR = BondFutureConstantSpreadHorizonCalculator.INSTANCE;
  ...
  static {
    for (int i = 0; i < NB_BOND; i++) {
      ...
      BASKET[i] = BondFixedSecurityDefinition.from(USD, MATURITY_DATE[i], START_ACCRUAL_DATE[i], PAYMENT_TENOR, RATE[i], SETTLEMENT_DAYS,
  ...
  public void testNullDefinition() {
    CALCULATOR.getTheta(null, HORIZON_DATE, FLAT_ISSUER_MULTICURVES, 1, CalendarAdapter.of(CALENDAR), 1.01);
  ...
  public void testNullDate() {
    CALCULATOR.getTheta(TRANSACTION, null, FLAT_ISSUER_MULTICURVES, 1, CalendarAdapter.of(CALENDAR), 1.01);
  }
  ...
  public void testNullData() {
    CALCULATOR.getTheta(TRANSACTION, HORIZON_DATE, null, 1, CalendarAdapter.of(CALENDAR), 1.01);
  }
  ...
  public void testDaysForward1() {
    CALCULATOR.getTheta(TRANSACTION, HORIZON_DATE, FLAT_ISSUER_MULTICURVES, 2, CalendarAdapter.of(CALENDAR), 1.01);
  }
