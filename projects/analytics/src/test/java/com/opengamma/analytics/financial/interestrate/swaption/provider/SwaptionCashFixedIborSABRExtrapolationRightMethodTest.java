...
/**
 * Class to test the present value and present value rate sensitivity of the cash-settled European swaption in the SABR with extrapolation
...
public class SwaptionCashFixedIborSABRExtrapolationRightMethodTest {
  ...
  private static final SwapFixedIborDefinition SWAP_RECEIVER_DEFINITION = SwapFixedIborDefinition.from(SETTLEMENT_DATE, CMS_INDEX, NOTIONAL,
      RATE, !FIXED_IS_PAYER, CalendarAdapter.of(CALENDAR));
  private static final SwapFixedIborDefinition SWAP_PAYER_HIGH_DEFINITION = SwapFixedIborDefinition.from(SETTLEMENT_DATE, CMS_INDEX,
      NOTIONAL, RATE_HIGH, FIXED_IS_PAYER, CalendarAdapter.of(CALENDAR));
  private static final SwapFixedIborDefinition SWAP_RECEIVER_HIGH_DEFINITION = SwapFixedIborDefinition.from(SETTLEMENT_DATE, CMS_INDEX,
      NOTIONAL, RATE_HIGH, !FIXED_IS_PAYER, CalendarAdapter.of(CALENDAR));
  private static final SwaptionCashFixedIborDefinition SWAPTION_LONG_PAYER_DEFINITION = SwaptionCashFixedIborDefinition.from(EXPIRY_DATE,
      SWAP_PAYER_DEFINITION, true, IS_LONG);
  private static final SwaptionCashFixedIborDefinition SWAPTION_LONG_RECEIVER_DEFINITION = SwaptionCashFixedIborDefinition.from(EXPIRY_DATE,
      SWAP_RECEIVER_DEFINITION, false, IS_LONG);
  private static final SwaptionCashFixedIborDefinition SWAPTION_SHORT_PAYER_DEFINITION = SwaptionCashFixedIborDefinition.from(EXPIRY_DATE,
      SWAP_PAYER_DEFINITION, true, !IS_LONG);
  private static final SwaptionCashFixedIborDefinition SWAPTION_SHORT_RECEIVER_DEFINITION = SwaptionCashFixedIborDefinition
      .from(EXPIRY_DATE, SWAP_RECEIVER_DEFINITION, false, !IS_LONG);
  private static final SwaptionCashFixedIborDefinition SWAPTION_LONG_PAYER_HIGH_DEFINITION = SwaptionCashFixedIborDefinition
      .from(EXPIRY_DATE, SWAP_PAYER_HIGH_DEFINITION, true, IS_LONG);
  private static final SwaptionCashFixedIborDefinition SWAPTION_LONG_RECEIVER_HIGH_DEFINITION = SwaptionCashFixedIborDefinition
      .from(EXPIRY_DATE, SWAP_RECEIVER_HIGH_DEFINITION, false, IS_LONG);
  private static final SwaptionCashFixedIborDefinition SWAPTION_SHORT_PAYER_HIGH_DEFINITION = SwaptionCashFixedIborDefinition
      .from(EXPIRY_DATE, SWAP_PAYER_HIGH_DEFINITION, true, !IS_LONG);
  // to derivatives
  ...
  private static final SwaptionCashFixedIbor SWAPTION_LONG_RECEIVER_HIGH = SWAPTION_LONG_RECEIVER_HIGH_DEFINITION
  ...
  private static final SwaptionCashFixedIborSABRExtrapolationRightMethod METHOD_EXTRAPOLATION = new SwaptionCashFixedIborSABRExtrapolationRightMethod(
      CUT_OFF_STRIKE, MU);
  // Calculators
  ...
  private static final ParameterSensitivityParameterCalculator<SABRSwaptionProviderInterface> PS_SS_X_C = new ParameterSensitivityParameterCalculator<>(
      PVCSSSXC);
  private static final ParameterSensitivitySABRSwaptionDiscountInterpolatedFDCalculator PS_SS_X_FDC = new ParameterSensitivitySABRSwaptionDiscountInterpolatedFDCalculator(
      PVSSXC, SHIFT);
  ...
  public void presentValueNoExtra() {
    ...
    assertEquals("Swaption cash SABR extrapolation: below cut-off strike", priceLongPayerNoExtra.getAmount(EUR),
        priceLongPayer.getAmount(EUR), TOLERANCE_PV);
    assertEquals("Swaption cash SABR extrapolation: below cut-off strike", priceShortPayerNoExtra.getAmount(EUR),
        priceShortPayer.getAmount(EUR), TOLERANCE_PV);
    assertEquals("Swaption cash SABR extrapolation: below cut-off strike", priceLongReceiverNoExtra.getAmount(EUR),
        priceLongReceiver.getAmount(EUR), TOLERANCE_PV);
    assertEquals("Swaption cash SABR extrapolation: below cut-off strike", priceShortReceiverNoExtra.getAmount(EUR),
        priceShortReceiver.getAmount(EUR), TOLERANCE_PV);
    assertEquals("Swaption cash SABR extrapolation: below cut-off strike long/short parity", priceLongPayer.getAmount(EUR),
        -priceShortPayer.getAmount(EUR), TOLERANCE_PV);
    assertEquals("Swaption cash SABR extrapolation: below cut-off strike long/short parity", priceLongReceiver.getAmount(EUR),
        -priceShortReceiver.getAmount(EUR), TOLERANCE_PV);
  }
  ...
  public void presentValueExtra() {
    ...
    assertEquals("Swaption cash SABR extrapolation: fixed value", priceLongReceiverExpected, priceLongReceiver.getAmount(EUR),
        TOLERANCE_PV);
    assertEquals("Swaption cash SABR extrapolation: long/short parity", priceLongPayer.getAmount(EUR), -priceShortPayer.getAmount(EUR),
        TOLERANCE_PV);
  }
  ...
  public void presentValueCurveSensitivityExtra() {
    final MultipleCurrencyParameterSensitivity pvpsExact = PS_SS_X_C.calculateSensitivity(SWAPTION_LONG_PAYER_HIGH, SABR_MULTICURVES,
    ...
    AssertSensitivityObjects.assertEquals("SwaptionCashFixedIborSABRExtrapolationRightMethod: presentValueCurveSensitivity ", pvpsExact,
        pvpsFD, 500 * TOLERANCE_PV_DELTA);
    ...
    final MultipleCurrencyMulticurveSensitivity pvcsSP = SWAPTION_SHORT_PAYER_HIGH.accept(PVCSSSXC, SABR_MULTICURVES).multipliedBy(-1)
        .cleaned();
    AssertSensitivityObjects.assertEquals("SwaptionCashFixedIborSABRExtrapolationRightMethod: presentValueCurveSensitivity ", pvcsLP,
        pvcsSP, TOLERANCE_PV_DELTA);
  }
  ...
  public void presentValueSABRSensitivity() {
    ...
    final PresentValueSABRSensitivityDataBundle pvsLongPayer = METHOD_EXTRAPOLATION.presentValueSABRSensitivity(SWAPTION_LONG_PAYER_HIGH,
        SABR_MULTICURVES);
    PresentValueSABRSensitivityDataBundle pvsShortPayer = METHOD_EXTRAPOLATION.presentValueSABRSensitivity(SWAPTION_SHORT_PAYER_HIGH,
        SABR_MULTICURVES);
    // Long/short parity
  ...
  public void presentValueSABRSensitivityMethodVsCalculator() {
    final PresentValueSABRSensitivityDataBundle pvssMethod = METHOD_EXTRAPOLATION.presentValueSABRSensitivity(SWAPTION_LONG_PAYER_HIGH,
        SABR_MULTICURVES);
