...
public class GeneratorBillTest {
  ...
  private static final BillSecurityDefinition BILL_BEL_SEC_DEFINITION = new BillSecurityDefinition(EUR, END_DATE, NOTIONAL, SETTLEMENT_DAYS,
      CALENDAR, YIELD_CONVENTION, ACT360, ISSUER_BEL);
  ...
  public void generateInstrument() {
    ...
    final BillTransactionDefinition billExpected = BillTransactionDefinition.fromYield(BILL_BEL_SEC_DEFINITION, quantity, dettleDate,
        marketQuote, CALENDAR);
