...
public class CouponIborGearingDiscountingMethodTest {
  ...
  private static final ZonedDateTime FIXING_DATE = ScheduleCalculator.getAdjustedDate(ACCRUAL_START_DATE, -EURIBOR3M.getSpotLag(),
      CALENDAR_EUR);
  private static final CouponIborGearingDefinition COUPON_DEFINITION = new CouponIborGearingDefinition(EURIBOR3M.getCurrency(),
      ACCRUAL_END_DATE, ACCRUAL_START_DATE, ACCRUAL_END_DATE, ACCRUAL_FACTOR,
      NOTIONAL, FIXING_DATE, EURIBOR3M, SPREAD, FACTOR, CalendarAdapter.of(CALENDAR_EUR));
  ...
  public void presentValue() {
    ...
    final double forward = PROVIDER.getSimplyCompoundForwardRate(EURIBOR3M, COUPON.getFixingPeriodStartTime(),
