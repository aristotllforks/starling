...
public class InterestRateFutureTransactionDiscountingMethodTest {
  ...
  private static final InterestRateFutureTransactionDiscountingMethod METHOD_IRFUT_TRA_DSC = InterestRateFutureTransactionDiscountingMethod
      .getInstance();
  ...
  private static final ParSpreadRateCurveSensitivityDiscountingCalculator PSRCSDC = ParSpreadRateCurveSensitivityDiscountingCalculator
      .getInstance();
  private static final ParSpreadMarketQuoteCurveSensitivityDiscountingCalculator PSMQCSDC = ParSpreadMarketQuoteCurveSensitivityDiscountingCalculator
      .getInstance();
  private static final SimpleParameterSensitivityParameterCalculator<MulticurveProviderInterface> PSC = new SimpleParameterSensitivityParameterCalculator<>(
      PSRCSDC);
  private static final SimpleParameterSensitivityMulticurveDiscountInterpolatedFDCalculator PSC_DSC_FD = new SimpleParameterSensitivityMulticurveDiscountInterpolatedFDCalculator(
      PSRDC, SHIFT_FD);
  ...
  public void parSpreadMarketQuote() {
    ...
    assertEquals("InterestRateFutureTransactionDiscountingMethod: STIR Futures par spread market quote", pv0.getAmount(EUR), 0,
        TOLERANCE_PRICE);
  }
  ...
  public void parSpreadMarketQuoteCurveSensitivity() {
    ...
    AssertSensitivityObjects.assertEquals("InterestRateFutureTransactionDiscountingMethod: priceCurveSensitivity ", pcsFD, pcsAD,
  ...
  public void parSpreadRate() {
    ...
    assertEquals("InterestRateFutureTransactionDiscountingMethod: STIR Futures par spread rate", -parSpreadMQ, parSpreadRate,
        TOLERANCE_PRICE);
  }
  ...
  public void parSpreadRateCurveSensitivity() {
    ...
    AssertSensitivityObjects.assertEquals("InterestRateFutureTransactionDiscountingMethod: parSpreadRateCurveSensitivity",
        pscsFD.multipliedBy(-1).cleaned(),
