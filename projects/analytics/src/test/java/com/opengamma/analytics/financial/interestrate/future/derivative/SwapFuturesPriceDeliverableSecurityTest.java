...
public class SwapFuturesPriceDeliverableSecurityTest {
  ...
  private static final SwapFuturesPriceDeliverableSecurity SWAP_FUTURES_SECURITY = new SwapFuturesPriceDeliverableSecurity(
      LAST_TRADING_TIME, EFFECTIVE_TIME, SWAP, NOTIONAL);
