...
public class SwapFuturesPriceDeliverableTransactionDiscountingMethodTest {
  ...
  public void presentValue() {
    ...
    assertEquals("SwapFuturesPriceDeliverableTransactionDiscountingMethod: present value", pvExpected1.getAmount(USD),
    ...
    final double pvExpected2 = (price - SWAP_FUTURES_TRANSACTION.getReferencePrice()) * SWAP_FUTURES_SECURITY_DEFINITION.getNotional()
        * QUANTITY;
    assertEquals("SwapFuturesPriceDeliverableTransactionDiscountingMethod: present value", pvExpected2, pvComputed.getAmount(USD),
        TOLERANCE_PV);
  }
  ...
  public void presentValueMethodVsCalculator() {
    ...
    assertEquals("SwapFuturesPriceDeliverableTransactionDiscountingMethod: present value", pvMethod.getAmount(USD),
        pvCalculator.getAmount(USD), TOLERANCE_PV);
  }
  ...
  public void presentValueCurveSensitivity() {
    ...
    AssertSensitivityObjects.assertEquals("SwapFuturesPriceDeliverableTransactionDiscountingMethod: presentValueCurveSensitivity ",
