...
public class SwapFuturesPriceDeliverableSecurityDefinitionTest {
  ...
  public void wrongSwap1() {
    new SwapFuturesPriceDeliverableSecurityDefinition(LAST_TRADING_DATE,
        SwapFixedIborDefinition.from(EFFECTIVE_DATE, TENOR, USD6MLIBOR3M, 2.0, RATE, false), NOTIONAL);
  }
  ...
  public void wrongSwap2() {
    new SwapFuturesPriceDeliverableSecurityDefinition(LAST_TRADING_DATE,
        SwapFixedIborDefinition.from(EFFECTIVE_DATE, TENOR, USD6MLIBOR3M, 1.0, RATE, true), NOTIONAL);
  }
  ...
  @Test
  public void getter() {
    assertEquals("DeliverableSwapFuturesSecurityDefinition: getter", LAST_TRADING_DATE,
        SWAP_FUTURES_SECURITY_DEFINITION.getLastTradingDate());
  ...
  @Test
  public void from() {
    final SwapFuturesPriceDeliverableSecurityDefinition futuresDefinition = SwapFuturesPriceDeliverableSecurityDefinition
        .from(EFFECTIVE_DATE, USD6MLIBOR3M, TENOR, NOTIONAL, RATE);
  ...
  public void toDerivativeDeprecated() {
    ...
    final SwapFuturesPriceDeliverableSecurity futuresExpected = new SwapFuturesPriceDeliverableSecurity(expiryTime, deliveryTime,
        underlying, NOTIONAL);
