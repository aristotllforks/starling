...
public class InterestRateFutureOptionMarginHullWhiteMethodTest {
  ...
  // Futures
  private static final InterestRateFutureSecurityDefinition ERH3_DEFINITION = new InterestRateFutureSecurityDefinition(FUT_LAST_MAR13,
      EURIBOR3M, NOTIONAL, FUTURE_FACTOR, NAME_MAR13, CalendarAdapter.of(TARGET));
  private static final InterestRateFutureSecurityDefinition ERM4_DEFINITION = new InterestRateFutureSecurityDefinition(FUT_LAST_JUN14,
      EURIBOR3M, NOTIONAL, FUTURE_FACTOR, NAME_JUN14, CalendarAdapter.of(TARGET));
  ...
  private static final InterestRateFutureOptionMarginSecurityDefinition OPT_ERH3_CALL_9900_DEFINITION = new InterestRateFutureOptionMarginSecurityDefinition(
      ERH3_DEFINITION, OPT_EXP_MAR13, STRIKE_1,
      true);
  private static final InterestRateFutureOptionMarginSecurityDefinition OPT_ERH3_PUT_9900_DEFINITION = new InterestRateFutureOptionMarginSecurityDefinition(
      ERH3_DEFINITION, OPT_EXP_MAR13, STRIKE_1,
      false);
  private static final InterestRateFutureOptionMarginSecurityDefinition OPT_ERM4_MID_CALL_9875_DEFINITION = new InterestRateFutureOptionMarginSecurityDefinition(
      ERM4_DEFINITION, OPT_MID_EXP_JUN13,
      STRIKE_2, true);
  private static final InterestRateFutureOptionMarginSecurityDefinition OPT_ERM4_MID_PUT_9875_DEFINITION = new InterestRateFutureOptionMarginSecurityDefinition(
      ERM4_DEFINITION, OPT_MID_EXP_JUN13,
      STRIKE_2, false);
  private static final InterestRateFutureOptionMarginSecurity OPT_ERH3_CALL_9900 = OPT_ERH3_CALL_9900_DEFINITION
  ...
  private static final InterestRateFutureOptionMarginSecurity OPT_ERM4_MID_CALL_9875 = OPT_ERM4_MID_CALL_9875_DEFINITION
      .toDerivative(REFERENCE_DATE);
  private static final InterestRateFutureOptionMarginSecurity OPT_ERM4_MID_PUT_9875 = OPT_ERM4_MID_PUT_9875_DEFINITION
      .toDerivative(REFERENCE_DATE);
  ...
  private static final InterestRateFutureOptionMarginTransactionDefinition OPT_ERH3_CALL_9900_TRA_1_DEFINITION = new InterestRateFutureOptionMarginTransactionDefinition(
      OPT_ERH3_CALL_9900_DEFINITION,
      QUANTITY_1, TRADE_DATE_1, TRADE_PRICE_1);
  private static final InterestRateFutureOptionMarginTransactionDefinition OPT_ERH3_CALL_9900_TRA_2_DEFINITION = new InterestRateFutureOptionMarginTransactionDefinition(
      OPT_ERH3_CALL_9900_DEFINITION,
      -QUANTITY_1, TRADE_DATE_1, TRADE_PRICE_1);
  private static final InterestRateFutureOptionMarginTransactionDefinition OPT_ERH3_PUT_9900_TRA_1_DEFINITION = new InterestRateFutureOptionMarginTransactionDefinition(
      OPT_ERH3_PUT_9900_DEFINITION,
      QUANTITY_1, TRADE_DATE_1, TRADE_PRICE_1);
  private static final InterestRateFutureOptionMarginTransaction OPT_ERH3_CALL_9900_TRA_1 = OPT_ERH3_CALL_9900_TRA_1_DEFINITION
      .toDerivative(REFERENCE_DATE, LAST_MARGIN_1);
  private static final InterestRateFutureOptionMarginTransaction OPT_ERH3_CALL_9900_TRA_2 = OPT_ERH3_CALL_9900_TRA_2_DEFINITION
      .toDerivative(REFERENCE_DATE, LAST_MARGIN_1);
  private static final InterestRateFutureOptionMarginTransaction OPT_ERH3_PUT_9900_TRA_1 = OPT_ERH3_PUT_9900_TRA_1_DEFINITION
      .toDerivative(REFERENCE_DATE, LAST_MARGIN_1);
  ...
  private static final InterestRateFutureOptionMarginTransaction OPT_ERM4_MID_CALL_9875_TRA_1 = OPT_ERM4_MID_CALL_9875_TRA_1_DEFINITION
      .toDerivative(REFERENCE_DATE, LAST_MARGIN_1);
  private static final InterestRateFutureOptionMarginTransaction OPT_ERM4_MID_CALL_9875_TRA_2 = OPT_ERM4_MID_CALL_9875_TRA_2_DEFINITION
      .toDerivative(REFERENCE_DATE, LAST_MARGIN_1);
  private static final InterestRateFutureOptionMarginTransaction OPT_ERM4_MID_PUT_9875_TRA_1 = OPT_ERM4_MID_PUT_9875_TRA_1_DEFINITION
      .toDerivative(REFERENCE_DATE, LAST_MARGIN_1);
  ...
  private static final InterestRateFutureOptionMarginSecurityHullWhiteMethod METHOD_OPT_SEC = InterestRateFutureOptionMarginSecurityHullWhiteMethod
      .getInstance();
  private static final InterestRateFutureOptionMarginTransactionHullWhiteMethod METHOD_OPT_TRA = InterestRateFutureOptionMarginTransactionHullWhiteMethod
      .getInstance();

  private static final MarketQuoteHullWhiteCalculator MQHWC = MarketQuoteHullWhiteCalculator.getInstance();
  private static final MarketQuoteCurveSensitivityHullWhiteCalculator MQCSHWC = MarketQuoteCurveSensitivityHullWhiteCalculator
      .getInstance();
  ...
  private static final SimpleParameterSensitivityParameterCalculator<HullWhiteOneFactorProviderInterface> SPSHWC = new SimpleParameterSensitivityParameterCalculator<>(
      MQCSHWC);
  private static final SimpleParameterSensitivityHullWhiteDiscountInterpolatedFDCalculator SPSHWC_FD = new SimpleParameterSensitivityHullWhiteDiscountInterpolatedFDCalculator(
      MQHWC, SHIFT_FD);
  private static final ParameterSensitivityParameterCalculator<HullWhiteOneFactorProviderInterface> PSHWC = new ParameterSensitivityParameterCalculator<>(
      PVCSHWC);
  private static final ParameterSensitivityHullWhiteDiscountInterpolatedFDCalculator PSHWC_FD = new ParameterSensitivityHullWhiteDiscountInterpolatedFDCalculator(
      PVHWC, SHIFT_FD);
  ...
  public void price() {
    ...
    final double exerciseBoundary = -1.0 / alphaOpt
        * (Math.log((1.0 + delta * ktilde) / (1 + delta * forward) / gammaFut) + alphaOpt * alphaOpt / 2.0);
  ...
  public void priceDeepOTM() {
    final InterestRateFutureOptionMarginSecurityDefinition callDefinition = new InterestRateFutureOptionMarginSecurityDefinition(
        ERH3_DEFINITION, OPT_EXP_MAR13, 1.25, true);
    ...
    final InterestRateFutureOptionMarginSecurityDefinition putDefinition = new InterestRateFutureOptionMarginSecurityDefinition(
        ERH3_DEFINITION, OPT_EXP_MAR13, 0.75, false);
  ...
  public void pricePositive() {
    ...
    for (int loopstrike = 0; loopstrike <= nbStrikes; loopstrike++) {
      ...
      final InterestRateFutureOptionMarginSecurityDefinition callDefinition = new InterestRateFutureOptionMarginSecurityDefinition(
          ERH3_DEFINITION, OPT_EXP_MAR13, strike, true);
      final InterestRateFutureOptionMarginSecurity call = callDefinition.toDerivative(REFERENCE_DATE);
      ...
      final InterestRateFutureOptionMarginSecurityDefinition putDefinition = new InterestRateFutureOptionMarginSecurityDefinition(
          ERH3_DEFINITION, OPT_EXP_MAR13, strike, false);
      final InterestRateFutureOptionMarginSecurity put = putDefinition.toDerivative(REFERENCE_DATE);
  ...
  public void priceCallPutParityStandard() {
    ...
    assertEquals("InterestRateFutureOptionMarginSecurityHullWhiteMethod: price", priceCall - pricePut, priceFutures - STRIKE_1,
        TOLERANCE_PRICE);
  }
  ...
  public void priceCallPutParityMid() {
    ...
    assertEquals("InterestRateFutureOptionMarginSecurityHullWhiteMethod: price", priceCall - pricePut, priceFutures - STRIKE_2,
        TOLERANCE_PRICE);
  }
  ...
  public void priceCurveSensitivity() {
    final SimpleParameterSensitivity pcsExact = SPSHWC.calculateSensitivity(OPT_ERM4_MID_CALL_9875, HW_MULTICURVES,
    ...
    AssertSensitivityObjects.assertEquals("DeliverableSwapFuturesSecurityHullWhiteMethod: priceCurveSensitivity", pcsExact, pcsFD,
  ...
  public void priceCurveSensitivityMethodVsCalculator() {
    ...
    AssertSensitivityObjects.assertEquals("InterestRateFutureSecurityHullWhiteProviderMethod: present value - calculator vs method",
        pcsCalculator, pcsMethod, TOLERANCE_PRICE_DELTA);
  }
  ...
  public void presentValueStandard() {
    ...
    assertEquals("InterestRateFutureOptionMarginTransactionHullWhiteMethod: present value", pvExpected, pvComputed.getAmount(EUR),
        TOLERANCE_PV);
  }
  ...
  public void presentValueLongShort() {
    ...
    assertEquals("InterestRateFutureOptionMarginTransactionHullWhiteMethod: present value", pvLongStd.getAmount(EUR),
        -pvShortStd.getAmount(EUR), TOLERANCE_PV);
    ...
    assertEquals("InterestRateFutureOptionMarginTransactionHullWhiteMethod: present value", pvLongMid.getAmount(EUR),
        -pvShortMid.getAmount(EUR), TOLERANCE_PV);
  }
  ...
  public void presentValuePutCallParity() {
    ...
    assertEquals("InterestRateFutureOptionMarginSecurityHullWhiteMethod: price",
        pvLongCallStd.getAmount(EUR) - pvShortPutStd.getAmount(EUR), (priceFuturesH3 - STRIKE_1) * QUANTITY_1 * NOTIONAL
            * FUTURE_FACTOR,
        TOLERANCE_PV);
    ...
    assertEquals("InterestRateFutureOptionMarginSecurityHullWhiteMethod: price",
        pvLongCallMid.getAmount(EUR) - pvShortPutMid.getAmount(EUR), (priceFuturesM4 - STRIKE_2) * QUANTITY_2 * NOTIONAL
            * FUTURE_FACTOR,
        TOLERANCE_PV);
  }
  ...
  public void presentValueMethodVsCalculator() {
    ...
    assertEquals("InterestRateFutureOptionMarginTransactionHullWhiteMethod: present value", pvMethod.getAmount(EUR),
        pvCalculator.getAmount(EUR), TOLERANCE_PV);
  }
  ...
  public void presentValueCurveSensitivity() {
    final MultipleCurrencyParameterSensitivity pcsExact = PSHWC.calculateSensitivity(OPT_ERM4_MID_CALL_9875_TRA_1, HW_MULTICURVES,
        MULTICURVES.getAllNames());
    ...
    AssertSensitivityObjects.assertEquals("InterestRateFutureOptionMarginTransactionHullWhiteMethod: presentValueCurveSensitivity",
        pcsExact, pcsFD, TOLERANCE_PV_DELTA);
  }
