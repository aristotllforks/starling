...
public class BondFuturesOptionMarginTransactionBlackExpLogMoneynessMethodTest {
  ...
  private static final BondFuturesOptionMarginSecurityDefinition CALL_BOBLM4_125_SEC_DEFINITION = new BondFuturesOptionMarginSecurityDefinition(
      BOBLM4_DEFINITION,
  ...
  private static final BondFuturesOptionMarginTransactionDefinition CALL_BOBLM4_125_TRA_1_DEFINITION = new BondFuturesOptionMarginTransactionDefinition(
      CALL_BOBLM4_125_SEC_DEFINITION, QUANTITY, TRADE_DATE, TRADE_PRICE);
  private static final BondFuturesOptionMarginTransactionDefinition CALL_BOBLM4_125_TRA_2_DEFINITION = new BondFuturesOptionMarginTransactionDefinition(
      CALL_BOBLM4_125_SEC_DEFINITION, QUANTITY, TRADE_DATE.minusDays(1), TRADE_PRICE);
  private static final double REFERENCE_PRICE = 0.02;
  private static final BondFuturesOptionMarginTransaction CALL_BOBLM4_125_TRA_1 = CALL_BOBLM4_125_TRA_1_DEFINITION
      .toDerivative(REFERENCE_DATE, REFERENCE_PRICE);
  private static final BondFuturesOptionMarginTransaction CALL_BOBLM4_125_TRA_2 = CALL_BOBLM4_125_TRA_2_DEFINITION
      .toDerivative(REFERENCE_DATE, REFERENCE_PRICE);
  ...
  private static final BlackBondFuturesExpLogMoneynessProviderDiscount BLACK_BNDFUT_MONEYNESS = new BlackBondFuturesExpLogMoneynessProviderDiscount(
      ISSUER_SPECIFIC_MULTICURVES, BLACK_SURFACE, LEGAL_ENTITY_GERMANY);
  private static final BlackBondFuturesExpLogMoneynessProviderDiscount BLACK_BNDFUT_MONEYNESS_FLAT = new BlackBondFuturesExpLogMoneynessProviderDiscount(
      ISSUER_SPECIFIC_MULTICURVES, BLACK_SURFACE_FLAT, LEGAL_ENTITY_GERMANY);
  /** Methods and calculators */
  private static final BondFuturesOptionMarginSecurityBlackBondFuturesMethod METHOD_OPT_SEC = BondFuturesOptionMarginSecurityBlackBondFuturesMethod
      .getInstance();
  ...
  private static final ParameterSensitivityParameterCalculator<BlackBondFuturesProviderInterface> PSSFC = new ParameterSensitivityParameterCalculator<>(
      PVCSBFC);
  private static final ParameterSensitivityBlackBondFuturesExpLogMoneynessDiscountInterpolatedFDCalculator PSSFC_FD = new ParameterSensitivityBlackBondFuturesExpLogMoneynessDiscountInterpolatedFDCalculator(
      PVBFC, SHIFT);
  /** Tolerances */
  ...
  public void presentValue() {
    ...
    assertEquals("BondFuturesOptionMarginTransactionBlackFlatMethod: present value", pvExpected1,
        pvComputed1.getAmount(BOBLM4_DEFINITION.getCurrency()), TOLERANCE_PV);
    ...
    assertEquals("BondFuturesOptionMarginTransactionBlackFlatMethod: present value", pvExpected1,
        pvCalculator.getAmount(BOBLM4_DEFINITION.getCurrency()), TOLERANCE_PV);
    ...
    assertEquals("BondFuturesOptionMarginTransactionBlackFlatMethod: present value", pvExpected2,
        pvComputed2.getAmount(BOBLM4_DEFINITION.getCurrency()), TOLERANCE_PV);
  }
  ...
  public void presentValueCurveSensitivity() {
    final MultipleCurrencyParameterSensitivity pvpsComputed = PSSFC.calculateSensitivity(CALL_BOBLM4_125_TRA_1,
        BLACK_BNDFUT_MONEYNESS_FLAT);
  ...
  public void presentValueCurveSensitivityMethodVsCalculator() {
    final MultipleCurrencyMulticurveSensitivity pvcsMethod = METHOD_OPT_TRA.presentValueCurveSensitivity(CALL_BOBLM4_125_TRA_1,
        BLACK_BNDFUT_MONEYNESS);
    final MultipleCurrencyMulticurveSensitivity pvcsCalculator = CALL_BOBLM4_125_TRA_1.accept(PVCSBFC, BLACK_BNDFUT_MONEYNESS);
    AssertSensitivityObjects.assertEquals("BondFuturesOptionMarginTransactionBlackFlatMethod: presentValueCurveSensitivity", pvcsMethod,
        pvcsCalculator, TOLERANCE_PV_DELTA);
  }
  ...
  public void presentValueBlackSensitivity() {
    ...
    final BlackBondFuturesExpLogMoneynessProviderDiscount blackShiftedPlus = new BlackBondFuturesExpLogMoneynessProviderDiscount(
        ISSUER_SPECIFIC_MULTICURVES, shiftedSurfacePlus, LEGAL_ENTITY_GERMANY);
    final BlackBondFuturesExpLogMoneynessProviderDiscount blackShiftedMinus = new BlackBondFuturesExpLogMoneynessProviderDiscount(
        ISSUER_SPECIFIC_MULTICURVES, shiftedSurfaceMinus, LEGAL_ENTITY_GERMANY);
    ...
    final double vegaExpected = (pvP.getAmount(CALL_BOBLM4_125_TRA_1.getCurrency()) - pvM.getAmount(CALL_BOBLM4_125_TRA_1.getCurrency()))
        / (2 * shiftVega);
    final double vegaComputed = METHOD_OPT_TRA.presentValueBlackSensitivity(CALL_BOBLM4_125_TRA_1, BLACK_BNDFUT_MONEYNESS).getSensitivity()
        .toSingleValue();
