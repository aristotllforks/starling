...
public class InterestRateFutureOptionMarginSecuritySABRMethodTest {
  ...
  private static final InterestRateFutureOptionMarginSecuritySABRMethod METHOD_OPT_FUT_SEC_SABR = InterestRateFutureOptionMarginSecuritySABRMethod
      .getInstance();
  private static final InterestRateFutureSecurityDiscountingMethod METHOD_DSC_FUT = InterestRateFutureSecurityDiscountingMethod
      .getInstance();
  ...
  public void priceFromFuturePriceStandard() {
    ...
    final InterestRateFutureOptionMarginSecurity optionEDU2Standard = new InterestRateFutureOptionMarginSecurity(EDU2, expirationTime,
        STRIKE, IS_CALL);
    final double priceFuture = 0.9905;
