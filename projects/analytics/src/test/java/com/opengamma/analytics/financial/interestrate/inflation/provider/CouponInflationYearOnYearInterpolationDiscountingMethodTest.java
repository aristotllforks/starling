...
public class CouponInflationYearOnYearInterpolationDiscountingMethodTest {
  ...
  private static final CouponInflationYearOnYearInterpolationDefinition YEAR_ON_YEAR_NO_DEFINITION = CouponInflationYearOnYearInterpolationDefinition
      .from(PAYMENT_DATE_MINUS1, PAYMENT_DATE, NOTIONAL,
  ...
  private static final CouponInflationYearOnYearInterpolationDefinition YEAR_ON_YEAR_WITH_DEFINITION = CouponInflationYearOnYearInterpolationDefinition
      .from(PAYMENT_DATE_MINUS1, PAYMENT_DATE,
          NOTIONAL,
