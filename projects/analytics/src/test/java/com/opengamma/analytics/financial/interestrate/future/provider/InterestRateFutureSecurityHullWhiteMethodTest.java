...
public class InterestRateFutureSecurityHullWhiteMethodTest {
  ...
  private static final InterestRateFutureSecurityDefinition ERU2_DEFINITION = new InterestRateFutureSecurityDefinition(LAST_TRADING_DATE,
      EURIBOR3M, NOTIONAL, FUTURE_FACTOR, NAME, CalendarAdapter.of(CALENDAR));
  ...
  public void price() {
    ...
    final double forward = MULTICURVES.getSimplyCompoundForwardRate(EURIBOR3M, ERU2.getFixingPeriodStartTime(),
        ERU2.getFixingPeriodEndTime(), ERU2.getFixingPeriodAccrualFactor());
    final double factor = MODEL.futuresConvexityFactor(MODEL_PARAMETERS, ERU2.getTradingLastTime(), ERU2.getFixingPeriodStartTime(),
  ...
  public void convexityAdjustment() {
    ...
    assertEquals("InterestRateFutureSecurityHullWhiteProviderMethod: convexity adjustment", price - (1.0d - forward), convexityAdjustment,
        TOLERANCE_PRICE);
