...
public class CapFloorCMSTest {
  ...
  public void testFrom() {
    final CapFloorCMSDefinition capConstructor = new CapFloorCMSDefinition(CUR, PAYMENT_DATE, ACCRUAL_START_DATE, ACCRUAL_END_DATE,
        ACCRUAL_FACTOR, NOTIONAL, FIXING_DATE, SWAP_DEFINITION, CMS_INDEX,
        STRIKE, IS_CAP);
  ...
  public void testWithNotional() {
    ...
    final CapFloorCMS capFloorCMS = new CapFloorCMS(CUR, ACCRUAL_FACTOR, RATE, NOTIONAL, ACCRUAL_FACTOR, CMS_CAP.getUnderlyingSwap(),
        SETTLEMENT_DAYS, STRIKE, IS_CAP);
    final CapFloorCMS expected = new CapFloorCMS(CUR, ACCRUAL_FACTOR, RATE, notional, ACCRUAL_FACTOR, CMS_CAP.getUnderlyingSwap(),
        SETTLEMENT_DAYS, STRIKE, IS_CAP);
  ...
  public void testHashCodeEquals() {
    final CapFloorCMS capFloorCMS = new CapFloorCMS(CUR, ACCRUAL_FACTOR, RATE, NOTIONAL, ACCRUAL_FACTOR, CMS_CAP.getUnderlyingSwap(),
        SETTLEMENT_DAYS, STRIKE, IS_CAP);
    CapFloorCMS other = new CapFloorCMS(CUR, ACCRUAL_FACTOR, RATE, NOTIONAL, ACCRUAL_FACTOR, CMS_CAP.getUnderlyingSwap(), SETTLEMENT_DAYS,
        STRIKE, IS_CAP);
    assertEquals(capFloorCMS, other);
    assertEquals(capFloorCMS.hashCode(), other.hashCode());
    other = new CapFloorCMS(Currency.AUD, ACCRUAL_FACTOR, RATE, NOTIONAL, ACCRUAL_FACTOR, CMS_CAP.getUnderlyingSwap(), SETTLEMENT_DAYS,
        STRIKE, IS_CAP);
    assertFalse(other.equals(capFloorCMS));
    other = new CapFloorCMS(CUR, ACCRUAL_FACTOR + 1, RATE, NOTIONAL, ACCRUAL_FACTOR, CMS_CAP.getUnderlyingSwap(), SETTLEMENT_DAYS, STRIKE,
        IS_CAP);
    assertFalse(other.equals(capFloorCMS));
    other = new CapFloorCMS(CUR, ACCRUAL_FACTOR, RATE + 0.01, NOTIONAL, ACCRUAL_FACTOR, CMS_CAP.getUnderlyingSwap(), SETTLEMENT_DAYS,
        STRIKE, IS_CAP);
    assertFalse(other.equals(capFloorCMS));
    other = new CapFloorCMS(CUR, ACCRUAL_FACTOR, RATE, NOTIONAL + 1, ACCRUAL_FACTOR, CMS_CAP.getUnderlyingSwap(), SETTLEMENT_DAYS, STRIKE,
        IS_CAP);
    assertFalse(other.equals(capFloorCMS));
    other = new CapFloorCMS(CUR, ACCRUAL_FACTOR, RATE, NOTIONAL, ACCRUAL_FACTOR + 1, CMS_CAP.getUnderlyingSwap(), SETTLEMENT_DAYS, STRIKE,
        IS_CAP);
    assertFalse(other.equals(capFloorCMS));
    other = new CapFloorCMS(CUR, ACCRUAL_FACTOR, RATE, NOTIONAL, ACCRUAL_FACTOR, CMS_CAP.getUnderlyingSwap().withNotional(NOTIONAL + 1),
        SETTLEMENT_DAYS, STRIKE, IS_CAP);
    assertFalse(other.equals(capFloorCMS));
    other = new CapFloorCMS(CUR, ACCRUAL_FACTOR, RATE, NOTIONAL, ACCRUAL_FACTOR, CMS_CAP.getUnderlyingSwap(), SETTLEMENT_DAYS + 1, STRIKE,
        IS_CAP);
    assertFalse(other.equals(capFloorCMS));
    other = new CapFloorCMS(CUR, ACCRUAL_FACTOR, RATE, NOTIONAL, ACCRUAL_FACTOR, CMS_CAP.getUnderlyingSwap(), SETTLEMENT_DAYS,
        STRIKE + 0.01, IS_CAP);
    assertFalse(other.equals(capFloorCMS));
    other = new CapFloorCMS(CUR, ACCRUAL_FACTOR, RATE, NOTIONAL, ACCRUAL_FACTOR, CMS_CAP.getUnderlyingSwap(), SETTLEMENT_DAYS, STRIKE,
        !IS_CAP);
    assertFalse(other.equals(capFloorCMS));
  }
}
