...
public class BondFuturesTransactionDiscountingMethodTest {
  ...
  private static final ParameterSensitivityIssuerCalculator<ParameterIssuerProviderInterface> PSC = new ParameterSensitivityIssuerCalculator<>(
      PVCSIC);
  private static final double SHIFT = 1.0E-7;
  private static final ParameterSensitivityIssuerDiscountInterpolatedFDCalculator PSC_DSC_FD = new ParameterSensitivityIssuerDiscountInterpolatedFDCalculator(
      PVIC, SHIFT);
  ...
  public void presentValueFromNetBasis() {
    ...
    final MultipleCurrencyAmount pvComputed = METHOD_FUT_TRA_DSC.presentValueFromNetBasis(BOND_FUTURES_TRA, ISSUER_MULTICURVES,
        netBasisInput);
  ...
  public void presentValueCurveSensitivityVsPrice() {
    // TODO calculator should take into account quantity
    final MultipleCurrencyMulticurveSensitivity pvcsComputed = METHOD_FUT_TRA_DSC
        .presentValueCurveSensitivity(BOND_FUTURES_TRA, ISSUER_MULTICURVES).cleaned().multipliedBy(QUANTITY);
