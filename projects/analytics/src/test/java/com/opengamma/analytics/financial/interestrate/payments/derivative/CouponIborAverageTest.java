...
public class CouponIborAverageTest {
  ...
  private static final ZonedDateTime FIXING_DATE = ScheduleCalculator.getAdjustedDate(ACCRUAL_END_DATE, -INDEX_EURIBOR3M.getSpotLag(),
      CalendarAdapter.of(CALENDAR)); // In arrears
  ...
  private static final double FIXING_ACCRUAL_FACTOR_1 = INDEX_EURIBOR3M.getDayCount().getDayCountFraction(FIXING_START_DATE_1,
      FIXING_END_DATE_1);
  ...
  private static final double FIXING_ACCRUAL_FACTOR_2 = INDEX_EURIBOR3M.getDayCount().getDayCountFraction(FIXING_START_DATE_2,
      FIXING_END_DATE_2);

  private static double WEIGHT_1 = 4.2;
  private static double WEIGHT_2 = -.003;
  private static final CouponIborAverage CPN_IBOR_AVERAGE = new CouponIborAverage(EUR, PAYMENT_TIME, ACCRUAL_FACTOR, NOTIONAL, FIXING_TIME,
      INDEX_EURIBOR3M, FIXING_START_TIME_1, FIXING_END_TIME_1,
  ...
  public void nullCurrency() {
    new CouponIborAverage(null, PAYMENT_TIME, ACCRUAL_FACTOR, NOTIONAL, FIXING_TIME, INDEX_EURIBOR3M, FIXING_START_TIME_1,
        FIXING_END_TIME_1,
        FIXING_ACCRUAL_FACTOR_1, INDEX_EURIBOR6M, FIXING_START_TIME_2, FIXING_END_TIME_2, FIXING_ACCRUAL_FACTOR_2, WEIGHT_1, WEIGHT_2);
  }
  ...
  public void incompatibleCurrency() {
    new CouponIborAverage(Currency.USD, PAYMENT_TIME, ACCRUAL_FACTOR, NOTIONAL, FIXING_TIME, INDEX_EURIBOR3M, FIXING_START_TIME_1,
        FIXING_END_TIME_1,
        FIXING_ACCRUAL_FACTOR_1, INDEX_EURIBOR6M, FIXING_START_TIME_2, FIXING_END_TIME_2, FIXING_ACCRUAL_FACTOR_2, WEIGHT_1, WEIGHT_2);
  }
  ...
  public void testWithNotional() {
    ...
    final CouponIborAverage expected = new CouponIborAverage(EUR, PAYMENT_TIME, ACCRUAL_FACTOR, notional, FIXING_TIME, INDEX_EURIBOR3M,
        FIXING_START_TIME_1, FIXING_END_TIME_1,
        FIXING_ACCRUAL_FACTOR_1, INDEX_EURIBOR6M, FIXING_START_TIME_2, FIXING_END_TIME_2, FIXING_ACCRUAL_FACTOR_2, WEIGHT_1, WEIGHT_2);
  ...
  public void testEqualHash() {
    ...
    final CouponIborAverage other = new CouponIborAverage(EUR, PAYMENT_TIME, ACCRUAL_FACTOR, NOTIONAL, FIXING_TIME, INDEX_EURIBOR3M,
        FIXING_START_TIME_1, FIXING_END_TIME_1,
        FIXING_ACCRUAL_FACTOR_1, INDEX_EURIBOR6M, FIXING_START_TIME_2, FIXING_END_TIME_2, FIXING_ACCRUAL_FACTOR_2, WEIGHT_1, WEIGHT_2);
    ...
    modified = new CouponIborAverage(EUR, PAYMENT_TIME + 0.1, ACCRUAL_FACTOR, NOTIONAL, FIXING_TIME, INDEX_EURIBOR3M, FIXING_START_TIME_1,
        FIXING_END_TIME_1,
        FIXING_ACCRUAL_FACTOR_1, INDEX_EURIBOR6M, FIXING_START_TIME_2, FIXING_END_TIME_2, FIXING_ACCRUAL_FACTOR_2, WEIGHT_1, WEIGHT_2);
    assertFalse("CouponIbor: equal-hash", CPN_IBOR_AVERAGE.equals(modified));
    modified = new CouponIborAverage(EUR, PAYMENT_TIME, ACCRUAL_FACTOR + 0.1, NOTIONAL, FIXING_TIME, INDEX_EURIBOR3M, FIXING_START_TIME_1,
        FIXING_END_TIME_1,
        FIXING_ACCRUAL_FACTOR_1, INDEX_EURIBOR6M, FIXING_START_TIME_2, FIXING_END_TIME_2, FIXING_ACCRUAL_FACTOR_2, WEIGHT_1, WEIGHT_2);
    assertFalse("CouponIbor: equal-hash", CPN_IBOR_AVERAGE.equals(modified));
    modified = new CouponIborAverage(EUR, PAYMENT_TIME, ACCRUAL_FACTOR, NOTIONAL + 0.1, FIXING_TIME, INDEX_EURIBOR3M, FIXING_START_TIME_1,
        FIXING_END_TIME_1,
        FIXING_ACCRUAL_FACTOR_1, INDEX_EURIBOR6M, FIXING_START_TIME_2, FIXING_END_TIME_2, FIXING_ACCRUAL_FACTOR_2, WEIGHT_1, WEIGHT_2);
    assertFalse("CouponIbor: equal-hash", CPN_IBOR_AVERAGE.equals(modified));
    modified = new CouponIborAverage(EUR, PAYMENT_TIME, ACCRUAL_FACTOR, NOTIONAL, FIXING_TIME - 0.1, INDEX_EURIBOR3M, FIXING_START_TIME_1,
        FIXING_END_TIME_1,
        FIXING_ACCRUAL_FACTOR_1, INDEX_EURIBOR6M, FIXING_START_TIME_2, FIXING_END_TIME_2, FIXING_ACCRUAL_FACTOR_2, WEIGHT_1, WEIGHT_2);
    assertFalse("CouponIbor: equal-hash", CPN_IBOR_AVERAGE.equals(modified));
    modified = new CouponIborAverage(EUR, PAYMENT_TIME, ACCRUAL_FACTOR, NOTIONAL, FIXING_TIME, INDEX_EURIBOR3M, FIXING_START_TIME_1 + 0.1,
        FIXING_END_TIME_1,
        FIXING_ACCRUAL_FACTOR_1, INDEX_EURIBOR6M, FIXING_START_TIME_2, FIXING_END_TIME_2, FIXING_ACCRUAL_FACTOR_2, WEIGHT_1, WEIGHT_2);
    assertFalse("CouponIbor: equal-hash", CPN_IBOR_AVERAGE.equals(modified));
    modified = new CouponIborAverage(EUR, PAYMENT_TIME, ACCRUAL_FACTOR, NOTIONAL, FIXING_TIME, INDEX_EURIBOR3M, FIXING_START_TIME_1,
        FIXING_END_TIME_1 + 0.1,
        FIXING_ACCRUAL_FACTOR_1, INDEX_EURIBOR6M, FIXING_START_TIME_2, FIXING_END_TIME_2, FIXING_ACCRUAL_FACTOR_2, WEIGHT_1, WEIGHT_2);
    assertFalse("CouponIbor: equal-hash", CPN_IBOR_AVERAGE.equals(modified));
    modified = new CouponIborAverage(EUR, PAYMENT_TIME, ACCRUAL_FACTOR, NOTIONAL, FIXING_TIME, INDEX_EURIBOR3M, FIXING_START_TIME_1,
        FIXING_END_TIME_1,
        FIXING_ACCRUAL_FACTOR_1 + 0.1, INDEX_EURIBOR6M, FIXING_START_TIME_2, FIXING_END_TIME_2, FIXING_ACCRUAL_FACTOR_2, WEIGHT_1,
        WEIGHT_2);
    assertFalse("CouponIbor: equal-hash", CPN_IBOR_AVERAGE.equals(modified));
    modified = new CouponIborAverage(EUR, PAYMENT_TIME, ACCRUAL_FACTOR, NOTIONAL, FIXING_TIME, INDEX_EURIBOR3M, FIXING_START_TIME_1,
        FIXING_END_TIME_1,
        FIXING_ACCRUAL_FACTOR_1, INDEX_EURIBOR6M, FIXING_START_TIME_2 + 0.1, FIXING_END_TIME_2, FIXING_ACCRUAL_FACTOR_2, WEIGHT_1,
        WEIGHT_2);
    assertFalse("CouponIbor: equal-hash", CPN_IBOR_AVERAGE.equals(modified));
    modified = new CouponIborAverage(EUR, PAYMENT_TIME, ACCRUAL_FACTOR, NOTIONAL, FIXING_TIME, INDEX_EURIBOR3M, FIXING_START_TIME_1,
        FIXING_END_TIME_1,
        FIXING_ACCRUAL_FACTOR_1, INDEX_EURIBOR6M, FIXING_START_TIME_2, FIXING_END_TIME_2 + 0.1, FIXING_ACCRUAL_FACTOR_2, WEIGHT_1,
        WEIGHT_2);
    assertFalse("CouponIbor: equal-hash", CPN_IBOR_AVERAGE.equals(modified));
    modified = new CouponIborAverage(EUR, PAYMENT_TIME, ACCRUAL_FACTOR, NOTIONAL, FIXING_TIME, INDEX_EURIBOR3M, FIXING_START_TIME_1,
        FIXING_END_TIME_1,
        FIXING_ACCRUAL_FACTOR_1, INDEX_EURIBOR6M, FIXING_START_TIME_2, FIXING_END_TIME_2, FIXING_ACCRUAL_FACTOR_2 + 0.1, WEIGHT_1,
        WEIGHT_2);
    assertFalse("CouponIbor: equal-hash", CPN_IBOR_AVERAGE.equals(modified));
    modified = new CouponIborAverage(EUR, PAYMENT_TIME, ACCRUAL_FACTOR, NOTIONAL, FIXING_TIME, INDEX_EURIBOR3M, FIXING_START_TIME_1,
        FIXING_END_TIME_1,
        FIXING_ACCRUAL_FACTOR_1, INDEX_EURIBOR6M, FIXING_START_TIME_2, FIXING_END_TIME_2, FIXING_ACCRUAL_FACTOR_2, WEIGHT_1 + 0.1,
        WEIGHT_2);
    assertFalse("CouponIbor: equal-hash", CPN_IBOR_AVERAGE.equals(modified));
    modified = new CouponIborAverage(EUR, PAYMENT_TIME, ACCRUAL_FACTOR, NOTIONAL, FIXING_TIME, INDEX_EURIBOR3M, FIXING_START_TIME_1,
        FIXING_END_TIME_1,
        FIXING_ACCRUAL_FACTOR_1, INDEX_EURIBOR6M, FIXING_START_TIME_2, FIXING_END_TIME_2, FIXING_ACCRUAL_FACTOR_2, WEIGHT_1,
        WEIGHT_2 + 0.1);
    assertFalse("CouponIbor: equal-hash", CPN_IBOR_AVERAGE.equals(modified));
    modified = new CouponIborAverage(EUR, PAYMENT_TIME, ACCRUAL_FACTOR, NOTIONAL, FIXING_TIME, INDEX_EURIBOR6M, FIXING_START_TIME_1,
        FIXING_END_TIME_1,
        FIXING_ACCRUAL_FACTOR_1, INDEX_EURIBOR6M, FIXING_START_TIME_2, FIXING_END_TIME_2, FIXING_ACCRUAL_FACTOR_2, WEIGHT_1, WEIGHT_2);
    assertFalse("CouponIbor: equal-hash", CPN_IBOR_AVERAGE.equals(modified));
    modified = new CouponIborAverage(EUR, PAYMENT_TIME, ACCRUAL_FACTOR, NOTIONAL, FIXING_TIME, INDEX_EURIBOR3M, FIXING_START_TIME_1,
