...
public class CapFloorCMSSpreadG2ppMethodTest {
  ...
  private static final GeneratorSwapFixedIbor EUR1YEURIBOR6M = GeneratorSwapFixedIborMaster.getInstance().getGenerator("EUR1YEURIBOR6M",
      CALENDAR);
  private static final GeneratorDeposit GEN_EUR_DEPOSIT = new EurDepositGenerator(CALENDAR);
  ...
  private static final ZonedDateTime ACCRUAL_START_DATE = ScheduleCalculator.getAdjustedDate(FIXING_DATE, EUR1YEURIBOR6M.getSpotLag(),
      CALENDAR);
  private static final ZonedDateTime ACCRUAL_END_DATE = ScheduleCalculator.getAdjustedDate(ACCRUAL_START_DATE, Period.ofMonths(6),
      GEN_EUR_DEPOSIT);
  ...
  private static final CapFloorCMSSpreadDefinition CMS_SPREAD_DEFINITION = CapFloorCMSSpreadDefinition.from(PAYMENT_DATE,
      ACCRUAL_START_DATE, ACCRUAL_END_DATE, PAYMENT_ACCRUAL_FACTOR, NOTIONAL,
      SWAP_EUR10Y, SWAP_EUR2Y, STRIKE, IS_CAP, CalendarAdapter.of(CALENDAR), CalendarAdapter.of(CALENDAR));
  ...
  private static final CapFloorCMSSpreadG2ppNumericalIntegrationMethod METHOD_NI = CapFloorCMSSpreadG2ppNumericalIntegrationMethod
      .getInstance();
