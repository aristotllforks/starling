...
public final class GeneratorSwapFixedIborMaster {
  ...
  private GeneratorSwapFixedIborMaster() {
    ...
    _generatorSwap.put("USD6MLIBOR1M",
        new GeneratorSwapFixedIbor("USD6MLIBOR1M", Period.ofMonths(6), DayCounts.THIRTY_U_360, _iborIndexMaster.getIndex("USDLIBOR1M"),
            baseCalendar));
    _generatorSwap.put("USD6MLIBOR3M",
        new GeneratorSwapFixedIbor("USD6MLIBOR3M", Period.ofMonths(6), DayCounts.THIRTY_U_360, _iborIndexMaster.getIndex("USDLIBOR3M"),
            baseCalendar));
    ...
    _generatorSwap.put("USD6MLIBOR6M",
        new GeneratorSwapFixedIbor("USD6MLIBOR6M", Period.ofMonths(6), DayCounts.THIRTY_U_360, _iborIndexMaster.getIndex("USDLIBOR6M"),
            baseCalendar));
    ...
    _generatorSwap.put("GBP6MLIBOR6M",
        new GeneratorSwapFixedIbor("GBP6MLIBOR6M", Period.ofMonths(6), DayCounts.ACT_365, _iborIndexMaster.getIndex("GBPLIBOR6M"),
            baseCalendar));
    _generatorSwap.put("DKK1YCIBOR6M",
        new GeneratorSwapFixedIbor("DKK1YCIBOR6M", Period.ofMonths(12), DayCounts.THIRTY_U_360, _iborIndexMaster.getIndex("DKKCIBOR6M"),
            baseCalendar));
    _generatorSwap.put("JPY6MLIBOR3M",
        new GeneratorSwapFixedIbor("JPY6MLIBOR3M", Period.ofMonths(6), DayCounts.ACT_365, _iborIndexMaster.getIndex("JPYLIBOR3M"),
            baseCalendar));
  ...
  public GeneratorSwapFixedIbor getGenerator(final String name, final WorkingDayCalendar cal) {
    ...
    return new GeneratorSwapFixedIbor(generatorNoCalendar.getName(), generatorNoCalendar.getFixedLegPeriod(),
        generatorNoCalendar.getFixedLegDayCount(),
        _iborIndexMaster.getIndex(generatorNoCalendar.getIborIndex().getName()), CalendarAdapter.of(cal));
  }
