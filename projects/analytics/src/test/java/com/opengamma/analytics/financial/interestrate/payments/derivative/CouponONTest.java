...
public class CouponONTest {
  ...
  static {
    LAST_FIXING_DATE = ScheduleCalculator.getAdjustedDate(LAST_FIXING_DATE, EUR_PUBLICATION_LAG, CalendarAdapter.of(CALENDAR)); // Lag
  }
  ...
  private static final CouponONSimplifiedDefinition EONIA_COUPON_DEFINITION = new CouponONSimplifiedDefinition(EUR_CUR, PAYMENT_DATE,
      START_ACCRUAL_DATE, END_ACCRUAL_DATE, PAYMENT_YEAR_FRACTION,
  ...
  private static final CouponON EONIA_COUPON_NOTSTARTED = new CouponON(EUR_CUR, PAYMENT_TIME_1, PAYMENT_YEAR_FRACTION, NOTIONAL, EUR_OIS,
      START_ACCRUAL_TIME_1, END_ACCRUAL_TIME_1,
  ...
  private static final CouponON EONIA_COUPON_STARTED = new CouponON(EUR_CUR, PAYMENT_TIME_2, PAYMENT_YEAR_FRACTION, NOTIONAL, EUR_OIS,
  ...
  public void nullIndex() {
    new CouponON(EUR_CUR, PAYMENT_TIME_1, PAYMENT_YEAR_FRACTION, NOTIONAL, null, START_ACCRUAL_TIME_1, END_ACCRUAL_TIME_1,
        FIXING_YEAR_FRACTION, NOTIONAL);
  }
  ...
  public void equalHash() {
    ...
    final CouponON other = new CouponON(EUR_CUR, PAYMENT_TIME_2, PAYMENT_YEAR_FRACTION, NOTIONAL, EUR_OIS, START_FIXING_TIME_2,
    ...
    CouponON modified;
    modified = new CouponON(EUR_CUR, PAYMENT_TIME_2, PAYMENT_YEAR_FRACTION, NOTIONAL, US_OIS, START_FIXING_TIME_2, END_FIXING_TIME_2,
        FIXING_YEAR_FRACTION_2, NOTIONAL_WITH_ACCRUED);
    assertFalse("CouponOIS derivative: equal/hash code", EONIA_COUPON_STARTED.equals(modified));
    modified = new CouponON(EUR_CUR, PAYMENT_TIME_2, PAYMENT_YEAR_FRACTION, NOTIONAL, EUR_OIS, START_FIXING_TIME_2 + 0.1, END_FIXING_TIME_2,
        FIXING_YEAR_FRACTION_2,
        NOTIONAL_WITH_ACCRUED);
    assertFalse("CouponOIS derivative: equal/hash code", EONIA_COUPON_STARTED.equals(modified));
    modified = new CouponON(EUR_CUR, PAYMENT_TIME_2, PAYMENT_YEAR_FRACTION, NOTIONAL, EUR_OIS, START_FIXING_TIME_2, END_FIXING_TIME_2 + 0.1,
        FIXING_YEAR_FRACTION_2,
        NOTIONAL_WITH_ACCRUED);
    assertFalse("CouponOIS derivative: equal/hash code", EONIA_COUPON_STARTED.equals(modified));
    modified = new CouponON(EUR_CUR, PAYMENT_TIME_2, PAYMENT_YEAR_FRACTION, NOTIONAL, EUR_OIS, START_FIXING_TIME_2, END_FIXING_TIME_2,
