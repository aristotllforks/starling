...
public class CouponIborCompoundingFlatSpreadDiscountingMethodTest {
  ...
  private static final WorkingDayCalendar CALENDAR = MulticurveProviderDiscountDataSets.getCADCalendar();
  ...
  private static final CouponIborCompoundingFlatSpreadDefinition CPN_DEFINITION = CouponIborCompoundingFlatSpreadDefinition.from(NOTIONAL,
      START_DATE, END_DATE, CADCDOR3M, SPREAD,
      StubType.SHORT_START, CADCDOR3M.getBusinessDayConvention(), CADCDOR3M.isEndOfMonth(), CalendarAdapter.of(CALENDAR));

  private static final CouponIborCompoundingFlatSpreadDiscountingMethod METHOD_COMPOUNDED = CouponIborCompoundingFlatSpreadDiscountingMethod
      .getInstance();

  private static final ZonedDateTime REFERENCE_DATE_BEFORE = DateUtils.getUTCDate(2012, 8, 7);
  private static final CouponIborCompoundingFlatSpread CPN_BEFORE = CPN_DEFINITION.toDerivative(REFERENCE_DATE_BEFORE); // Reference date
                                                                                                                        // before the coupon
                                                                                                                        // start date.
  ...
  private static final DoubleTimeSeries<ZonedDateTime> FIXING_TS = ImmutableZonedDateTimeDoubleTimeSeries.ofUTC(
      new ZonedDateTime[] { DateUtils.getUTCDate(2012, 8, 23), DateUtils.getUTCDate(2012, 8, 24),
          DateUtils.getUTCDate(2012, 9, 20) },
      FIXING_RATES);
  private static final ZonedDateTime REFERENCE_DATE_1 = DateUtils.getUTCDate(2012, 8, 28);
  private static final CouponIborCompoundingFlatSpread CPN_1 = (CouponIborCompoundingFlatSpread) CPN_DEFINITION
      .toDerivative(REFERENCE_DATE_1, FIXING_TS);
  ...
  private static final PresentValueCurveSensitivityDiscountingCalculator PVCSDC = PresentValueCurveSensitivityDiscountingCalculator
      .getInstance();
  private static final PresentValueMarketQuoteSensitivityDiscountingCalculator PVMQSDC = PresentValueMarketQuoteSensitivityDiscountingCalculator
      .getInstance();

  private static final double SHIFT = 1.0E-6;

  private static final ParameterSensitivityParameterCalculator<MulticurveProviderInterface> PS_PV_C = new ParameterSensitivityParameterCalculator<>(
      PVCSDC);
  private static final ParameterSensitivityMulticurveDiscountInterpolatedFDCalculator PS_PV_FDC = new ParameterSensitivityMulticurveDiscountInterpolatedFDCalculator(
      PVDC, SHIFT);
  ...
  public void presentValueMethodVsCalculator() {
    ...
    assertEquals("CouponIborCompoundingFlatSpreadDiscountingMethod: Present value", pvMethod.getAmount(CAD),
        pvCalculator.getAmount(CADCDOR3M.getCurrency()), TOLERANCE_PV);
  }
  ...
  public void presentValueCurveSensitivity() {
    final MultipleCurrencyParameterSensitivity pvpsDepositExact = PS_PV_C.calculateSensitivity(CPN_BEFORE, MULTICURVES,
    ...
    AssertSensitivityObjects.assertEquals("CouponIborCompoundingFlatSpreadDiscountingMethod: presentValueCurveSensitivity ",
  ...
  public void presentValueCurveSensitivityMethodVsCalculator() {
    ...
    AssertSensitivityObjects.assertEquals("CouponIborCompoundingFlatSpreadDiscountingMethod: Present value curve sensitivity", pvcsMethod,
  ...
  public void presentValueMarketQuoteSensitivity() {
    final CouponIborCompoundingFlatSpreadDefinition cpnShiftedPDefinition = CouponIborCompoundingFlatSpreadDefinition.from(NOTIONAL,
        START_DATE, END_DATE, CADCDOR3M, SPREAD + SHIFT,
        StubType.SHORT_START, CADCDOR3M.getBusinessDayConvention(), CADCDOR3M.isEndOfMonth(), CalendarAdapter.of(CALENDAR));
    final CouponIborCompoundingFlatSpreadDefinition cpnShiftedMDefinition = CouponIborCompoundingFlatSpreadDefinition.from(NOTIONAL,
        START_DATE, END_DATE, CADCDOR3M, SPREAD - SHIFT,
        StubType.SHORT_START, CADCDOR3M.getBusinessDayConvention(), CADCDOR3M.isEndOfMonth(), CalendarAdapter.of(CALENDAR));
    ...
    assertEquals("CouponIborCompoundingFlatSpreadDiscountingMethod: Present value market quote sensitivity", mqsExpected, mqsCalculator,
        TOLERANCE_PV_DELTA);
    assertEquals("CouponIborCompoundingFlatSpreadDiscountingMethod: Present value market quote sensitivity", mqsCalculator, mqsMethod,
        TOLERANCE_PV_DELTA);
  }
