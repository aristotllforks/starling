...
public class LegacyForwardStartingCreditDefaultSwapDefinition extends LegacyCreditDefaultSwapDefinition {
  ...
  public LegacyForwardStartingCreditDefaultSwapDefinition(final BuySellProtection buySellProtection, final LegalEntity protectionBuyer,
  ...
  public LegacyForwardStartingCreditDefaultSwapDefinition withStartDate(final ZonedDateTime startDate) {
    return new LegacyForwardStartingCreditDefaultSwapDefinition(getBuySellProtection(), getProtectionBuyer(), getProtectionSeller(), getReferenceEntity(),
