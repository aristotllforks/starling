...
/**
 * Class describing a OIS-like floating coupon. The description is simplified by not creating the full set of fixing dates. Only the start and the end of the
 * fixing period are described. The description is enough to construct curves from OIS and to price forward OIS but not to describe and price OIS coupons for
 * which some fixing already took place.
 */
