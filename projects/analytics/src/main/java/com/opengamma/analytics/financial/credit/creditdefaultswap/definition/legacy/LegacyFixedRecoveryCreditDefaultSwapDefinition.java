...
public class LegacyFixedRecoveryCreditDefaultSwapDefinition extends LegacyCreditDefaultSwapDefinition {
  ...
  public LegacyFixedRecoveryCreditDefaultSwapDefinition(final BuySellProtection buySellProtection, final LegalEntity protectionBuyer,
  ...
  public LegacyFixedRecoveryCreditDefaultSwapDefinition withStartDate(final ZonedDateTime startDate) {
    return new LegacyFixedRecoveryCreditDefaultSwapDefinition(getBuySellProtection(), getProtectionBuyer(), getProtectionSeller(), getReferenceEntity(),
