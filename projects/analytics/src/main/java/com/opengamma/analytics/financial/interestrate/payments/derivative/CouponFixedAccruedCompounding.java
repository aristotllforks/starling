...
/**
 * Class describing a fixed compounded coupon. The amount paid is equal to $$ \begin{equation*} (1+r)^ \delta -\epsilon \end{equation*} $$ where the $\delta$ is
 * the accrual factor of the period and the $r$ the fixed rate. dates used to compute the coupon accrual factors.
 */
public class CouponFixedAccruedCompounding extends Coupon {
   ...
   */
  @Deprecated
  public CouponFixedAccruedCompounding(final Currency currency, final double paymentTime, final String fundingCurveName, final double paymentYearFraction,
   ...
   *          The coupon fixed rate.
   */
  public CouponFixedAccruedCompounding(final Currency currency, final double paymentTime, final double paymentYearFraction, final double notional,
      final double rate) {
  ...
  public CouponFixedAccruedCompounding withRate(final double rate) {
    return new CouponFixedAccruedCompounding(getCurrency(), getPaymentTime(), getFundingCurveName(), getPaymentYearFraction(), getNotional(), rate,
  ...
  public CouponFixedAccruedCompounding withRateShifted(final double spread) {
    return new CouponFixedAccruedCompounding(getCurrency(), getPaymentTime(), getFundingCurveName(), getPaymentYearFraction(), getNotional(),
  ...
  public CouponFixedAccruedCompounding withNotional(final double notional) {
    return new CouponFixedAccruedCompounding(getCurrency(), getPaymentTime(), getFundingCurveName(), getPaymentYearFraction(), notional, getFixedRate(),
        getAccrualStartDate(), getAccrualEndDate());
  }
