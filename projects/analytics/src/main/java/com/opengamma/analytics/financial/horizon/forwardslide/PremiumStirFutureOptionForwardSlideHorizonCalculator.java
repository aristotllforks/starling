...
/**
 * Calculates the theta for a short-term interest rate future option with upfront premium with rate and volatility slide.
 */
public class PremiumStirFutureOptionForwardSlideHorizonCalculator
