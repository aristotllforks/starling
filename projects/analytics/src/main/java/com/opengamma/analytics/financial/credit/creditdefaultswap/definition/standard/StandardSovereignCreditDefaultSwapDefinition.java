...
public class StandardSovereignCreditDefaultSwapDefinition extends StandardCreditDefaultSwapDefinition {
  ...
  public StandardSovereignCreditDefaultSwapDefinition(final BuySellProtection buySellProtection, final LegalEntity protectionBuyer,
  ...
  public StandardSovereignCreditDefaultSwapDefinition withSpread(final double spread) {
    return new StandardSovereignCreditDefaultSwapDefinition(getBuySellProtection(), getProtectionBuyer(), getProtectionSeller(), getReferenceEntity(),
