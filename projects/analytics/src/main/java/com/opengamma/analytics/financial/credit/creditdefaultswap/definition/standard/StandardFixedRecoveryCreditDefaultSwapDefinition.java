...
public class StandardFixedRecoveryCreditDefaultSwapDefinition extends StandardCreditDefaultSwapDefinition {
  ...
  public StandardFixedRecoveryCreditDefaultSwapDefinition(final BuySellProtection buySellProtection, final LegalEntity protectionBuyer,
  ...
  public StandardFixedRecoveryCreditDefaultSwapDefinition withSpread(final double spread) {
    return new StandardFixedRecoveryCreditDefaultSwapDefinition(getBuySellProtection(), getProtectionBuyer(), getProtectionSeller(), getReferenceEntity(),
