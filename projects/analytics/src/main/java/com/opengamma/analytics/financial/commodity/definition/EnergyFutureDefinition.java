...
public class EnergyFutureDefinition extends CommodityFutureDefinition<EnergyFuture> {
   ...
   * @param settlementDate settlement date
   */
  public EnergyFutureDefinition(final ZonedDateTime expiryDate, final ExternalId underlying, final double unitAmount,
   ...
   * @return the future
   */
  public static EnergyFutureDefinition withCashSettlement(final ZonedDateTime expiryDate, final ExternalId underlying,
  ...
  public static EnergyFutureDefinition withPhysicalSettlement(final ZonedDateTime expiryDate, final ExternalId underlying, final double unitAmount,
      ...
      final Currency currency, final ZonedDateTime settlementDate) {
    return new EnergyFutureDefinition(expiryDate, underlying, unitAmount, firstDeliveryDate, lastDeliveryDate, amount, unitName,
  ...
  public EnergyFuture toDerivative(final ZonedDateTime date) {
    ...
    return new EnergyFuture(timeToFixing, getUnderlying(), getUnitAmount(), getFirstDeliveryDate(), getLastDeliveryDate(),
