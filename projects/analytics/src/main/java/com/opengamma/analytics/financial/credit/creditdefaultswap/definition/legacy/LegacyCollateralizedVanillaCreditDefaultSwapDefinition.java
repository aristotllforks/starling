...
public class LegacyCollateralizedVanillaCreditDefaultSwapDefinition extends LegacyCreditDefaultSwapDefinition {
  ...
  public LegacyCollateralizedVanillaCreditDefaultSwapDefinition(final BuySellProtection buySellProtection, final LegalEntity protectionBuyer,
  ...
  public LegacyCollateralizedVanillaCreditDefaultSwapDefinition withStartDate(final ZonedDateTime startDate) {
    return new LegacyCollateralizedVanillaCreditDefaultSwapDefinition(getBuySellProtection(), getProtectionBuyer(), getProtectionSeller(), getReferenceEntity(),
