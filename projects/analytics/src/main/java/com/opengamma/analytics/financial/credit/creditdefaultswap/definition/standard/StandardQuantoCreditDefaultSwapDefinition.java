...
public class StandardQuantoCreditDefaultSwapDefinition extends StandardCreditDefaultSwapDefinition {
  ...
  public StandardQuantoCreditDefaultSwapDefinition(final BuySellProtection buySellProtection, final LegalEntity protectionBuyer,
  ...
  public StandardQuantoCreditDefaultSwapDefinition withSpread(final double spread) {
    return new StandardQuantoCreditDefaultSwapDefinition(getBuySellProtection(), getProtectionBuyer(), getProtectionSeller(), getReferenceEntity(),
