...
/**
 * Calculates the theta for a margined short-term interest rate future option without rate slide.
 */
public class MarginedStirFutureOptionConstantSpreadHorizonCalculator
