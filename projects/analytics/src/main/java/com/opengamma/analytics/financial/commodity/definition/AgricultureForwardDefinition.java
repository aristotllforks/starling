...
public class AgricultureForwardDefinition extends CommodityForwardDefinition<AgricultureForward> {
   ...
   */
  public AgricultureForwardDefinition(final ZonedDateTime expiryDate, final ExternalId underlying, final double unitAmount,
   ...
   * @return the forward
   */
  public static AgricultureForwardDefinition withCashSettlement(final ZonedDateTime expiryDate, final ExternalId underlying,
   ...
   * @return the forward
   */
  public static AgricultureForwardDefinition withPhysicalSettlement(final ZonedDateTime expiryDate, final ExternalId underlying,
      final double unitAmount, final ZonedDateTime firstDeliveryDate, final ZonedDateTime lastDeliveryDate, final double amount,
      final String unitName, final double referencePrice, final Currency currency, final ZonedDateTime settlementDate) {
    return new AgricultureForwardDefinition(expiryDate, underlying, unitAmount, firstDeliveryDate, lastDeliveryDate, amount, unitName,
  ...
  public AgricultureForward toDerivative(final ZonedDateTime date) {
    ...
    return new AgricultureForward(timeToFixing, getUnderlying(), getUnitAmount(), getFirstDeliveryDate(),
