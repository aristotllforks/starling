...
public class StandardVanillaCreditDefaultSwapDefinition extends StandardCreditDefaultSwapDefinition {
  ...
  public StandardVanillaCreditDefaultSwapDefinition(final BuySellProtection buySellProtection, final LegalEntity protectionBuyer,
  ...
  public StandardVanillaCreditDefaultSwapDefinition withSpread(final double spread) {
    return new StandardVanillaCreditDefaultSwapDefinition(getBuySellProtection(), getProtectionBuyer(), getProtectionSeller(), getReferenceEntity(),
