...
public class SwapFixedIborDefinition extends SwapDefinition {
  ...
  /**
   * Constructor of the fixed-ibor swap from its two legs. This constructor is intended to be used when there is an initial floating rate defined in the swap
   * contract - the stream of payments on the floating leg then consists of a {@link CouponFixedDefinition} and then a series of {@link CouponIborDefinition}.
   * 
   * @param fixedLeg
   *          The fixed leg.
   * @param iborLeg
   ...
   *          The settlement date.
   * @param cmsIndex
   *          The CMS index from which the swap is constructed.
   * @param notional
   *          The swap notional
   * @param fixedRate
   *          The swap fixed rate.
   * @param isPayer
   *          The payer flag of the fixed leg.
   * @param calendar
  ...
  public static SwapFixedIborDefinition from(final ZonedDateTime settlementDate, final IndexSwap cmsIndex, final double notional, final double fixedRate,
    ...
    final AnnuityCouponFixedDefinition fixedLeg = AnnuityCouponFixedDefinition.from(cmsIndex.getCurrency(), settlementDate, cmsIndex.getTenor(),
        cmsIndex.getFixedLegPeriod(), calendar,
        cmsIndex.getFixedLegDayCount(), cmsIndex.getIborIndex().getBusinessDayConvention(), cmsIndex.getIborIndex().isEndOfMonth(), notional, fixedRate,
        isPayer);
    final AnnuityCouponIborDefinition iborLeg = AnnuityCouponIborDefinition.from(settlementDate, cmsIndex.getTenor(), notional, cmsIndex.getIborIndex(),
        !isPayer, calendar);
   ...
   * @return The vanilla swap.
   */
  public static SwapFixedIborDefinition from(final ZonedDateTime settlementDate, final Period tenor, final GeneratorSwapFixedIbor generator,
      final double notional, final double fixedRate,
      final boolean isPayer) {
    ArgumentChecker.notNull(settlementDate, "settlement date");
    ArgumentChecker.notNull(tenor, "Tenor");
    ArgumentChecker.notNull(generator, "Swap generator");
    final AnnuityCouponFixedDefinition fixedLeg = AnnuityCouponFixedDefinition.from(generator.getCurrency(), settlementDate, tenor,
        generator.getFixedLegPeriod(), generator.getCalendar(),
        generator.getFixedLegDayCount(), generator.getIborIndex().getBusinessDayConvention(), generator.getIborIndex().isEndOfMonth(), notional, fixedRate,
        isPayer);
   ...
   *          The swap generator.
   * @param notional
   *          The swap notional (identical on both legs)
   * @param fixedRate
   *          The swap fixed rate.
   * @param isPayer
   *          The payer flag of the fixed leg.
  ...
  public static SwapFixedIborDefinition from(final ZonedDateTime settlementDate, final ZonedDateTime maturityDate, final GeneratorSwapFixedIbor generator,
    ...
    ArgumentChecker.notNull(generator, "Swap generator");
    final AnnuityCouponFixedDefinition fixedLeg = AnnuityCouponFixedDefinition.from(generator.getCurrency(), settlementDate, maturityDate,
        generator.getFixedLegPeriod(), generator.getCalendar(),
        generator.getFixedLegDayCount(), generator.getIborIndex().getBusinessDayConvention(), generator.getIborIndex().isEndOfMonth(), notional, fixedRate,
        isPayer);
  ...
  public static SwapFixedIborDefinition from(final ZonedDateTime settlementDate, final ZonedDateTime maturityDate, final GeneratorSwapFixedIbor generator,
    ...
    final AnnuityCouponFixedDefinition fixedLeg = AnnuityCouponFixedDefinition.from(generator.getCurrency(), settlementDate, maturityDate,
        generator.getFixedLegPeriod(), generator.getCalendar(),
        generator.getFixedLegDayCount(), generator.getIborIndex().getBusinessDayConvention(), generator.getIborIndex().isEndOfMonth(), notionalFixed, fixedRate,
        isPayer);
   ...
   *          The payment period for the fixed leg.
   * @param fixedLegDayCount
   *          The fixed leg day count.
   * @param fixedLegBusinessDayConvention
   *          The fixed leg business day convention.
   * @param fixedLegEOM
   *          The fixed leg end-of-month rule application.
   * @param fixedLegNotional
   *          The fixed leg notional.
   * @param fixedLegRate
   *          The fixed leg rate.
   * @param iborLegPeriod
   *          The Ibor leg payment period.
   * @param iborLegDayCount
   *          The Ibor leg day count convention.
   * @param iborLegBusinessDayConvention
   *          The Ibor leg business day convention.
   * @param iborLegEOM
   *          The Ibor leg end-of-month.
   * @param iborLegNotional
   *          The Ibor leg notional.
   * @param iborIndex
   *          The Ibor index.
   * @param isPayer
   *          The payer flag for the fixed leg.
   * @param calendar
   *          The calendar.
   * @return The swap.
   */
  public static SwapFixedIborDefinition from(final ZonedDateTime settlementDate, final ZonedDateTime maturityDate, final Period fixedLegPeriod,
      ...
      final BusinessDayConvention fixedLegBusinessDayConvention, final boolean fixedLegEOM, final double fixedLegNotional, final double fixedLegRate,
    ...
    final AnnuityCouponFixedDefinition fixedLeg = AnnuityCouponFixedDefinition.from(iborIndex.getCurrency(), settlementDate, maturityDate, fixedLegPeriod,
        calendar, fixedLegDayCount,
        fixedLegBusinessDayConvention, fixedLegEOM, fixedLegNotional, fixedLegRate, isPayer);
    final AnnuityCouponIborDefinition iborLeg = AnnuityCouponIborDefinition.from(settlementDate, maturityDate, iborLegPeriod, iborLegNotional, iborIndex,
        !isPayer, iborLegBusinessDayConvention,
