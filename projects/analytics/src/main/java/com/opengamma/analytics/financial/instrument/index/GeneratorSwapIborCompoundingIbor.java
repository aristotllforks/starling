...
public class GeneratorSwapIborCompoundingIbor extends GeneratorInstrument<GeneratorAttributeIR> {
   ...
   *          The holiday calendar for the second ibor leg.
   */
  public GeneratorSwapIborCompoundingIbor(final String name, final IborIndex iborIndex1, final Period compoundingPeriod1,
      final IborIndex iborIndex2,
  ...
  public GeneratorSwapIborCompoundingIbor(final String name, final IborIndex iborIndex1, final Period compoundingPeriod1,
      final IborIndex iborIndex2,
      final WorkingDayCalendar calendar1, final WorkingDayCalendar calendar2) {
    super(name);
    ArgumentChecker.notNull(iborIndex1, "ibor index 1");
    ArgumentChecker.notNull(compoundingPeriod1, "compounding period 1");
    ArgumentChecker.notNull(iborIndex2, "ibor index 2");
  ...
  @Override
  public SwapDefinition generateInstrument(final ZonedDateTime date, final double spread, final double notional,
    ...
    final AnnuityDefinition<CouponIborCompoundingFlatSpreadDefinition> leg1 = AnnuityDefinitionBuilder.couponIborCompoundingFlatSpread(
        startDate, maturityDate,
        _compoundingPeriod1, notional, spread, _iborIndex1, StubType.SHORT_START, true, _businessDayConvention, _endOfMonth, _calendar1,
        StubType.SHORT_START);
    final AnnuityDefinition<CouponIborDefinition> leg2 = AnnuityDefinitionBuilder.couponIbor(startDate, maturityDate,
        _iborIndex2.getTenor(), notional,
        _iborIndex2, false,
