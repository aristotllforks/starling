...
public class StandardForwardStartingCreditDefaultSwapDefinition extends StandardCreditDefaultSwapDefinition {
  ...
  public StandardForwardStartingCreditDefaultSwapDefinition(final BuySellProtection buySellProtection, final LegalEntity protectionBuyer,
  ...
  public StandardForwardStartingCreditDefaultSwapDefinition withSpread(final double spread) {
    return new StandardForwardStartingCreditDefaultSwapDefinition(getBuySellProtection(), getProtectionBuyer(), getProtectionSeller(), getReferenceEntity(),
