...
import com.opengamma.analytics.financial.horizon.rolldown.FxOptionBlackDataConstantSpreadRolldown;
 ...
 *
 */
public class DigitalFxOptionConstantSpreadHorizonCalculator
  ...
  public MultipleCurrencyAmount getTheta(final ForexOptionDigitalDefinition definition, final ZonedDateTime date,
    ...
    final BlackForexSmileProviderInterface tomorrowData = FxOptionBlackDataConstantSpreadRolldown.INSTANCE
