...
public class LegacyVanillaCreditDefaultSwapDefinition extends LegacyCreditDefaultSwapDefinition {
  ...
  public LegacyVanillaCreditDefaultSwapDefinition(final BuySellProtection buySellProtection, final LegalEntity protectionBuyer,
  ...
  public LegacyVanillaCreditDefaultSwapDefinition withStartDate(final ZonedDateTime startDate) {
    return new LegacyVanillaCreditDefaultSwapDefinition(getBuySellProtection(), getProtectionBuyer(), getProtectionSeller(), getReferenceEntity(),
