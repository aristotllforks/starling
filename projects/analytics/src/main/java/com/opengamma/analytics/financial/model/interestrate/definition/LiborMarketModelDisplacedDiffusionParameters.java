...
public class LiborMarketModelDisplacedDiffusionParameters {
   ...
   *          The mean reversion used for the volatility time dependency.
   */
  public LiborMarketModelDisplacedDiffusionParameters(final double[] iborTime, final double[] accrualFactor, final double[] displacement,
      final double[][] volatility, final double meanReversion) {
   ...
   * @param annuity
   *          The annuity to be used for the model construction, not null
   * @param dayCount
   *          The Ibor day count, not null
   * @param displacement
   *          The displacement (common to all Ibors).
   * @param meanReversion
   *          The mean reversion.
   ...
   * @param startIndex
   *          The start index for the block to change.
   */
