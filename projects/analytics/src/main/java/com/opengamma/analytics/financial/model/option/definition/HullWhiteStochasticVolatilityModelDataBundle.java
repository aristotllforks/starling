...
public class HullWhiteStochasticVolatilityModelDataBundle extends StandardOptionDataBundle {
  ...
  public HullWhiteStochasticVolatilityModelDataBundle(final YieldAndDiscountCurve discountCurve, final double b, final VolatilitySurface volatilitySurface,
      final double spot,
  ...
  public HullWhiteStochasticVolatilityModelDataBundle(final StandardOptionDataBundle data, final double lambda, final double sigmaLR, final double volOfVol,
      final double rho) {
    super(data);
    _lambda = lambda;
    _sigmaLR = sigmaLR;
  ...
  public HullWhiteStochasticVolatilityModelDataBundle withInterestRateCurve(final YieldAndDiscountCurve curve) {
    return new HullWhiteStochasticVolatilityModelDataBundle(curve, getCostOfCarry(), getVolatilitySurface(), getSpot(), getDate(), getHalfLife(),
        getLongRunVolatility(), getVolatilityOfVolatility(),
        getCorrelation());
  }

  @Override
  public HullWhiteStochasticVolatilityModelDataBundle withCostOfCarry(final double b) {
    return new HullWhiteStochasticVolatilityModelDataBundle(getInterestRateCurve(), b, getVolatilitySurface(), getSpot(), getDate(), getHalfLife(),
        getLongRunVolatility(), getVolatilityOfVolatility(),
        getCorrelation());
  }
  ...
  public HullWhiteStochasticVolatilityModelDataBundle withVolatilitySurface(final VolatilitySurface surface) {
    return new HullWhiteStochasticVolatilityModelDataBundle(getInterestRateCurve(), getCostOfCarry(), surface, getSpot(), getDate(), getHalfLife(),
        getLongRunVolatility(), getVolatilityOfVolatility(),
        getCorrelation());
  }
  ...
  public HullWhiteStochasticVolatilityModelDataBundle withSpot(final double spot) {
    return new HullWhiteStochasticVolatilityModelDataBundle(getInterestRateCurve(), getCostOfCarry(), getVolatilitySurface(), spot, getDate(), getHalfLife(),
        getLongRunVolatility(),
  ...
  public HullWhiteStochasticVolatilityModelDataBundle withDate(final ZonedDateTime date) {
    return new HullWhiteStochasticVolatilityModelDataBundle(getInterestRateCurve(), getCostOfCarry(), getVolatilitySurface(), getSpot(), date, getHalfLife(),
        getLongRunVolatility(),
        getVolatilityOfVolatility(), getCorrelation());
  }

  public HullWhiteStochasticVolatilityModelDataBundle withHalfLife(final double lambda) {
    return new HullWhiteStochasticVolatilityModelDataBundle(getInterestRateCurve(), getCostOfCarry(), getVolatilitySurface(), getSpot(), getDate(), lambda,
        getLongRunVolatility(),
        getVolatilityOfVolatility(), getCorrelation());
  }

  public HullWhiteStochasticVolatilityModelDataBundle withLongRunVolatility(final double longRunVolatility) {
    return new HullWhiteStochasticVolatilityModelDataBundle(getInterestRateCurve(), getCostOfCarry(), getVolatilitySurface(), getSpot(), getDate(),
        getHalfLife(), longRunVolatility,
        getVolatilityOfVolatility(), getCorrelation());
  }

  public HullWhiteStochasticVolatilityModelDataBundle withVolatilityOfVolatility(final double volOfVol) {
    return new HullWhiteStochasticVolatilityModelDataBundle(getInterestRateCurve(), getCostOfCarry(), getVolatilitySurface(), getSpot(), getDate(),
        getHalfLife(), getLongRunVolatility(), volOfVol,
        getCorrelation());
  }

  public HullWhiteStochasticVolatilityModelDataBundle withCorrelation(final double rho) {
    return new HullWhiteStochasticVolatilityModelDataBundle(getInterestRateCurve(), getCostOfCarry(), getVolatilitySurface(), getSpot(), getDate(),
        getHalfLife(), getLongRunVolatility(),
