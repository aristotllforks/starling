...
public class MetalFutureSecurityDefinition extends CommodityFutureSecurityDefinition<MetalFutureSecurity> {
   ...
   */
  public MetalFutureSecurityDefinition(final ZonedDateTime lastTradingDate, final CommodityUnderlying underlying, final String unitName,
  ...
  public MetalFutureSecurity toDerivative(final ZonedDateTime date) {
    ...
    return new MetalFutureSecurity(lastTradingTime, getUnderlying(), getUnitName(), getUnitAmount(), noticeFirstTime, noticeLastTime,
