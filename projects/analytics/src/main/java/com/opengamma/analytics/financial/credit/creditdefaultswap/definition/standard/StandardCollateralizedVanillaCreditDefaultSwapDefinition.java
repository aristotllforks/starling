...
public class StandardCollateralizedVanillaCreditDefaultSwapDefinition extends StandardVanillaCreditDefaultSwapDefinition {
  ...
  public StandardCollateralizedVanillaCreditDefaultSwapDefinition(final BuySellProtection buySellProtection, final LegalEntity protectionBuyer,
      final LegalEntity protectionSeller,
      final LegalEntity referenceEntity, final Currency currency, final DebtSeniority debtSeniority, final RestructuringClause restructuringClause,
      final Calendar calendar, final ZonedDateTime startDate,
      ...
      final ZonedDateTime cashSettlementDate, final boolean adjustCashSettlementDate, final CreditSupportAnnexDefinition creditSupportAnnex,
  ...
  public StandardCollateralizedVanillaCreditDefaultSwapDefinition withSpread(final double spread) {
    return new StandardCollateralizedVanillaCreditDefaultSwapDefinition(getBuySellProtection(), getProtectionBuyer(), getProtectionSeller(),
        getReferenceEntity(), getCurrency(), getDebtSeniority(),
        ...
        getProtectionStart(), spread, getPremiumLegCoupon(), getUpfrontAmount(), getCashSettlementDate(), getAdjustCashSettlementDate(), _creditSupportAnnex,
  ...
  public StandardCollateralizedVanillaCreditDefaultSwapDefinition withMaturityDate(final ZonedDateTime maturityDate) {
    return new StandardCollateralizedVanillaCreditDefaultSwapDefinition(getBuySellProtection(), getProtectionBuyer(), getProtectionSeller(),
        ...
        _creditSupportAnnex, _centralCounterparty);
  }
