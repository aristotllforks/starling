...
public class ISDACompliantScheduleGenerator {
   ...
   * @param spreadCurveDates
   *          all the points in the risky curve
   * @return An ascending array of dates that is the unique combination of all the input dates (including startDate and endDate) that are not strictly before
   *         startDate or after EndDate (hence startDate will be the first entry and enddate the last).
   */
  public static LocalDate[] getIntegrationNodesAsDates(final LocalDate startDate, final LocalDate endDate, final LocalDate[] disCurveDates,
      final LocalDate[] spreadCurveDates) {
   ...
   */
  public static double[] getIntegrationNodesAsTimes(final LocalDate today, final LocalDate startDate, final LocalDate endDate, final LocalDate[] disCurveDates,
      final LocalDate[] spreadCurveDates) {
   ...
   * @param endDate
   *          This will be the last value in the list
   * @param dateList
   *          Must be sorted
