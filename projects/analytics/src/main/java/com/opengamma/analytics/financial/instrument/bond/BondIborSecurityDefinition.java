...
public class BondIborSecurityDefinition extends BondSecurityDefinition<PaymentFixedDefinition, CouponIborDefinition>
   ...
   * @param coupon
   *          The bond Ibor coupons. The coupons notional and currency should be in line with the bond nominal.
   * @param exCouponDays
   ...
   *
   * @param nominal
   *          The notional payments, not null. For bullet bond, it is restricted to a single payment.
   * @param coupon
   *          The bond Ibor coupons. The coupons notional and currency should be in line with the bond nominal, not null.
   * @param exCouponDays
   *          Number of days before the payment of the coupon is detached from the bond (and paid to the then owner), not null.
   * @param settlementDays
   *          Standard number of days between trade date and trade settlement, not null. Used for clean price and yield computation.
   * @param calendar
   *          The calendar used to compute the standard settlement date, not null
   * @param dayCount
   *          The coupon day count convention, not null
   * @param issuer
   *          The issuer name.
   */
  public BondIborSecurityDefinition(final AnnuityPaymentFixedDefinition nominal, final AnnuityCouponIborDefinition coupon,
   ...
   * @param indexFixingTS
   *          The index fixing time series, not null
   * @param settlementDate
   *          The settlement date, not null
   * @param yieldCurveNames
   *          The yield curve names, not null, must have at least two entries
   * @return The security
