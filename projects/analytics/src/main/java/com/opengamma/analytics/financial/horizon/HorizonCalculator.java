 ...
 * @param <W>
 *          The type of any additional market data required to calculate the horizon.
 */
public abstract class HorizonCalculator<U extends InstrumentDefinition<?>, V extends ParameterProviderInterface, W> {
   ...
   * @param daysForward
   *          The number of days to roll, must be +/-1
   * @param calendar
   ...
   *          The number of days to roll, must be +/-1
   * @param calendar
   *          The holiday calendar, may be null
   * @param additionalData
   *          Any additional data that are needed for pricing (e.g. fixing series for swaps).
   * @return The theta
   */
