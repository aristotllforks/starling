...
public class LegacyQuantoCreditDefaultSwapDefinition extends LegacyCreditDefaultSwapDefinition {
  ...
  public LegacyQuantoCreditDefaultSwapDefinition(final BuySellProtection buySellProtection, final LegalEntity protectionBuyer,
  ...
  public LegacyQuantoCreditDefaultSwapDefinition withStartDate(final ZonedDateTime startDate) {
    return new LegacyQuantoCreditDefaultSwapDefinition(getBuySellProtection(), getProtectionBuyer(), getProtectionSeller(), getReferenceEntity(), getCurrency(),
        getDebtSeniority(),
