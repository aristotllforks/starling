...
/**
 * Calculates the difference in the present value of a bond total return swap between two dates with rate slide.
 */
public final class BondTrsForwardSlideHorizonCalculator
  ...
  private static final HorizonCalculator<BondTotalReturnSwapDefinition, IssuerProviderInterface, ZonedDateTimeDoubleTimeSeries> INSTANCE = new BondTrsForwardSlideHorizonCalculator();
   ...
   * Private constructor
   */
  private BondTrsForwardSlideHorizonCalculator() {
  }
  ...
  public MultipleCurrencyAmount getTheta(final BondTotalReturnSwapDefinition definition, final ZonedDateTime date,
    ...
    final IssuerProviderInterface dataTomorrow = (IssuerProviderInterface) CurveProviderForwardSlideRolldown.INSTANCE
