...
public abstract class IMMDateLogic {
   ...
   *
   * @param baseIMMDate
   *          The base IMM date (all dates are some interval on from this)
   * @param tenors
   *          The periods (typically this would look like 6M, 1Y, 2Y, 3Y, 5Y, 10Y)
   ...
   *
   * @param startIMMDate
   *          The starting IMM date (this will be the first entry)
   * @param size
   *          number of dates
   * @return set of IMM dates
   */
  ...
  /**
   * IMM dates are 20th March, June, September and December. This returns the next IMM date from the given date - if the date is an IMM date the next IMM date
   * (i.e. 3 months on) is returned.
   *
   * @param date
   *          a given date
  ...
  /**
   * IMM dates are 20th March, June, September and December. This returns the previous IMM date from the given date - if the date is an IMM date the previous
   * IMM date (i.e. 3 months before) is returned.
   *
   * @param date
   *          a given date
   * @return the next IMM date
  ...
  /**
   * Index roll dates are 20th March and September. This returns the next roll date from the given date - if the date is a roll date the next roll date (i.e. 6
   * months on) is returned.
   *
   * @param date
   *          a given date
