 ...
 */
public final class EquityTrsConstantSpreadHorizonCalculator
  ...
  private static final HorizonCalculator<EquityTotalReturnSwapDefinition, MulticurveProviderInterface, ZonedDateTimeDoubleTimeSeries> INSTANCE = new EquityTrsConstantSpreadHorizonCalculator();
   ...
   * Private constructor
   */
  private EquityTrsConstantSpreadHorizonCalculator() {
  }
  ...
  public MultipleCurrencyAmount getTheta(final EquityTotalReturnSwapDefinition definition, final ZonedDateTime date,
    ...
    final MulticurveProviderInterface dataTomorrow = (MulticurveProviderInterface) CurveProviderConstantSpreadRolldown.INSTANCE
