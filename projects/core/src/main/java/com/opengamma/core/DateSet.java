...
public class DateSet implements ImmutableBean {
   ...
   */
  public LocalDate getNextDate(final LocalDate date) {
   ...
   */
  public LocalDate getPreviousDate(final LocalDate date) {
    ArgumentChecker.notNull(date, "date");
    final SortedSet<LocalDate> headSet = _dates.headSet(date);
    if (headSet.isEmpty()) {
      return null;
    }
    return headSet.last();
