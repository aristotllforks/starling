...
public final class HistoricalDataRequest implements ImmutableBean {
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ...
      return JodaBeanUtils.equal(_bundle, other._bundle) &&
          JodaBeanUtils.equal(_field, other._field) &&
          JodaBeanUtils.equal(_from, other._from) &&
          (_fromInclusive == other._fromInclusive) &&
          JodaBeanUtils.equal(_to, other._to) &&
          (_toInclusive == other._toInclusive) &&
          JodaBeanUtils.equal(_resolver, other._resolver);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    hash = hash * 31 + JodaBeanUtils.hashCode(_bundle);
    hash = hash * 31 + JodaBeanUtils.hashCode(_field);
    hash = hash * 31 + JodaBeanUtils.hashCode(_from);
    hash = hash * 31 + JodaBeanUtils.hashCode(_fromInclusive);
    hash = hash * 31 + JodaBeanUtils.hashCode(_to);
    hash = hash * 31 + JodaBeanUtils.hashCode(_toInclusive);
    hash = hash * 31 + JodaBeanUtils.hashCode(_resolver);
    return hash;
  }
  ...
  public String toString() {
    ...
    buf.append("bundle").append('=').append(_bundle).append(',').append(' ');
    buf.append("field").append('=').append(_field).append(',').append(' ');
    buf.append("from").append('=').append(_from).append(',').append(' ');
    buf.append("fromInclusive").append('=').append(_fromInclusive).append(',').append(' ');
    buf.append("to").append('=').append(_to).append(',').append(' ');
    buf.append("toInclusive").append('=').append(_toInclusive).append(',').append(' ');
