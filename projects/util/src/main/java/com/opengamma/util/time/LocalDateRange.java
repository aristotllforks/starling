...
public final class LocalDateRange implements ImmutableBean, Serializable {
  ...
  public static LocalDateRange of(final LocalDate startDateInclusive, final LocalDate endDate, final boolean endDateInclusive) {
    ...
    if (!endDateInclusive && end.isBefore(LocalDate.MAX)) {
      end = end.minusDays(1);
    }
    if (end.isBefore(startDateInclusive)) {
      throw new IllegalArgumentException("Start date must be on or after end date");
    }
    return new LocalDateRange(startDateInclusive, end);
  }
  ...
  public static LocalDateRange ofNullUnbounded(final LocalDate startDateInclusive, final LocalDate endDate, final boolean endDateInclusive) {
    final LocalDate start = startDateInclusive != null ? startDateInclusive : LocalDate.MIN;
    final LocalDate end = endDate != null ? endDate : LocalDate.MAX;
    return of(start, end, endDateInclusive);
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ...
      return JodaBeanUtils.equal(_startDateInclusive, other._startDateInclusive) &&
          JodaBeanUtils.equal(_endDateInclusive, other._endDateInclusive);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    hash = hash * 31 + JodaBeanUtils.hashCode(_startDateInclusive);
    hash = hash * 31 + JodaBeanUtils.hashCode(_endDateInclusive);
    return hash;
  }
   ...
   */
  private static final class Builder extends DirectPrivateBeanBuilder<LocalDateRange> {
