...
/**
 * Tests for {@link RoleEventHistoryResult}.
 */
@Test(groups = TestGroup.UNIT)
public class RoleEventHistoryResultTest {
  ...
  public void testNullEvents1() {
    new RoleEventHistoryResult(null);
  }
  ...
  public void testNullEvents2() {
    new RoleEventHistoryResult().setEvents(null);
  }
  ...
  public void testObject() {
    final RoleEventHistoryResult result = new RoleEventHistoryResult(EVENTS);
    assertEquals(result, result);
    assertNotEquals(null, result);
    assertNotEquals(EVENTS, result);
    assertEquals(result.getEvents(), EVENTS);
    assertEquals(result.toString(), "RoleEventHistoryResult{events=["
    ...
    RoleEventHistoryResult other = new RoleEventHistoryResult();
    other.setEvents(EVENTS);
    assertEquals(result, other);
    assertEquals(result.hashCode(), other.hashCode());
    other = new RoleEventHistoryResult(Collections.<HistoryEvent>emptyList());
