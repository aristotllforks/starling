...
public class ManageableHoliday extends DirectBean implements Holiday, Serializable, MutableUniqueIdentifiable {
   ...
   */
  public ManageableHoliday(final Currency currency, final Collection<LocalDate> holidaySeries) {
   ...
   */
  public ManageableHoliday(final HolidayType holidayType, final ExternalId regionOrExchangeId, final Collection<LocalDate> holidaySeries) {
