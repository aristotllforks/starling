...
public class ConfigDocument extends AbstractDocument {
   ...
   */
  public ConfigDocument(final ConfigItem<?> configItem) {
   ...
   */
  public <T> ConfigDocument(final T value, final Class<T> type, final String name, final UniqueId uid, final Instant versionFrom,
      final Instant versionTo, final Instant correctionFrom, final Instant correctionTo) {
    final ConfigItem<T> item = ConfigItem.of(value);
    item.setName(name);
   ...
   */
  public void setConfig(final ConfigItem<?> object) {
    _config = object;
    if (object != null) {
