...
public abstract class AbstractSearchRequest extends DirectBean implements PagedRequest {
  ...
  public void setVersionCorrection(final VersionCorrection versionCorrection) {
    this._versionCorrection = MoreObjects.firstNonNull(versionCorrection, VersionCorrection.LATEST);
  }
  ...
  public boolean matches(final AbstractDocument document) {
    ...
    final Instant versionFrom = MoreObjects.firstNonNull(document.getVersionFromInstant(), Instant.MIN);
    final Instant versionTo = MoreObjects.firstNonNull(document.getVersionToInstant(), Instant.MAX);
    final Instant correctionFrom = MoreObjects.firstNonNull(document.getCorrectionFromInstant(), Instant.MIN);
    final Instant correctionTo = MoreObjects.firstNonNull(document.getCorrectionToInstant(), Instant.MAX);
