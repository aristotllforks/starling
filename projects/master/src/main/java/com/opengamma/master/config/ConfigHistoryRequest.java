 ...
 * <p>
 * A full configuration master implements historical storage of data. History
 * can be stored in two dimensions and this request provides searching.
 * <p>
 ...
 * realized that the original data stored was incorrect. A simple configuration
 ...
 * <p>
 * For example, a piece of configuration added on Monday and updated on Thursday
...
public class ConfigHistoryRequest<T> extends AbstractHistoryRequest {
   ...
   */
  public ConfigHistoryRequest(final ObjectIdentifiable objectId, final Class<T> type) {
    super(objectId);
   ...
   */
  public ConfigHistoryRequest(final ObjectIdentifiable objectId, final Instant versionInstant, final Instant correctedToInstant) {
