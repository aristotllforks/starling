...
public class CapFloorCMSSpreadSecurity extends FinancialSecurity {
   ...
   *          the identifier of the long underlying (i.e. the long reference rate), not null
   * @param shortIdentifier
   *          the identifier of the short underlying (i.e. the short reference rate), not null
   * @param strike
   *          the strike
   * @param frequency
   ...
   * @param payer
   *          true if the security is a payer
   * @param cap
   *          true if the spread is capped
   */
  public CapFloorCMSSpreadSecurity(final ZonedDateTime startDate, final ZonedDateTime maturityDate, final double notional, final ExternalId longIdentifier,
      final ExternalId shortIdentifier, final double strike, final Frequency frequency, final Currency currency, final DayCount dayCount, final boolean payer,
      final boolean cap) {
    super(SECURITY_TYPE);
