...
/**
 * Tests for {@link GovernmentBondSecurity}.
 */
@Test(groups = TestGroup.UNIT)
public class GovernmentBondSecurityTest extends AbstractBeanTestCase {
  private static final String ISSUER_NAME = "UKGO";
  private static final String ISSUER_TYPE = "Government";
  private static final String ISSUER_DOMICILE = "UK";
  private static final String MARKET = "Gilts";
  private static final Currency CURRENCY = Currency.GBP;
  private static final YieldConvention YIELD = SimpleYieldConvention.UK_BUMP_DMO_METHOD;
  ...
  private static final double COUPON_RATE = 0.02;
  ...
  @Override
  public JodaBeanProperties<GovernmentBondSecurity> getJodaBeanProperties() {
    return new JodaBeanProperties<>(GovernmentBondSecurity.class,
  ...
  public void testVisitor() {
    final GovernmentBondSecurity security = new GovernmentBondSecurity(ISSUER_NAME, ISSUER_TYPE, ISSUER_DOMICILE, MARKET, CURRENCY, YIELD, LAST_TRADE_DATE,
