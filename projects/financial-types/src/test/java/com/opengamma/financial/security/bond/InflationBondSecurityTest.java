...
/**
 * Tests for {@link InflationBondSecurity}.
 */
@Test(groups = TestGroup.UNIT)
public class InflationBondSecurityTest extends AbstractBeanTestCase {
  ...
  private static final String MARKET = "Inflation";
  ...
  @Override
  public JodaBeanProperties<InflationBondSecurity> getJodaBeanProperties() {
    return new JodaBeanProperties<>(InflationBondSecurity.class,
  ...
  public void testVisitor() {
    final InflationBondSecurity security = new InflationBondSecurity(ISSUER_NAME, ISSUER_TYPE, ISSUER_DOMICILE, MARKET, CURRENCY, YIELD, LAST_TRADE_DATE,
