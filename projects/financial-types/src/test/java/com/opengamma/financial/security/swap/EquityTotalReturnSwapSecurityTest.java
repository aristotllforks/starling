...
/**
 * Tests for {@link EquityTotalReturnSwapSecurity}.
 */
@Test(groups = TestGroup.UNIT)
public class EquityTotalReturnSwapSecurityTest extends AbstractBeanTestCase {
  private static final double NUMBER_OF_SHARES = 10000000;
  private static final Currency CCY = Currency.AUD;
  private static final double NOTIONAL = 100000;
  private static final double DIVIDEND_PERCENTAGE = 0.76;
  ...
  public void testConstructor() {
    EquityTotalReturnSwapSecurity security = new EquityTotalReturnSwapSecurity();
  ...
  private static final class TestVisitor extends FinancialSecurityVisitorAdapter<Double> {
    ...
    @Override
    public Double visitEquityTotalReturnSwapSecurity(final EquityTotalReturnSwapSecurity security) {
      return security.getNumberOfShares();
    }
  }
}
