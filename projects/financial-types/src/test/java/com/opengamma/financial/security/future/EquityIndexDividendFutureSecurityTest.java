...
/**
 * Tests for {@link EquityIndexDividendFutureSecurity}.
 */
@Test(groups = TestGroup.UNIT)
public class EquityIndexDividendFutureSecurityTest extends AbstractBeanTestCase {
  ...
  public JodaBeanProperties<? extends Bean> getJodaBeanProperties() {
    return new JodaBeanProperties<>(EquityIndexDividendFutureSecurity.class,
