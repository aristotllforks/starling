...
/**
 * Tests for {@link CorporateBondSecurity}.
 */
@Test(groups = TestGroup.UNIT)
public class CorporateBondSecurityTest extends AbstractBeanTestCase {
  private static final String ISSUER_NAME = "ABC";
  private static final String ISSUER_TYPE = "Corporate";
  private static final String ISSUER_DOMICILE = "UK";
  private static final String MARKET = "Corp";
  ...
  @Override
  public JodaBeanProperties<CorporateBondSecurity> getJodaBeanProperties() {
    return new JodaBeanProperties<>(CorporateBondSecurity.class,
  ...
  public void testVisitor() {
    final CorporateBondSecurity security = new CorporateBondSecurity(ISSUER_NAME, ISSUER_TYPE, ISSUER_DOMICILE, MARKET, CURRENCY, YIELD, LAST_TRADE_DATE,
