...
public class EquityIndexOptionLoader extends SecurityLoader {
  ...
  /** Logger. */
  private static final Logger LOGGER = LoggerFactory.getLogger(EquityIndexOptionLoader.class);
  /**
   ...
   */
  public EquityIndexOptionLoader(final ReferenceDataProvider referenceDataProvider) {
    super(LOGGER, referenceDataProvider, SecurityType.EQUITY_INDEX_OPTION);
  }
