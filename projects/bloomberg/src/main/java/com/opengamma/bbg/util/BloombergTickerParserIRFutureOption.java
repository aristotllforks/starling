...
/**
 * <p>
 * Parser for Bloomberg IR option tickers. The rationale for having this parsing is to be able to extract instrument indicatives from a Bloomberg ticker string
 * or {@link com.opengamma.id.ExternalId}, without looking up the instrument via Bloomberg security field loading. This allows the caller to avoid expending
 * Bloomberg security field lookup quota.
 * </p>
