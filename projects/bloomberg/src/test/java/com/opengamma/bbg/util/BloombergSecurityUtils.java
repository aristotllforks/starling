...
public final class BloombergSecurityUtils {
  ...
  public static EquityFutureSecurity makeEquityFuture() {
    final Expiry expiry = new Expiry(ZonedDateTime.of(LocalDateTime.of(2010, Month.JUNE, 17, 21, 15),
        ZoneOffset.UTC), ExpiryAccuracy.MIN_HOUR_DAY_MONTH_YEAR);
    final EquityFutureSecurity sec = new EquityFutureSecurity(expiry, "XCME", "XCME", USD, 250,
  ...
  public static AgricultureFutureSecurity makeAgricultureFuture() {
    final Expiry expiry = new Expiry(ZonedDateTime.of(LocalDateTime.of(2010, Month.JUNE, 23, 21, 30),
        ZoneOffset.UTC), ExpiryAccuracy.MIN_HOUR_DAY_MONTH_YEAR);
    final AgricultureFutureSecurity sec = new AgricultureFutureSecurity(expiry, "XMTB", "XMTB", USD, 100, "Wheat");
  ...
  public static FXFutureSecurity makeAUDUSDCurrencyFuture() {
    final Expiry expiry = new Expiry(ZonedDateTime.of(LocalDate.of(2010, Month.JUNE, 1).atTime(LocalTime.MIDNIGHT), ZoneOffset.UTC),
        ExpiryAccuracy.DAY_MONTH_YEAR);
    final FXFutureSecurity security = new FXFutureSecurity(expiry, "XCME", "XCME", USD, 1000, AUD, USD, "FX");
  ...
  public static MetalFutureSecurity makeSilverFuture() {
    final Expiry expiry = new Expiry(ZonedDateTime.of(LocalDateTime.of(2010, Month.JUNE, 28, 18, 25),
        ZoneOffset.UTC), ExpiryAccuracy.MIN_HOUR_DAY_MONTH_YEAR);
    final MetalFutureSecurity sec = new MetalFutureSecurity(expiry, "XCEC", "XCEC", USD, 5000, "Precious Metal");
  ...
  public static EnergyFutureSecurity makeEthanolFuture() {
    final Expiry expiry = new Expiry(ZonedDateTime.of(LocalDateTime.of(2010, Month.JUNE, 3, 19, 15),
        ZoneOffset.UTC), ExpiryAccuracy.MIN_HOUR_DAY_MONTH_YEAR);
    final EnergyFutureSecurity sec = new EnergyFutureSecurity(expiry, "XCBT", "XCBT", USD, 29000, "Refined Products");
  ...
  public static EquitySecurity makeExpectedATTEquitySecurity() {
    final EquitySecurity equitySecurity = new EquitySecurity("NEW YORK STOCK EXCHANGE, INC.", "XNYS", "AT&T INC", USD);
  ...
  public static EquityIndexFutureOptionSecurity makeEquityIndexFutureOptionSecurity() {
    ...
    final OptionType optionType = OptionType.CALL;
    final double strike = 1000.0;
    final Expiry expiry = new Expiry(DateUtils.getUTCDate(2013, 3, 15));
    final ExternalId underlyingUniqueID = ExternalSchemes.bloombergBuidSecurityId("IX14248603-0");
  ...
  public static EquityIndexDividendFutureOptionSecurity makeEquityIndexDividendFutureOptionSecurity() {
    ...
    final Expiry expiry = new Expiry(DateUtils.getUTCDate(2013, 12, 20));
    final ExternalId underlyingUniqueID = ExternalSchemes.bloombergBuidSecurityId("IX6817069-0");
  ...
  public static EquitySecurity makeExpectedAAPLEquitySecurity() {
    final EquitySecurity equitySecurity = new EquitySecurity("NASDAQ/NGS (GLOBAL SELECT MARKET)", "XNGS", "APPLE INC", USD);
  ...
  public static EquitySecurity makeExchangeTradedFund() {
    final EquitySecurity equitySecurity = new EquitySecurity("NYSE ARCA", "ARCX", "US NATURAL GAS FUND LP", USD);
  ...
  public static Security makeAmericanGeneralEquity() {
    final EquitySecurity equitySecurity = new EquitySecurity("LONDON STOCK EXCHANGE", "XLON", "AMERICAN GENERAL CORP", GBP);
  ...
  public static Security makeTHYSSENKRUPPEquity() {
    final EquitySecurity equitySecurity = new EquitySecurity("LONDON STOCK EXCHANGE", "XLON", "THYSSENKRUPP AEROSPACE UK LT",
        GBP);
  ...
  public static Security makePTSEquity() {
    final EquitySecurity equitySecurity = new EquitySecurity("LONDON STOCK EXCHANGE", "XLON", "PTS GROUP PLC", GBP);
  ...
  public static ExternalIdBundle makeBloombergTickerIdentifier(final String secDes) {
    return ExternalIdBundle.of(ExternalSchemes.bloombergTickerSecurityId(secDes));
  }

  public static ExternalIdBundle makeBloombergBuid(final String secDes) {
  ...
  public static IRFutureOptionSecurity makeEURODOLLARFutureOptionSecurity() {
    final OptionType optionType = OptionType.CALL;
    final double strike = 0.995;
    final double pointValue = 2500;
  ...
  public static IRFutureOptionSecurity makeLIBORFutureOptionSecurity() {
    final OptionType optionType = OptionType.CALL;
    final double strike = 0.91;
    final double pointValue = 1250.0;
  ...
  public static IRFutureOptionSecurity makeEURIBORFutureOptionSecurity() {
    final OptionType optionType = OptionType.CALL;
    final double strike = 0.92875;
    final double pointValue = 2500;
    final Expiry expiry = new Expiry(DateUtils.getUTCDate(2011, 9, 19));
    final ExternalId underlyingID = ExternalSchemes.bloombergTickerSecurityId("FPU11 Comdty");
  ...
  public static CommodityFutureOptionSecurity makeCommodityFutureOptionSecurity() {
    ...
    final OptionType optionType = OptionType.CALL;
    final double strike = 0.2425;
    final double pointValue = 1000;
    final Expiry expiry = new Expiry(DateUtils.getUTCDate(2013, 2, 19));
    final ExternalId underlyingID = ExternalSchemes.bloombergTickerSecurityId("CHH3 Comdty");
  ...
  public static FxFutureOptionSecurity makeFxFutureOptionSecurity() {
    ...
    final double pointValue = 1250;
    final Expiry expiry = new Expiry(DateUtils.getUTCDate(2013, 3, 8));
    final ExternalId underlyingID = ExternalSchemes.bloombergTickerSecurityId("JYH3 Curncy");
    final String exchange = "CME";
