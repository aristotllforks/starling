...
/**
 * An object representing a FX spot trade as defined in FpML consisting of a single FX leg settling on the spot date.
 * These trades are converted to {@link FXForwardSecurity} before pricing the portfolio.
 */
@BeanDefinition
public class FxSpotTrade implements ImmutableBean, Trade {
  ...
  /**
   * The trade header containing information about the parties in the trade and the trade date.
   */
  @PropertyDefinition(validate = "notNull")
  ...
  public Position toPosition() {
    ...
    final BigDecimal payAmount, receiveAmount;
    ...
    if (exchangedCurrency1.getPayerPartyReference() != null) {
      ...
      receiveAmount = exchangedCurrency1.getPaymentAmount().getAmount();
      payCurrency = exchangedCurrency2.getPaymentAmount().getCurrency();
      payAmount = exchangedCurrency2.getPaymentAmount().getAmount();
    } else {
      receiveCurrency = exchangedCurrency2.getPaymentAmount().getCurrency();
      receiveAmount = exchangedCurrency2.getPaymentAmount().getAmount();
      payCurrency = exchangedCurrency1.getPaymentAmount().getCurrency();
      payAmount = exchangedCurrency1.getPaymentAmount().getAmount();
    }
    //TODO think about the zone
    final ZonedDateTime forwardDate = _fxSingleLeg.getValueDate().atStartOfDay(ZoneId.systemDefault());
    final FXForwardSecurity security = new FXForwardSecurity(payCurrency, payAmount.doubleValue(),
        receiveCurrency, receiveAmount.doubleValue(), forwardDate, DEFAULT_REGION);
...
//    final Collection<com.opengamma.core.position.Trade> trades = position.getTrades();
//    ArgumentChecker.isTrue(trades.size() == 1, "Position must have one trade; have {}" + trades);
//    final com.opengamma.core.position.Trade trade = trades.iterator().next();
//    final ExternalId correlationId = ExternalId.parse(position.getAttributes().get(ManageableTrade.meta().providerId().name()));
//    final SimpleDeal deal = SimpleDeal.parse(trade.getAttributes().get(ManageableTrade.meta().deal().name()));
//    final TradeHeader tradeHeader = TradeHeader.builder()
//        .party1(party1)
//        .build();
//    return FxSpotTrade.builder()
...
//        .build();
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code FxSpotTrade}.
   * @return the meta-bean, not null
   */
  public static FxSpotTrade.Meta meta() {
    return FxSpotTrade.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(FxSpotTrade.Meta.INSTANCE);
  }
   ...
   */
  public static FxSpotTrade.Builder builder() {
    return new FxSpotTrade.Builder();
  }
   ...
   */
  protected FxSpotTrade(final FxSpotTrade.Builder builder) {
  ...
  @Override
  public FxSpotTrade.Meta metaBean() {
    return FxSpotTrade.Meta.INSTANCE;
  }
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the creation time stamp of this trade.
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the trade header containing information about the parties in the trade and the trade date.
   * @return the value of the property, not null
   */
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the FX leg containing details of the payments.
   * @return the value of the property, not null
   */
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the identifier of the first party in the trade.
   * @return the value of the property, not null
   */
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the identifier of the second party in the trade, does not need to be set.
  ...
  public boolean equals(final Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      final FxSpotTrade other = (FxSpotTrade) obj;
  ...
  public static class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<ZonedDateTime> _creationTimestamp = DirectMetaProperty.ofImmutable(
        this, "creationTimestamp", FxSpotTrade.class, ZonedDateTime.class);
    /**
    ...
    private final MetaProperty<ExternalId> _correlationId = DirectMetaProperty.ofImmutable(
        this, "correlationId", FxSpotTrade.class, ExternalId.class);
    /**
    ...
    private final MetaProperty<TradeHeader> _tradeHeader = DirectMetaProperty.ofImmutable(
        this, "tradeHeader", FxSpotTrade.class, TradeHeader.class);
    /**
    ...
    private final MetaProperty<FxSingleLeg> _fxSingleLeg = DirectMetaProperty.ofImmutable(
        this, "fxSingleLeg", FxSpotTrade.class, FxSingleLeg.class);
    /**
    ...
    private final MetaProperty<ExternalId> _party1Id = DirectMetaProperty.ofImmutable(
        this, "party1Id", FxSpotTrade.class, ExternalId.class);
    /**
    ...
    private final MetaProperty<ExternalId> _party2Id = DirectMetaProperty.ofImmutable(
        this, "party2Id", FxSpotTrade.class, ExternalId.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public FxSpotTrade.Builder builder() {
      return new FxSpotTrade.Builder();
    }

    @Override
    public Class<? extends FxSpotTrade> beanType() {
      return FxSpotTrade.class;
    }
    ...
    protected Object propertyGet(final Bean bean, final String propertyName, final boolean quiet) {
      switch (propertyName.hashCode()) {
        case -370203401:  // creationTimestamp
          return ((FxSpotTrade) bean).getCreationTimestamp();
        case -764983747:  // correlationId
          return ((FxSpotTrade) bean).getCorrelationId();
        case 1638409489:  // tradeHeader
          return ((FxSpotTrade) bean).getTradeHeader();
        case -202817548:  // fxSingleLeg
          return ((FxSpotTrade) bean).getFxSingleLeg();
        case 1189278854:  // party1Id
          return ((FxSpotTrade) bean).getParty1Id();
        case 1189279815:  // party2Id
          return ((FxSpotTrade) bean).getParty2Id();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code FxSpotTrade}.
   */
  public static class Builder extends DirectFieldsBeanBuilder<FxSpotTrade> {
     ...
     */
    protected Builder(final FxSpotTrade beanToCopy) {
    ...
    @Override
    public FxSpotTrade build() {
      return new FxSpotTrade(this);
    }

    //-----------------------------------------------------------------------
    /**
     * Sets the creation time stamp of this trade.
    ...
    /**
     * Sets the trade header containing information about the parties in the trade and the trade date.
    ...
    /**
     * Sets the FX leg containing details of the payments.
    ...
    /**
     * Sets the identifier of the first party in the trade.
    ...
    /**
     * Sets the identifier of the second party in the trade, does not need to be set.
    ...
    public String toString() {
      final StringBuilder buf = new StringBuilder(224);
      buf.append("FxSpotTrade.Builder{");
      final int len = buf.length();
      toString(buf);
      if (buf.length() > len) {
        buf.setLength(buf.length() - 2);
