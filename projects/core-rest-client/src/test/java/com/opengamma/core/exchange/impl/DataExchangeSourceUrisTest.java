...
/**
 * Tests for {@link DataExchangeSourceUris}.
 */
@Test(groups = TestGroup.UNIT)
public class DataExchangeSourceUrisTest {
  ...
  public void testUriGetNullUri1() {
    DataExchangeSourceUris.uriGet(null, OID, VC);
  }
  ...
  public void testUriGetNullObjectId() {
    DataExchangeSourceUris.uriGet(_baseUri, null, VC);
  }
  ...
  public void testBuildUriOidLatest() {
    ...
    assertEquals(uri.getPath(), "path/to/exchanges/conv~1");
  ...
  public void testBuildUriOidVersion() {
    final URI uri = DataExchangeSourceUris.uriGet(_baseUri, OID, VC);
    assertEquals(uri.getPath(), "path/to/exchanges/conv~1");
  ...
  public void testUriGetNullUri2() {
    DataExchangeSourceUris.uriGet(null, UID_1);
  }
  ...
  public void testUriGetNullUid() {
    DataExchangeSourceUris.uriGet(_baseUri, null);
  }
  ...
  public void testBuildUriUid() {
    final URI uri = DataExchangeSourceUris.uriGet(_baseUri, UID_1);
    assertEquals(uri.getPath(), "path/to/exchanges/conv~1");
    assertNull(uri.getQuery());
  }
  ...
  public void testBuildUriUidWithVersion() {
    ...
    final URI uri = DataExchangeSourceUris.uriGet(_baseUri, uid);
    assertEquals(uri.getPath(), "path/to/exchanges/conv~1");
  ...
  public void testUriSearchNullUri() {
    DataExchangeSourceUris.uriSearch(null, VC, EIDS);
  }
  ...
  public void testUriSearchNullBundle() {
    DataExchangeSourceUris.uriSearch(_baseUri, VC, null);
  }
  ...
  public void testSearchLatest() {
    ...
    assertEquals(uri.getPath(), "path/to/exchanges");
  ...
  public void testSearch() {
    final URI uri = DataExchangeSourceUris.uriSearch(_baseUri, VC, EIDS);
    assertEquals(uri.getPath(), "path/to/exchanges");
  ...
  public void testUriSearchSingleNullBundle1() {
    DataExchangeSourceUris.uriSearchSingle(_baseUri, null);
  }
  ...
  public void testSearchSingle() {
    final URI uri = DataExchangeSourceUris.uriSearchSingle(_baseUri, EIDS);
    assertEquals(uri.getPath(), "path/to/exchangeSearches/single");
    assertEquals(uri.getQuery(), "id=eid~1&id=eid~2");
  }
}