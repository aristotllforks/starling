...
/**
 * A historical time series resolver for Quandl data that allows multiple mappings from Quandl data fields to a single OpenGamma field (e.g.
 * {@link com.opengamma.core.value.MarketDataRequirementNames#MARKET_VALUE} to ({@link com.mcleodmoores.quandl.QuandlConstants#RATE_FIELD_NAME},
 * {@link com.mcleodmoores.quandl.QuandlConstants#VALUE_FIELD_NAME} and {@link com.mcleodmoores.quandl.QuandlConstants#LAST_FIELD_NAME}).
 */
public class QuandlFieldMappingHistoricalTimeSeriesResolver extends DefaultHistoricalTimeSeriesResolver {
   ...
   * 
   * @param fieldMaps
   *          the field adjustment maps, not null
   * @param selector
