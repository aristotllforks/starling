...
public interface MarketDataSnapshot extends UniqueIdentifiable {
  ...
  /**
   * Gets an indication of the time which will be associated with the snapshot once it has been initialised. This might be used to build a
   * dependency graph which will probably be valid for the snapshotted data.
   * <p>
