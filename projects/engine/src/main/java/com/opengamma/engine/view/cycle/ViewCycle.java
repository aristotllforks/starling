...
public interface ViewCycle extends UniqueIdentifiable {
   ...
   * <p>
   * For efficiency, the result object contains only terminal outputs, i.e. values explicitly requested in the view definition at the
   * time of the computation. A computation cycle may be queried in order to obtain any values which were calculated during the cycle,
   * including intermediate values corresponding to inputs as well as terminal output values already present in the result object.
   *
   ...
   * <p>
   * For efficiency, the result object contains only terminal outputs, i.e. values explicitly requested in the view definition at the
   * time of the computation. A computation cycle may be queried in order to obtain any results which were calculated during the cycle,
   * including intermediate results corresponding to inputs as well as terminal outputs already present in the result object.
   *
   * @param query the query, not null
