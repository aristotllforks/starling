 ...
 * <p>
 * This behavior is separated as a strategy from the {@code FunctionRepository} to allow different implementations. For example, functions may be
 * matched on given different criteria, such as speed.
 */
@PublicAPI
