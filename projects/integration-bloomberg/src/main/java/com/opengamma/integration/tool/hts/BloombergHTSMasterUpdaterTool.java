...
public class BloombergHTSMasterUpdaterTool extends AbstractTool<IntegrationToolContext> {
  ...
  public static void main(final String[] args) { // CSIGNORE
    ...
    try {
      ...
      final boolean success = new BloombergHTSMasterUpdaterTool().initAndRun(args, IntegrationToolContext.class);
  ...
  protected void doRun() throws Exception {
    ...
    final ReferenceDataProvider bloombergReferenceDataProvider = getToolContext().getBloombergReferenceDataProvider();
  ...
  private static void configureOptions(final CommandLine line, final BloombergHTSMasterUpdater dataLoader) {
