...
/**
 * Provides access to configuration methods on {@link AbstractDbMaster} (and potentially other implementations). This makes it possible to initialize in a
 * standard way. See AbstractDbMasterComponentFactory (og-component) for further details.
 */
public interface ConfigurableDbMaster {
   ...
   */
  void setUniqueIdScheme(String scheme);
