...
public abstract class AbstractDbHistoricalTimeSeriesMasterWorkerTest extends AbstractDbTest {
  ...
  public AbstractDbHistoricalTimeSeriesMasterWorkerTest(final String databaseType, final String databaseVersion) {
  ...
  protected void assert101(final HistoricalTimeSeriesInfoDocument test) {
    ...
    final ManageableHistoricalTimeSeriesInfo info = test.getInfo();
    assertNotNull(info);
    ...
    final ExternalIdBundleWithDates key = info.getExternalIdBundle();
    assertNotNull(key);
