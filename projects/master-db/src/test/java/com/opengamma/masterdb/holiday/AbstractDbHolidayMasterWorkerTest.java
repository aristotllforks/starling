...
public abstract class AbstractDbHolidayMasterWorkerTest extends AbstractDbTest {
  ...
  private void init() {
    ...
    template.update("INSERT INTO hol_holiday VALUES (?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?,?,?)",
        ...
        "TestHoliday101", "COPP_CLARK", "1", "CURRENCY", null, null, null, null, null, null, "GBP", "SATURDAY_SUNDAY");
    template.update("INSERT INTO hol_holiday VALUES (?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?,?,?)",
        102, 102, toSqlTimestamp(_version1Instant), MAX_SQL_TIMESTAMP, toSqlTimestamp(_version1Instant), MAX_SQL_TIMESTAMP,
        "TestHoliday102", "COPP_CLARK", "2", "CURRENCY", null, null, null, null, null, null, "EUR", "SATURDAY_SUNDAY");
    template.update("INSERT INTO hol_holiday VALUES (?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?,?,?)",
        ...
        "TestHoliday201", "COPP_CLARK", "3", "CURRENCY", null, null, null, null, null, null, "GBP", "SATURDAY_SUNDAY");
    template.update("INSERT INTO hol_holiday VALUES (?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?,?,?)",
        202, 201, toSqlTimestamp(_version2Instant), MAX_SQL_TIMESTAMP, toSqlTimestamp(_version2Instant), MAX_SQL_TIMESTAMP,
        "TestHoliday202", "COPP_CLARK", "3", "CURRENCY", null, null, null, null, null, null, "GBP", "SATURDAY_SUNDAY");
    _totalHolidays = 3;
