...
public class ModifyExchangeDbExchangeMasterWorkerUpdateTest extends AbstractDbExchangeMasterWorkerTest {
  ...
  public ModifyExchangeDbExchangeMasterWorkerUpdateTest(final String databaseType, final String databaseVersion) {
  ...
  public void test_update_getUpdateGet() {
    ...
    final ExchangeDocument updated = _exgMaster.update(input);
    ...
    final ExchangeDocument old = _exgMaster.get(uniqueId);
    ...
    final ExchangeHistoryRequest search = new ExchangeHistoryRequest(base.getUniqueId(), null, now);
  ...
  public void test_update_rollback() {
    final DbExchangeMaster w = new DbExchangeMaster(_exgMaster.getDbConnector());
