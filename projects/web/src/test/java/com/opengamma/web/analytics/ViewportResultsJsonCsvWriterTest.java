...
public class ViewportResultsJsonCsvWriterTest {
  ...
  private static GridColumnGroups createColumns(final Class<?> type) {
    final GridColumn.CellRenderer renderer = new TestCellRenderer();
    final GridColumn column = new GridColumn("header", "desc", type, renderer);
    return new GridColumnGroups(new GridColumnGroup("grp", ImmutableList.of(column), false));
  }

  private List<ResultsCell> createResults(final Object value, final List<Object> history, final Class<?> columnType) {
  ...
  public void valueWithNoHistory() throws JSONException {
    final List<ResultsCell> results = createResults("val", null, String.class);
    final ViewportResults viewportResults = new ViewportResults(results, _viewportDefinition, createColumns(String.class), DURATION, CALC_TIME);
  ...
  public void valueWithHistory() throws JSONException {
    final List<ResultsCell> results = createResults(3d, ImmutableList.<Object>of(1d, 2d, 3d), Double.class);
    final ViewportResults viewportResults = new ViewportResults(results, _viewportDefinition, createColumns(Double.class), DURATION, CALC_TIME);
    final String json = _writer.getJson(viewportResults);
  ...
  public void valueWithUnknownType() throws JSONException {
    final List<ResultsCell> results = createResults(3d, null, null);
    final ViewportResults viewportResults = new ViewportResults(results, _viewportDefinition, createColumns(null), DURATION, CALC_TIME);
    final String json = _writer.getJson(viewportResults);
  ...
  public void nullValueWithUnknownType() throws JSONException {
    final List<ResultsCell> results = createResults(null, null, null);
    final ViewportResults viewportResults = new ViewportResults(results, _viewportDefinition, createColumns(null), DURATION, CALC_TIME);
    final String json = _writer.getJson(viewportResults);
  ...
  public void valueWithUnknownTypeAndHistory() throws JSONException {
    final List<ResultsCell> results = createResults(3d, ImmutableList.<Object>of(1d, 2d, 3d), null);
    final ViewportResults viewportResults = new ViewportResults(results, _viewportDefinition, createColumns(null), DURATION, CALC_TIME);
    final String json = _writer.getJson(viewportResults);
  ...
  public void errorValueNoHistory() throws JSONException {
    final List<ResultsCell> results = createResults(MissingOutput.EVALUATION_ERROR, null, String.class);
    final ViewportResults viewportResults = new ViewportResults(results, _viewportDefinition, createColumns(String.class), DURATION, CALC_TIME);
    final String json = _writer.getJson(viewportResults);
  ...
  public void errorValueWithHistory() throws JSONException {
    final ImmutableList<Object> history = ImmutableList.<Object>of(1d, 2d, MissingOutput.EVALUATION_ERROR);
    final List<ResultsCell> results = createResults(MissingOutput.EVALUATION_ERROR, history, Double.class);
    final ViewportResults viewportResults = new ViewportResults(results, _viewportDefinition, createColumns(Double.class), DURATION, CALC_TIME);
    final String json = _writer.getJson(viewportResults);
  ...
  public void errorValueInHistory() throws JSONException {
    final ImmutableList<Object> history = ImmutableList.<Object>of(1d, MissingOutput.EVALUATION_ERROR, 3d);
    final List<ResultsCell> results = createResults(3d, history, Double.class);
    final ViewportResults viewportResults = new ViewportResults(results, _viewportDefinition, createColumns(Double.class), DURATION, CALC_TIME);
    final String json = _writer.getJson(viewportResults);
