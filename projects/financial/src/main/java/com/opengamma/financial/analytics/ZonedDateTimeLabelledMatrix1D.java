...
public class ZonedDateTimeLabelledMatrix1D extends LabelledMatrix1D<ZonedDateTime, Period> {
  ...
  public ZonedDateTimeLabelledMatrix1D(final ZonedDateTime[] keys, final Object[] labels, final String labelsTitle, final double[] values,
  ...
  @Override
  public LabelledMatrix1D<ZonedDateTime, Period> getMatrix(final ZonedDateTime[] keys, final Object[] labels, final String labelsTitle, final double[] values,
      final String valuesTitle) {
