...
public class FactorExposureDataComparator implements Comparator<FactorExposureData> {
  ...
  @Override
  public int compare(final FactorExposureData arg0, final FactorExposureData arg1) {
    ...
    if (arg0.getNode() != null && arg0.getNode().length() > 0) {
      final Duration p0 = Duration.parse("P" + arg0.getNode());
      if (arg1.getNode() != null && arg1.getNode().length() > 0) {
        final Duration p1 = Duration.parse("P" + arg1.getNode());
