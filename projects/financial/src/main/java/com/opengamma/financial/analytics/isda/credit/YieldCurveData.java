...
public final class YieldCurveData implements ImmutableBean {
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ...
      return JodaBeanUtils.equal(_currency, other._currency) &&
          JodaBeanUtils.equal(_curveDayCount, other._curveDayCount) &&
          JodaBeanUtils.equal(_curveBusinessDayConvention, other._curveBusinessDayConvention) &&
          JodaBeanUtils.equal(_cashDayCount, other._cashDayCount) &&
          JodaBeanUtils.equal(_swapDayCount, other._swapDayCount) &&
          JodaBeanUtils.equal(_spotDate, other._spotDate) &&
          JodaBeanUtils.equal(_calendar, other._calendar) &&
          JodaBeanUtils.equal(_swapFixedLegInterval, other._swapFixedLegInterval) &&
          JodaBeanUtils.equal(_cashData, other._cashData) &&
          JodaBeanUtils.equal(_swapData, other._swapData);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    hash = hash * 31 + JodaBeanUtils.hashCode(_curveDayCount);
    hash = hash * 31 + JodaBeanUtils.hashCode(_curveBusinessDayConvention);
    hash = hash * 31 + JodaBeanUtils.hashCode(_cashDayCount);
    hash = hash * 31 + JodaBeanUtils.hashCode(_swapDayCount);
    hash = hash * 31 + JodaBeanUtils.hashCode(_spotDate);
    hash = hash * 31 + JodaBeanUtils.hashCode(_calendar);
    hash = hash * 31 + JodaBeanUtils.hashCode(_swapFixedLegInterval);
    hash = hash * 31 + JodaBeanUtils.hashCode(_cashData);
    hash = hash * 31 + JodaBeanUtils.hashCode(_swapData);
    return hash;
  }
  ...
  public String toString() {
    ...
    buf.append("curveDayCount").append('=').append(_curveDayCount).append(',').append(' ');
    buf.append("curveBusinessDayConvention").append('=').append(_curveBusinessDayConvention).append(',').append(' ');
    buf.append("cashDayCount").append('=').append(_cashDayCount).append(',').append(' ');
    buf.append("swapDayCount").append('=').append(_swapDayCount).append(',').append(' ');
    buf.append("spotDate").append('=').append(_spotDate).append(',').append(' ');
    buf.append("calendar").append('=').append(_calendar).append(',').append(' ');
    buf.append("swapFixedLegInterval").append('=').append(_swapFixedLegInterval).append(',').append(' ');
    buf.append("cashData").append('=').append(_cashData).append(',').append(' ');
