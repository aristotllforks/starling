...
/**
 * A {@code TemporalAdjuster} that moves the date to the next Quarter within a cycle of four.
 * <p>
...
public class NextQuarterAdjuster implements TemporalAdjuster {
  ...
  /**
   * @param futureQuarters
   *          a set of {@link Month}'s, eg EnumSet.of(Month.FEBRUARY, Month.MAY, Month.AUGUST, Month.NOVEMBER)
   */
  ...
  /**
   * @param month
   *          a Month from which a set of 4 will be created, each 3 months apart
   */
