...
public class CashFlowDetailsProvider implements ImmutableBean {
   ...
   * Creates an instance.
   *
   * @param multicurveProviderInterface
   *          the MulticurveProviderInterface
   * @param zonedDateTime
   *          the ZonedDateTime
   * @param definition
   *          the SwapDefinition containing the payment definitions
   * @param security
   *          the InterestRateSwapSecurity
   * @param type
   *          the PayReceiveType, either pay or receive
   */
