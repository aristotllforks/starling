...
public final class LiveCattleFutureOptionExpiryCalculator implements ExchangeTradedInstrumentExpiryCalculator {
  ...
  private static final Month[] CATTLE_OPTION_EXPIRY_MONTHS = { Month.FEBRUARY, Month.APRIL, Month.JUNE, Month.AUGUST, Month.OCTOBER, Month.DECEMBER };
  ...
  // -------------------------------------------------------------------------
  /**
   * Expiry date of Soybean Future Options: The first Friday of the month. See
  ...
  private LocalDate getNextExpiryMonth(final LocalDate dtCurrent) {
    ...
    final int idx = Arrays.binarySearch(CATTLE_OPTION_EXPIRY_MONTHS, mthCurrent);
