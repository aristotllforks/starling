...
/**
 * {@code DatAdjuster} that finds the next Expiry in Equity Futures Options. This is the Saturday immediately following the 3rd Friday of the next IMM Future
 * Expiry Month.
 */
