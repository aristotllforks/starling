...
public final class LiveCattleFutureExpiryCalculator implements ExchangeTradedInstrumentExpiryCalculator {
  ...
  private static final Month[] CATTLE_FUTURE_EXPIRY_MONTHS = { Month.FEBRUARY, Month.APRIL, Month.JUNE, Month.AUGUST, Month.OCTOBER, Month.DECEMBER };
  ...
  // -------------------------------------------------------------------------
  /**
   * Expiry date of Soybean Futures: The last business day of the contract month. See
   * http://www.cmegroup.com/trading/agricultural/livestock/live-cattle_contractSpecs_futures.html
   *
   * @param n
  ...
  private LocalDate getNextExpiryMonth(final LocalDate dtCurrent) {
    ...
    final int idx = Arrays.binarySearch(CATTLE_FUTURE_EXPIRY_MONTHS, mthCurrent);
